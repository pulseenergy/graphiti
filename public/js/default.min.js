...
setTimeout(function(){!d.data(a,m,e,!0)&&!d.data(a,u,e,!0)&&(d.removeData(a,i,!0),b.resolve())},0)}function p(){return!1}function n(){return!0}function v(a,c,f){var i=d.extend({},f[0]);i.type=a;i.originalEvent={};i.liveFired=e;d.event.handle.call(c,i);i.isDefaultPrevented()&&f[0].preventDefault()}function B(a){var c,f,i,m,u,b,h,e,l,g,j,o=[];m=[];u=d._data(this,"events");if(!(a.liveFired===this||!u||!u.live||a.target.disabled||a.button&&"click"===a.type)){a.namespace&&(j=RegExp("(^|\\.)"+a.namespace.split(".").join("\\.(?:.*\\.)?")+
...
handleObj:u,level:g.level})}}e=0;for(l=o.length;e<l;e++){m=o[e];if(f&&m.level>f)break;a.currentTarget=m.elem;a.data=m.handleObj.data;a.handleObj=m.handleObj;j=m.handleObj.origHandler.apply(m.elem,arguments);if(!1===j||a.isPropagationStopped())if(f=m.level,!1===j&&(c=!1),a.isImmediatePropagationStopped())break}return c}}function G(a,c){return(a&&"*"!==a?a+".":"")+c.replace(Ta,"`").replace(Ua,"&")}function y(a,c,f){c=c||0;if(d.isFunction(c))return d.grep(a,function(a,d){return!!c.call(a,d,a)===f});
...
0);"margin"===f&&(i+=parseFloat(d.css(a,f+this))||0)});return i+"px"}function z(a){return function(c,f){"string"!==typeof c&&(f=c,c="*");if(d.isFunction(f))for(var i=c.toLowerCase().split(ra),m=0,u=i.length,b,h;m<u;m++)b=i[m],(h=/^\+/.test(b))&&(b=b.substr(1)||"*"),b=a[b]=a[b]||[],b[h?"unshift":"push"](f)}}function H(a,c,d,i,m,u){m=m||c.dataTypes[0];u=u||{};u[m]=!0;for(var m=a[m],b=0,h=m?m.length:0,l=a===ha,g;b<h&&(l||!g);b++)g=m[b](c,d,i),"string"===typeof g&&(!l||u[g]?g=e:(c.dataTypes.unshift(g),
g=H(a,c,d,i,g,u)));if((l||!g)&&!u["*"])g=H(a,c,d,i,"*",u);return g}function w(a,c){var f,i,m=d.ajaxSettings.flatOptions||{};for(f in c)c[f]!==e&&((m[f]?a:i||(i={}))[f]=c[f]);i&&d.extend(!0,a,i)}function A(a,c,f,i){if(d.isArray(c))d.each(c,function(c,m){f||Za.test(a)?i(a,m):A(a+"["+("object"===typeof m||d.isArray(m)?c:"")+"]",m,f,i)});else if(!f&&null!=c&&"object"===typeof c)for(var m in c)A(a+"["+m+"]",c[m],f,i);else i(a,c)}function J(){try{return new g.XMLHttpRequest}catch(a){}}function t(){setTimeout(C,
0);return ba=d.now()}function C(){ba=e}function F(a,c){var f={};d.each(sa.concat.apply([],sa.slice(0,c)),function(){f[this]=a});return f}function U(a){if(!ia[a]){var c=s.body,f=d("<"+a+">").appendTo(c),i=f.css("display");f.remove();if("none"===i||""===i){L||(L=s.createElement("iframe"),L.frameBorder=L.width=L.height=0);c.appendChild(L);if(!V||!L.createElement)V=(L.contentWindow||L.contentDocument).document,V.write(("CSS1Compat"===s.compatMode?"<!doctype html>":"")+"<html><body>"),V.close();f=V.createElement(a);
...
t=/^[\],:{}\s]*$/,q=/\\(?:["\\\/bfnrt]|u[0-9a-fA-F]{4})/g,n=/"[^"\\\n\r]*"|true|false|null|-?\d+(?:\.\d*)?(?:[eE][+\-]?\d+)?/g,z=/(?:^|:|,)(?:\s*\[)+/g,r=/(webkit)[ \/]([\w.]+)/,p=/(opera)(?:.*version)?[ \/]([\w.]+)/,C=/(msie) ([\w.]+)/,F=/(mozilla)(?:.*? rv:([\w.]+))?/,Y=/-([a-z]|[0-9])/ig,$a=/^-ms-/,ab=function(a,c){return(c+"").toUpperCase()},Z=O.userAgent,ca,W,bb=Object.prototype.toString,ja=Object.prototype.hasOwnProperty,y=Array.prototype.push,H=Array.prototype.slice,w=String.prototype.trim,
A=Array.prototype.indexOf,ta={};c.fn=c.prototype={constructor:c,init:function(a,d,f){var i;if(!a)return this;if(a.nodeType)return this.context=this[0]=a,this.length=1,this;if("body"===a&&!d&&s.body)return this.context=s,this[0]=s.body,this.selector=a,this.length=1,this;if("string"===typeof a){if((i="<"===a.charAt(0)&&">"===a.charAt(a.length-1)&&3<=a.length?[null,a,null]:b.exec(a))&&(i[1]||!d)){if(i[1])return f=(d=d instanceof c?d[0]:d)?d.ownerDocument||d:s,(a=k.exec(a))?c.isPlainObject(d)?(a=[s.createElement(a[1])],
...
try{if(a.constructor&&!ja.call(a,"constructor")&&!ja.call(a.constructor.prototype,"isPrototypeOf"))return!1}catch(d){return!1}for(var f in a);return f===e||ja.call(a,f)},isEmptyObject:function(a){for(var c in a)return!1;return!0},error:function(a){throw a;},parseJSON:function(a){if("string"!==typeof a||!a)return null;a=c.trim(a);if(g.JSON&&g.JSON.parse)return g.JSON.parse(a);if(t.test(a.replace(q,"@").replace(n,"]").replace(z,"")))return(new Function("return "+a))();c.error("Invalid JSON: "+a)},parseXML:function(a){var d,
...
c.toUpperCase()},each:function(a,d,f){var i,m=0,b=a.length,u=b===e||c.isFunction(a);if(f)if(u)for(i in a){if(!1===d.apply(a[i],f))break}else for(;m<b&&!1!==d.apply(a[m++],f););else if(u)for(i in a){if(!1===d.call(a[i],i,a[i]))break}else for(;m<b&&!1!==d.call(a[m],m,a[m++]););return a},trim:w?function(a){return null==a?"":w.call(a)}:function(a){return null==a?"":a.toString().replace(l,"").replace(j,"")},makeArray:function(a,d){var f=d||[];if(null!=a){var i=c.type(a);null==a.length||"string"===i||"function"===
i||"regexp"===i||c.isWindow(a)?y.call(f,a):c.merge(f,a)}return f},inArray:function(a,c){if(!c)return-1;if(A)return A.call(c,a);for(var d=0,f=c.length;d<f;d++)if(c[d]===a)return d;return-1},merge:function(a,c){var d=a.length,f=0;if("number"===typeof c.length)for(var i=c.length;f<i;f++)a[d++]=c[f];else for(;c[f]!==e;)a[d++]=c[f++];a.length=d;return a},grep:function(a,c,d){for(var f=[],i,d=!!d,m=0,b=a.length;m<b;m++)i=!!c(a[m],m),d!==i&&f.push(a[m]);return f},map:function(a,d,f){var i,m,b=[],u=0,h=a.length;
...
if("object"===typeof d){for(var h in d)c.access(a,h,d[h],i,m,f);return a}if(f!==e){i=!b&&i&&c.isFunction(f);for(h=0;h<u;h++)m(a[h],d,i?f.call(a[h],h,m(a[h],d)):f,b);return a}return u?m(a[0],d):e},now:function(){return(new Date).getTime()},uaMatch:function(a){a=a.toLowerCase();a=r.exec(a)||p.exec(a)||C.exec(a)||0>a.indexOf("compatible")&&F.exec(a)||[];return{browser:a[1]||"",version:a[2]||"0"}},sub:function(){function a(c,d){return new a.fn.init(c,d)}c.extend(!0,a,this);a.superclass=this;a.fn=a.prototype=
...
Ta=/\./g,Ua=/ /g,gb=/[^\w\s.|`]/g,hb=function(a){return a.replace(gb,"\\$&")};d.event={add:function(a,c,f,i){if(!(a.nodeType===3||a.nodeType===8)){if(f===false)f=p;else if(!f)return;var b,h;if(f.handler){b=f;f=b.handler}if(!f.guid)f.guid=d.guid++;if(h=d._data(a)){var l=h.events,g=h.handle;if(!l)h.events=l={};if(!g)h.handle=g=function(a){return typeof d!=="undefined"&&(!a||d.event.triggered!==a.type)?d.event.handle.apply(g.elem,arguments):e};g.elem=a;for(var c=c.split(" "),j,o=0,k;j=c[o++];){h=b?d.extend({},
b):{handler:f,data:i};if(j.indexOf(".")>-1){k=j.split(".");j=k.shift();h.namespace=k.slice(0).sort().join(".")}else{k=[];h.namespace=""}h.type=j;if(!h.guid)h.guid=f.guid;var t=l[j],q=d.event.special[j]||{};if(!t){t=l[j]=[];if(!q.setup||q.setup.call(a,i,k,g)===false)a.addEventListener?a.addEventListener(j,g,false):a.attachEvent&&a.attachEvent("on"+j,g)}if(q.add){q.add.call(a,h);if(!h.handler.guid)h.handler.guid=f.guid}t.push(h);d.event.global[j]=true}a=null}}},global:{},remove:function(a,c,f,i){if(!(a.nodeType===
3||a.nodeType===8)){f===false&&(f=p);var b,h,l=0,g,j,k,o,t,q,s=d.hasData(a)&&d._data(a),n=s&&s.events;if(s&&n){if(c&&c.type){f=c.handler;c=c.type}if(!c||typeof c==="string"&&c.charAt(0)==="."){c=c||"";for(b in n)d.event.remove(a,b+c)}else{for(c=c.split(" ");b=c[l++];){o=b;g=b.indexOf(".")<0;j=[];if(!g){j=b.split(".");b=j.shift();k=RegExp("(^|\\.)"+d.map(j.slice(0).sort(),hb).join("\\.(?:.*\\.)?")+"(\\.|$)")}if(t=n[b])if(f){o=d.event.special[b]||{};for(h=i||0;h<t.length;h++){q=t[h];if(f.guid===q.guid){if(g||
k.test(q.namespace)){i==null&&t.splice(h--,1);o.remove&&o.remove.call(a,q)}if(i!=null)break}}if(t.length===0||i!=null&&t.length===1){(!o.teardown||o.teardown.call(a,j)===false)&&d.removeEvent(a,b,s.handle);delete n[b]}}else for(h=0;h<t.length;h++){q=t[h];if(g||k.test(q.namespace)){d.event.remove(a,o,q.handler,h);t.splice(h--,1)}}}if(d.isEmptyObject(n)){if(c=s.handle)c.elem=null;delete s.events;delete s.handle;d.isEmptyObject(s)&&d.removeData(a,e,true)}}}}},customEvent:{getData:!0,setData:!0,changeData:!0},
...
a)}});var na={focus:"focusin",blur:"focusout",mouseenter:"mouseover",mouseleave:"mouseout"};d.each(["live","die"],function(a,c){d.fn[c]=function(a,i,h,b){var l=0,g,j,o=b||this.selector,k=b?this:d(this.context);if(typeof a==="object"&&!a.preventDefault){for(g in a)k[c](g,i,a[g],o);return this}if(c==="die"&&!a&&b&&b.charAt(0)==="."){k.unbind(b);return this}if(i===false||d.isFunction(i)){h=i||p;i=e}for(a=(a||"").split(" ");(b=a[l++])!=null;){g=ga.exec(b);j="";if(g){j=g[0];b=b.replace(ga,"")}if(b==="hover")a.push("mouseenter"+
...
9)return[];if(!a||typeof a!=="string")return d;var e,l,g,j,u,Q=true,q=o.isXML(c),n=[],r=a;do{f.exec("");if(e=f.exec(r)){r=e[3];n.push(e[1]);if(e[2]){j=e[3];break}}}while(e);if(n.length>1&&t.exec(a))if(n.length===2&&k.relative[n[0]])l=F(n[0]+n[1],c);else for(l=k.relative[n[0]]?[c]:o(n.shift(),c);n.length;){a=n.shift();k.relative[a]&&(a=a+n.shift());l=F(a,l)}else{if(!i&&n.length>1&&c.nodeType===9&&!q&&k.match.ID.test(n[0])&&!k.match.ID.test(n[n.length-1])){e=o.find(n.shift(),c,q);c=e.expr?o.filter(e.expr,
e.set)[0]:e.set[0]}if(c){e=i?{expr:n.pop(),set:z(i)}:o.find(n.pop(),n.length===1&&(n[0]==="~"||n[0]==="+")&&c.parentNode?c.parentNode:c,q);l=e.expr?o.filter(e.expr,e.set):e.set;for(n.length>0?g=z(l):Q=false;n.length;){e=u=n.pop();k.relative[u]?e=n.pop():u="";e==null&&(e=c);k.relative[u](g,e,q)}}else g=[]}g||(g=l);g||o.error(u||a);if(b.call(g)==="[object Array]")if(Q)if(c&&c.nodeType===1)for(a=0;g[a]!=null;a++)g[a]&&(g[a]===true||g[a].nodeType===1&&o.contains(c,g[a]))&&d.push(l[a]);else for(a=0;g[a]!=
null;a++)g[a]&&g[a].nodeType===1&&d.push(l[a]);else d.push.apply(d,g);else z(g,d);if(j){o(j,h,d,i);o.uniqueSort(d)}return d};o.uniqueSort=function(a){if(p){h=l;a.sort(p);if(h)for(var c=1;c<a.length;c++)a[c]===a[c-1]&&a.splice(c--,1)}return a};o.matches=function(a,c){return o(a,null,null,c)};o.matchesSelector=function(a,c){return o(c,null,null,[a]).length>0};o.find=function(a,c,d){var f;if(!a)return[];for(var i=0,h=k.order.length;i<h;i++){var b,m=k.order[i];if(b=k.leftMatch[m].exec(a)){var e=b[1];
b.splice(1,1);if(e.substr(e.length-1)!=="\\"){b[1]=(b[1]||"").replace(g,"");f=k.find[m](b,c,d);if(f!=null){a=a.replace(k.match[m],"");break}}}}f||(f=typeof c.getElementsByTagName!=="undefined"?c.getElementsByTagName("*"):[]);return{set:f,expr:a}};o.filter=function(a,c,d,f){for(var i,b,h=a,m=[],l=c,g=c&&c[0]&&o.isXML(c[0]);a&&c.length;){for(var j in k.filter)if((i=k.leftMatch[j].exec(a))!=null&&i[2]){var u,t,n=k.filter[j];t=i[1];b=false;i.splice(1,1);if(t.substr(t.length-1)!=="\\"){l===m&&(m=[]);if(k.preFilter[j])if(i=
k.preFilter[j](i,l,d,m,f,g)){if(i===true)continue}else b=u=true;if(i)for(var Q=0;(t=l[Q])!=null;Q++)if(t){u=n(t,i,Q,l);var q=f^!!u;if(d&&u!=null)q?b=true:l[Q]=false;else if(q){m.push(t);b=true}}if(u!==e){d||(l=m);a=a.replace(k.match[j],"");if(!b)return[];break}}}if(a===h)if(b==null)o.error(a);else break;h=a}return l};o.error=function(a){throw"Syntax error, unrecognized expression: "+a;};var k=o.selectors={order:["ID","NAME","TAG"],match:{ID:/#((?:[\w\u00c0-\uFFFF\-]|\\.)+)/,CLASS:/\.((?:[\w\u00c0-\uFFFF\-]|\\.)+)/,
...
d,c,f)}}},t=k.match.POS,q=function(a,c){return"\\"+(c-0+1)},n;for(n in k.match){k.match[n]=RegExp(k.match[n].source+/(?![^\[]*\])(?![^\(]*\))/.source);k.leftMatch[n]=RegExp(/(^(?:.|\r|\n)*?)/.source+k.match[n].source.replace(/\\(\d+)/g,q))}var z=function(a,c){a=Array.prototype.slice.call(a,0);if(c){c.push.apply(c,a);return c}return a};try{Array.prototype.slice.call(s.documentElement.childNodes,0)[0].nodeType}catch(r){z=function(a,c){var d=0,f=c||[];if(b.call(a)==="[object Array]")Array.prototype.push.apply(f,
a);else if(typeof a.length==="number")for(var i=a.length;d<i;d++)f.push(a[d]);else for(;a[d];d++)f.push(a[d]);return f}}var p,C;if(s.documentElement.compareDocumentPosition)p=function(a,c){if(a===c){h=true;return 0}return!a.compareDocumentPosition||!c.compareDocumentPosition?a.compareDocumentPosition?-1:1:a.compareDocumentPosition(c)&4?-1:1};else{p=function(a,c){if(a===c){h=true;return 0}if(a.sourceIndex&&c.sourceIndex)return a.sourceIndex-c.sourceIndex;var d,f,i=[],b=[];d=a.parentNode;f=c.parentNode;
...
2)};a=null})();s.querySelectorAll&&function(){var a=o,c=s.createElement("div");c.innerHTML="<p class='TEST'></p>";if(!(c.querySelectorAll&&c.querySelectorAll(".TEST").length===0)){o=function(c,d,f,i){d=d||s;if(!i&&!o.isXML(d)){var b=/^(\w+$)|^\.([\w\-]+$)|^#([\w\-]+$)/.exec(c);if(b&&(d.nodeType===1||d.nodeType===9)){if(b[1])return z(d.getElementsByTagName(c),f);if(b[2]&&k.find.CLASS&&d.getElementsByClassName)return z(d.getElementsByClassName(b[2]),f)}if(d.nodeType===9){if(c==="body"&&d.body)return z([d.body],
f);if(b&&b[3]){var h=d.getElementById(b[3]);if(h&&h.parentNode){if(h.id===b[3])return z([h],f)}else return z([],f)}try{return z(d.querySelectorAll(c),f)}catch(m){}}else if(d.nodeType===1&&d.nodeName.toLowerCase()!=="object"){var b=d,e=(h=d.getAttribute("id"))||"__sizzle__",l=d.parentNode,g=/^\s*[+~]/.test(c);h?e=e.replace(/'/g,"\\$&"):d.setAttribute("id",e);if(g&&l)d=d.parentNode;try{if(!g||l)return z(d.querySelectorAll("[id='"+e+"'] "+c),f)}catch(j){}finally{h||b.removeAttribute("id")}}}return a(c,
...
i;f++){h=b.length;d.find(a,this[f],b);if(f>0)for(e=h;e<b.length;e++)for(l=0;l<h;l++)if(b[l]===b[e]){b.splice(e--,1);break}}return b},has:function(a){var c=d(a);return this.filter(function(){for(var a=0,i=c.length;a<i;a++)if(d.contains(this,c[a]))return true})},not:function(a){return this.pushStack(y(this,a,false),"not",a)},filter:function(a){return this.pushStack(y(this,a,true),"filter",a)},is:function(a){return!!a&&(typeof a==="string"?d.filter(a,this).length>0:this.filter(a).length>0)},closest:function(a,
...
b,h,l){if(d.isFunction(b)){l=l||h;h=b;b=e}return d.ajax({type:c,url:a,data:b,success:h,dataType:l})}});d.extend({getScript:function(a,c){return d.get(a,e,c,"script")},getJSON:function(a,c,f){return d.get(a,c,f,"json")},ajaxSetup:function(a,c){if(c)w(a,d.ajaxSettings);else{c=a;a=d.ajaxSettings}w(a,c);return a},ajaxSettings:{url:M,isLocal:/^(?:about|app|app\-storage|.+\-extension|file|res|widget):$/.test(N[1]),global:!0,type:"GET",contentType:"application/x-www-form-urlencoded",processData:!0,async:!0,
accepts:{xml:"application/xml, text/xml",html:"text/html",text:"text/plain",json:"application/json, text/javascript","*":Oa},contents:{xml:/xml/,html:/html/,json:/json/},responseFields:{xml:"responseXML",text:"responseText"},converters:{"* text":g.String,"text html":!0,"text json":d.parseJSON,"text xml":d.parseXML},flatOptions:{context:!0,url:!0}},ajaxPrefilter:z(ha),ajaxTransport:z(Na),ajax:function(a,c){function f(a,c,f,t){if(C!==2){C=2;r&&clearTimeout(r);z=e;q=t||"";w.readyState=a>0?4:0;var n,
s,p,t=c;if(f){var y=b,H=w,O=y.contents,A=y.dataTypes,I=y.responseFields,x,v,J,U;for(v in I)v in f&&(H[I[v]]=f[v]);for(;A[0]==="*";){A.shift();x===e&&(x=y.mimeType||H.getResponseHeader("content-type"))}if(x)for(v in O)if(O[v]&&O[v].test(x)){A.unshift(v);break}if(A[0]in f)J=A[0];else{for(v in f){if(!A[0]||y.converters[v+" "+A[0]]){J=v;break}U||(U=v)}J=J||U}if(J){J!==A[0]&&A.unshift(J);f=f[J]}else f=void 0}else f=e;if(a>=200&&a<300||a===304){if(b.ifModified){if(x=w.getResponseHeader("Last-Modified"))d.lastModified[k]=
x;if(x=w.getResponseHeader("Etag"))d.etag[k]=x}if(a===304){t="notmodified";n=true}else try{x=b;x.dataFilter&&(f=x.dataFilter(f,x.dataType));var E=x.dataTypes;v={};var R,B,Sa=E.length,G,D=E[0],S,L,P,K,M;for(R=1;R<Sa;R++){if(R===1)for(B in x.converters)typeof B==="string"&&(v[B.toLowerCase()]=x.converters[B]);S=D;D=E[R];if(D==="*")D=S;else if(S!=="*"&&S!==D){L=S+" "+D;P=v[L]||v["* "+D];if(!P){M=e;for(K in v){G=K.split(" ");if(G[0]===S||G[0]==="*")if(M=v[G[1]+" "+D]){K=v[K];K===true?P=M:M===true&&(P=
K);break}}}!P&&!M&&d.error("No conversion from "+L.replace(" "," to "));P!==true&&(f=P?P(f):M(K(f)))}}s=f;t="success";n=true}catch(N){t="parsererror";p=N}}else{p=t;if(!t||a){t="error";a<0&&(a=0)}}w.status=a;w.statusText=""+(c||t);n?g.resolveWith(h,[s,t,w]):g.rejectWith(h,[w,t,p]);w.statusCode(o);o=e;F&&l.trigger("ajax"+(n?"Success":"Error"),[w,b,n?s:p]);j.resolveWith(h,[w,t]);if(F){l.trigger("ajaxComplete",[w,b]);--d.active||d.event.trigger("ajaxStop")}}}if(typeof a==="object"){c=a;a=e}var c=c||{},
b=d.ajaxSetup({},c),h=b.context||b,l=h!==b&&(h.nodeType||h instanceof d)?d(h):d.event,g=d.Deferred(),j=d._Deferred(),o=b.statusCode||{},k,t={},n={},q,s,z,r,p,C=0,F,y,w={readyState:0,setRequestHeader:function(a,c){if(!C){var d=a.toLowerCase(),a=n[d]=n[d]||a;t[a]=c}return this},getAllResponseHeaders:function(){return C===2?q:null},getResponseHeader:function(a){var c;if(C===2){if(!s)for(s={};c=yb.exec(q);)s[c[1].toLowerCase()]=c[2];c=s[a.toLowerCase()]}return c===e?null:c},overrideMimeType:function(a){if(!C)b.mimeType=
a;return this},abort:function(a){a=a||"abort";z&&z.abort(a);f(0,a);return this}};g.promise(w);w.success=w.done;w.error=w.fail;w.complete=j.done;w.statusCode=function(a){if(a){var c;if(C<2)for(c in a)o[c]=[o[c],a[c]];else{c=a[w.status];w.then(c,c)}}return this};b.url=((a||b.url)+"").replace(xb,"").replace(Bb,N[1]+"//");b.dataTypes=d.trim(b.dataType||"*").toLowerCase().split(ra);if(b.crossDomain==null){p=La.exec(b.url.toLowerCase());b.crossDomain=!(!p||!(p[1]!=N[1]||p[2]!=N[2]||(p[3]||(p[1]==="http:"?
80:443))!=(N[3]||(N[1]==="http:"?80:443))))}if(b.data&&b.processData&&typeof b.data!=="string")b.data=d.param(b.data,b.traditional);H(ha,b,c,w);if(C===2)return false;F=b.global;b.type=b.type.toUpperCase();b.hasContent=!Ab.test(b.type);F&&d.active++===0&&d.event.trigger("ajaxStart");if(!b.hasContent){if(b.data){b.url=b.url+((Ka.test(b.url)?"&":"?")+b.data);delete b.data}k=b.url;if(b.cache===false){p=d.now();var O=b.url.replace(Eb,"$1_="+p);b.url=O+(O===b.url?(Ka.test(b.url)?"&":"?")+"_="+p:"")}}(b.data&&
b.hasContent&&b.contentType!==false||c.contentType)&&w.setRequestHeader("Content-Type",b.contentType);if(b.ifModified){k=k||b.url;d.lastModified[k]&&w.setRequestHeader("If-Modified-Since",d.lastModified[k]);d.etag[k]&&w.setRequestHeader("If-None-Match",d.etag[k])}w.setRequestHeader("Accept",b.dataTypes[0]&&b.accepts[b.dataTypes[0]]?b.accepts[b.dataTypes[0]]+(b.dataTypes[0]!=="*"?", "+Oa+"; q=0.01":""):b.accepts["*"]);for(y in b.headers)w.setRequestHeader(y,b.headers[y]);if(b.beforeSend&&(b.beforeSend.call(h,
w,b)===false||C===2)){w.abort();return false}for(y in{success:1,error:1,complete:1})w[y](b[y]);if(z=H(Na,b,c,w)){w.readyState=1;F&&l.trigger("ajaxSend",[w,b]);b.async&&b.timeout>0&&(r=setTimeout(function(){w.abort("timeout")},b.timeout));try{C=1;z.send(t,f)}catch(A){C<2?f(-1,A):d.error(A)}}else f(-1,"No Transport");return w},param:function(a,c){var b=[],h=function(a,c){c=d.isFunction(c)?c():c;b[b.length]=encodeURIComponent(a)+"="+encodeURIComponent(c)};if(c===e)c=d.ajaxSettings.traditional;if(d.isArray(a)||
a.jquery&&!d.isPlainObject(a))d.each(a,function(){h(this.name,this.value)});else for(var l in a)A(l,a[l],c,h);return b.join("&").replace(wb,"+")}});d.extend({active:0,lastModified:{},etag:{}});var Fb=d.now(),ea=/(\=)\?(&|$)|\?\?/i;d.ajaxSetup({jsonp:"callback",jsonpCallback:function(){return d.expando+"_"+Fb++}});d.ajaxPrefilter("json jsonp",function(a,c,b){c=a.contentType==="application/x-www-form-urlencoded"&&typeof a.data==="string";if(a.dataTypes[0]==="jsonp"||a.jsonp!==false&&(ea.test(a.url)||
...
!a.crossDomain&&!b["X-Requested-With"]&&(b["X-Requested-With"]="XMLHttpRequest");try{for(o in b)l.setRequestHeader(o,b[o])}catch(k){}l.send(a.hasContent&&a.data||null);c=function(b,f){var g,o,k,t,n;try{if(c&&(f||l.readyState===4)){c=e;if(j){l.onreadystatechange=d.noop;qa&&delete X[j]}if(f)l.readyState!==4&&l.abort();else{g=l.status;k=l.getAllResponseHeaders();t={};if((n=l.responseXML)&&n.documentElement)t.xml=n;t.text=l.responseText;try{o=l.statusText}catch(q){o=""}!g&&a.isLocal&&!a.crossDomain?g=
t.text?200:404:g===1223&&(g=204)}}}catch(s){f||h(-1,s)}t&&h(g,o,t,k)};if(!a.async||l.readyState===4)c();else{j=++Gb;if(qa){if(!X){X={};d(g).unload(qa)}X[j]=c}l.onreadystatechange=c}},abort:function(){c&&c(0,1)}}}});var ia={},L,V,Hb=/^(?:toggle|show|hide)$/,Ib=/^([+\-]=)?([\d+.\-]+)([a-z%]*)$/i,fa,sa=[["height","marginTop","marginBottom","paddingTop","paddingBottom"],["width","marginLeft","marginRight","paddingLeft","paddingRight"],["opacity"]],ba;d.fn.extend({show:function(a,c,b){if(a||a===0)return this.animate(F("show",
...
(function(g){function e(b,e){for(var g=b.length;g--;)if(b[g]===e)return g;return-1}function b(b,e,g){var j,k,h,l;void 0===g&&(g=e,e="all");b=b.replace(/\s/g,"");j=b.split(",");""==j[j.length-1]&&(j[j.length-2]+=",");for(h=0;h<j.length;h++){k=[];b=j[h].split("+");if(1<b.length){k=b.slice(0,b.length-1);for(l=0;l<k.length;l++)k[l]=B[k[l]];b=[b[b.length-1]]}b=b[0];b=G[b]||b.toUpperCase().charCodeAt(0);b in p||(p[b]=[]);p[b].push({shortcut:j[h],scope:e,method:g,key:j[h],mods:k})}}function j(b,e,g){b.addEventListener?
b.addEventListener(e,g,!1):b.attachEvent&&b.attachEvent("on"+e,function(){g(window.event)})}var k,p={},n={16:!1,18:!1,17:!1,91:!1},v="all",B={"\u21e7":16,shift:16,"\u2325":18,alt:18,option:18,"\u2303":17,ctrl:17,control:17,"\u2318":91,command:91},G={backspace:8,tab:9,clear:12,enter:13,"return":13,esc:27,escape:27,space:32,left:37,up:38,right:39,down:40,del:46,"delete":46,home:36,end:35,pageup:33,pagedown:34,",":188,".":190,"/":191,"`":192,"-":189,"=":187,";":186,"'":222,"[":219,"]":221,"\\":220};
for(k=1;20>k;k++)B["f"+k]=111+k;for(k in B)b[k]=!1;j(document,"keydown",function(g){var j,k,x,E,h;k=(g.target||g.srcElement).tagName;j=g.keyCode;if(93==j||224==j)j=91;if(j in n)for(x in n[j]=!0,B)B[x]==j&&(b[x]=!0);else if(!("INPUT"==k||"SELECT"==k||"TEXTAREA"==k)&&j in p)for(E=0;E<p[j].length;E++)if(k=p[j][E],k.scope==v||"all"==k.scope){h=0<k.mods.length;for(x in n)if(!n[x]&&-1<e(k.mods,+x)||n[x]&&-1==e(k.mods,+x))h=!1;if((0==k.mods.length&&!n[16]&&!n[18]&&!n[17]&&!n[91]||h)&&!1===k.method(g,k))g.preventDefault?
g.preventDefault():g.returnValue=!1,g.stopPropagation&&g.stopPropagation(),g.cancelBubble&&(g.cancelBubble=!0)}});j(document,"keyup",function(e){var e=e.keyCode,g;if(93==e||224==e)e=91;if(e in n)for(g in n[e]=!1,B)B[g]==e&&(b[g]=!1)});g.key=b;g.key.setScope=function(b){v=b||"all"};"undefined"!==typeof module&&(module.exports=key)})(this);
(function(g,e){var b,j=/:([\w\d]+)/g,k=/\?([^#]*)?$/,p=function(b){return Array.prototype.slice.call(b)},n=function(b){return"[object Function]"===Object.prototype.toString.call(b)},v=function(b){return"[object Array]"===Object.prototype.toString.call(b)},B=function(b){return decodeURIComponent((b||"").replace(/\+/g," "))},G=encodeURIComponent,y=function(b){return(""+b).replace(/&(?!\w+;)/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")},I=function(b){return function(e,
g){return this.route.apply(this,[b,e,g])}},r={},x=!(!e.history||!history.pushState),E=[];b=function(){var h=p(arguments),e,j;b.apps=b.apps||{};if(0===h.length||h[0]&&n(h[0]))return b.apply(b,["body"].concat(h));if("string"==typeof(j=h.shift()))return e=b.apps[j]||new b.Application,e.element_selector=j,0<h.length&&g.each(h,function(b,h){e.use(h)}),e.element_selector!=j&&delete b.apps[j],b.apps[e.element_selector]=e};b.VERSION="0.7.0";b.addLogger=function(b){E.push(b)};b.log=function(){var h=p(arguments);
h.unshift("["+Date()+"]");g.each(E,function(e,g){g.apply(b,h)})};"undefined"!=typeof e.console?n(e.console.log.apply)?b.addLogger(function(){e.console.log.apply(e.console,arguments)}):b.addLogger(function(){e.console.log(arguments)}):"undefined"!=typeof console&&b.addLogger(function(){console.log.apply(console,arguments)});g.extend(b,{makeArray:p,isFunction:n,isArray:v,extend:g.extend});b.Object=function(b){return g.extend(this,b||{})};g.extend(b.Object.prototype,{escapeHTML:y,h:y,toHash:function(){var b=
...
g.toString()+") is not defined",j):n(e)?this.error("Plugin Error",j):this.error("Plugin Error: called use() but '"+g.toString()+"' is not a function",j)}return this},setLocationProxy:function(b){var e=this._location_proxy;this._location_proxy=b;this.isRunning()&&(e&&e.unbind(),this._location_proxy.bind())},log:function(){b.log.apply(b,Array.prototype.concat.apply([this.element_selector],arguments))},route:function(b,e,k){var p=this,r=[],w,A;!k&&n(e)&&(k=e=b,b="any");b=b.toLowerCase();if(e.constructor==
String){for(j.lastIndex=0;null!==(A=j.exec(e));)r.push(A[1]);e=RegExp(e.replace(j,"([^/]+)")+"$")}"string"==typeof k&&(k=p[k]);w=function(b){var h={verb:b,path:e,callback:k,param_names:r};p.routes[b]=p.routes[b]||[];p.routes[b].push(h)};"any"===b?g.each(this.ROUTE_VERBS,function(b,h){w(h)}):w(b);return this},get:I("get"),post:I("post"),put:I("put"),del:I("delete"),any:I("any"),mapRoutes:function(b){var e=this;g.each(b,function(b,h){e.route.apply(e,h)});return this},eventNamespace:function(){return["sammy-app",
...
"")},lookupRoute:function(b,e){var g=!1,j=0,k,n;if("undefined"!=typeof this.routes[b])for(k=this.routes[b].length;j<k;j++)if(n=this.routes[b][j],this.routablePath(e).match(n.path)){g=n;break}return g},runRoute:function(b,e,j,k){var n=this,p=this.lookupRoute(b,e),r,v,t,C,F,x,q;this.log("runRoute",[b,e].join(" "));this.trigger("run-route",{verb:b,path:e,params:j});"undefined"==typeof j&&(j={});g.extend(j,this._parseQueryString(e));if(p){this.trigger("route-found",{route:p});if(null!==(x=p.path.exec(this.routablePath(e))))x.shift(),
g.each(x,function(b,h){p.param_names[b]?j[p.param_names[b]]=B(h):(j.splat||(j.splat=[]),j.splat.push(B(h)))});r=new this.context_prototype(this,b,e,j,k);k=this.arounds.slice(0);t=this.befores.slice(0);F=[r].concat(j.splat);v=function(){for(var b;0<t.length;)if(C=t.shift(),n.contextMatchesOptions(r,C[0])&&(b=C[1].apply(r,[r]),!1===b))return!1;n.last_route=p;r.trigger("event-context-before",{context:r});b=p.callback.apply(r,F);r.trigger("event-context-after",{context:r});return b};g.each(k.reverse(),
...
this;j||(j=v(this.previous_content)?this.previous_content:[]);if(k)g.each(j,function(g,j){var t={},o=this.next_engine||b;e?t[e]=j:t=j;k(j,p.event_context.interpolate(n,t,o))});else return this.collect(j,function(g,j){var k={},o=this.next_engine||b;e?k[e]=j:k=j;return this.event_context.interpolate(n,k,o)},true)})},interpolate:function(b,e,g){var j=this;return this.then(function(k,n){!b&&n&&(b=n);this.next_engine&&(e=this.next_engine,this.next_engine=!1);var p=j.event_context.interpolate(k,b,e,this.partials);
...
q.box.onmouseout=function(){g.focus()};q.box.onmousedown=function(){E=!0};q.box.onmousemove=function(b){if(o||z)o&&G(b),z&&y(b),document.selection?document.selection.empty():window.getSelection&&window.getSelection().removeAllRanges()};q.padM.onmouseup=q.padM.onmouseout=function(){o&&(o=!1,jscolor.fireEvent(h,"change"))};q.padM.onmousedown=function(b){o=!0;G(b)};q.sldM.onmouseup=q.sldM.onmouseout=function(){z&&(z=!1,jscolor.fireEvent(h,"change"))};q.sldM.onmousedown=function(b){z=!0;y(b)};j=k(r);
...
1));jscolor.picker.sldM.style.backgroundPosition="0 "+(r.pickerFace+r.pickerInset+b-Math.floor(jscolor.images.arrow[1]/2))+"px"}function v(){return jscolor.picker&&jscolor.picker.owner===r}function B(){h!==g&&r.importColor()}function G(b){var e=jscolor.getRelMousePos(b),b=e.x-r.pickerFace-r.pickerInset,e=e.y-r.pickerFace-r.pickerInset;switch(x){case 0:r.fromHSV(b*(6/(jscolor.images.pad[0]-1)),1-e/(jscolor.images.pad[1]-1),null,J);break;case 1:r.fromHSV(b*(6/(jscolor.images.pad[0]-1)),null,1-e/(jscolor.images.pad[1]-
1),J)}}function y(b){b=jscolor.getRelMousePos(b).y-r.pickerFace-r.pickerInset;switch(x){case 0:r.fromHSV(null,null,1-b/(jscolor.images.sld[1]-1),A);break;case 1:r.fromHSV(null,1-b/(jscolor.images.sld[1]-1),null,A)}}this.adjust=this.required=!0;this.hash=!1;this.slider=this.caps=!0;this.styleElement=this.valueElement=g;this.hsv=[0,0,1];this.rgb=[1,1,1];this.pickerOnfocus=!0;this.pickerMode="HSV";this.pickerPosition="bottom";this.pickerButtonHeight=20;this.pickerClosable=!1;this.pickerCloseText="Close";
...
e[p]-d-d*r:b[p]+e[p]-d+d*r:0<=b[p]+e[p]-d+d*r?b[p]+e[p]-d+d*r:b[p]+e[p]-d-d*r];j(b[o],b[p])}};this.importColor=function(){h?this.adjust?!this.required&&/^\s*$/.test(h.value)?(h.value="",l.style.backgroundColor=l.jscStyle.backgroundColor,l.style.color=l.jscStyle.color,this.exportColor(H|w)):this.fromString(h.value)||this.exportColor():this.fromString(h.value,H)||(l.style.backgroundColor=l.jscStyle.backgroundColor,l.style.color=l.jscStyle.color,this.exportColor(H|w)):this.exportColor()};this.exportColor=
function(b){if(!(b&H)&&h){var e=this.toString();this.caps&&(e=e.toUpperCase());this.hash&&(e="#"+e);h.value=e}!(b&w)&&l&&(l.style.backgroundColor="#"+this.toString(),l.style.color=0.5>0.213*this.rgb[0]+0.715*this.rgb[1]+0.072*this.rgb[2]?"#FFF":"#000");!(b&A)&&v()&&p();!(b&J)&&v()&&n()};this.fromHSV=function(e,g,h,j){0>e&&(e=0)||6<e&&(e=6);0>g&&(g=0)||1<g&&(g=1);0>h&&(h=0)||1<h&&(h=1);this.rgb=b(null===e?this.hsv[0]:this.hsv[0]=e,null===g?this.hsv[1]:this.hsv[1]=g,null===h?this.hsv[2]:this.hsv[2]=
...
$("#metrics-list ul.search-results");g.html("");""!==$("#metrics-menu input.search").val()&&$("<li>").addClass("root").text("..").appendTo(g);for(var k=0,p=e.length;k<p;k++)Sammy.log(e[k]),$("<li>").addClass("folder").text(e[k]).prepend("<img src=http://localhost:5001/images/folder.png>").hover(function(){$(this).css("font-weight","bold")},function(){$(this).css("font-weight","normal")}).appendTo(g);k=0;for(p=b.length;k<p;k++)Sammy.log(b[k]),$("<li>").addClass("key").append($("<a rel='add'>Add</a>")).append($("<strong>").text(b[k])).prepend("<img src=http://localhost:5001/images/metric.gif>").appendTo(g)},
appendFolderToSearchKey:function(e){var b=$("#metrics-menu input.search");""!==b.val()&&b.val(b.val()+".");b.val(b.val()+e)},removeFolderFromSearchKey:function(){var e=$("#metrics-menu input.search");""!==e.val()?e.val(e.val().replace(/\.?\w*$/,"")):e.val("")},bindMetricsList:function(){var e=this,b=$("#metrics-list ul.search-results"),g=$("#metrics-menu input.search");b.delegate("li.root","click",function(b){b.preventDefault();e.removeFolderFromSearchKey();e.searchFolderAndKeyList(g.val())}).addClass(".bound");
b.delegate("li.folder","click",function(b){b.preventDefault();e.appendFolderToSearchKey($(this).text());e.searchFolderAndKeyList(g.val())}).addClass(".bound");b.delegate("li.key","click",function(b){b.preventDefault();var p=g.val(),b=$(this).find("a").attr("rel"),p=p+"."+$(this).find("strong").text();Sammy.log("clicked",b,p);e[b+"GraphMetric"](p)}).addClass(".bound");g.change(function(){e.searchFolderAndKeyList(g.val())});""==g.val()&&e.searchFolderAndKeyList("")},keywordRequestPending:0,searchFolderAndKeyList:function(e){var b=
this,g=++b.keywordRequestPending;this.load("/keywords.js",{cache:!1,data:{q:e}}).then(function(e){g==b.keywordRequestPending&&b.buildMetricsList(e.folders,e.metrics)})},addGraphMetric:function(e){var b=this.getEditorJSON();b.targets.push([e,{}]);this.graphPreview(b);this.setEditorJSON(b)},replaceGraphMetric:function(e){var b=this.getEditorJSON();b.targets=[[e,{}]];this.graphPreview(b);this.setEditorJSON(b)},timestamp:function(e){"string"==typeof e&&(e=parseInt(e,10));return(new Date(1E3*e)).toString()},
buildDashboardsDropdown:function(e){this.load("/dashboards.js",{cache:!1,data:{uuid:e}}).then(function(b){var e=$('select[name="dashboard"]');e.html("");for(var b=b.dashboards,g=0,p=b.length,n;g<p;g++)n=b[g],$("<option />",{value:n.slug,text:n.title}).appendTo(e)})},buildSnapshotsDropdown:function(e,b){var g=$('select[name="snapshot"]');b&&g.html("");for(var k=0,p=e.length,n,v;k<p;k++)n=e[k],v=this.snapshotURLToDate(n),$("<option />",{value:n,text:v}).prependTo(g).attr("selected","selected")},loadAndRenderGraphs:function(e){var b=
this,g=this.showPane("graphs"," ");this.load(e,{cache:!1}).then(function(e){var p="All Graphs",n;e.title?(n=!1,p=e.title):n=!0;g.append("<h2>"+p+"</h2>");var p=e.graphs,v=0,B=p.length,G=$("#templates .graph").clone(),y;if(0==e.graphs.length)return g.append($("#graphs-empty")),!0;for(;v<B;v++)y=p[v],G.clone().find(".title").text(y.title||"Untitled").end().find("a.edit").attr("href","/graphs/"+y.uuid).end().show().data("graph",y.json).appendTo(g).each(function(){b.drawGraph(y.json,$(this).find("img"));
(v+1)%2==0&&$(this).addClass("last");n?$(this).find(".delete").attr("action","/graphs/"+y.uuid):$(this).find(".delete").attr("action","/graphs/dashboards").find("[name=dashboard]").val(e.slug).end().find("[name=uuid]").val(y.uuid).end().find("[type=submit]").val("Remove")})})},drawGraph:function(e,b){var g=JSON.parse(e);$.extend(!0,g,this.getOptionOverrides());graph_obj=new Graphiti.Graph(g);graph_obj.image(b)},redrawGraphs:function(){var e=this,b=$("#graphs-pane");b.is(":visible")&&b.find(".graph").each(function(){e.drawGraph($(this).data("graph"),
$(this).find("img"))})},loadAndRenderDashboards:function(){var e=this.showPane("dashboards","<h2>Dashboards</h2>"),b=this;this.load("/dashboards.js",{cache:!1}).then(function(g){var g=g.dashboards,k=0,p=g.length,n,v,B=$("#templates .dashboard").clone();if(0==g.length)e.append($("#dashboards-empty"));else for(;k<p;k++)n=g[k],v=0==(k+1)%2?"alt":"",B.clone().find("a.view").attr("href","/dashboards/"+n.slug).end().find(".title").text(n.title).end().find(".graphs-count").text(n.graphs.length).end().find(".updated-at").text(b.timestamp(n.updated_at)).end().find("form.delete").attr("action",
"/dashboards/"+n.slug).end().addClass(v).show().appendTo(e)})},loadAndRenderSnapshots:function(){var e=this;this.load("/graphs/"+this.params.uuid+".js",{cache:!1}).then(function(b){for(var g=e.showPane("snapshots","<h2>"+b.title+" - Snapshots</h2>"),b=b.snapshots,k=0,p=b.length,n,v=$("#templates .snapshot").clone();k<p;k++)n=b[k],v.clone().find("a.view").attr("href",n).end().find("img").attr("src",n).end().find("h3.title").text(e.snapshotURLToDate(n)).end().show().appendTo(g)})},snapshotURLToDate:function(e){var b;
try{b=(new Date(parseInt(e.match(/\/(\d+)\.png/)[1],10))).toString()}catch(g){}return b},bindEditorPanes:function(){var e=this;$("#editor-pane").delegate(".edit-group .edit-head","click",function(b){b.preventDefault();var b=$(this).add($(this).siblings(".edit-body")),g=b.parents(".edit-group").attr("data-group");b.is(".closed")?(b.removeClass("closed").addClass("open"),e.session("groups:"+g,!0)):(b.addClass("closed").removeClass("open"),e.session("groups:"+g,!1))})},toggleEditorPanesByPreference:function(){var e=
...
k=g.find(".new-dashboard"),g=g.find(".add-to-dashboard");k.is(":visible")?(k.hide(),g.show()):(k.show(),g.hide())});this.registerShortcut("redraw-preview","g",function(){this.redrawPreview()});this.bind("run",function(){var e=this;this.bindEditorPanes();this.bindMetricsList();this.bindTimeSelector();var b=function(){""==$(this).val().toString()?$(this).siblings(".save").attr("disabled","disabled"):$(this).siblings(".save").removeAttr("disabled")};$('select[name="dashboard"]').live("click",b).live("focus",
b).live("blur",b);$('.dashboard button[rel=create], .dashboard a[rel="cancel"]').live("click",function(b){b.preventDefault();e.trigger("toggle-dashboard-creation",{target:$(this).parents(".dashboard")})});$("#graph-actions").delegate(".redraw","click",function(b){b.preventDefault();e.redrawPreview()})})});$(function(){app.run()});Graphiti=window.Graphiti||{};
