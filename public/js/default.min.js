...
*/
(function(g,e){function b(a,c,f){if(f===e&&1===a.nodeType)if(f="data-"+c.replace(Qa,"-$1").toLowerCase(),f=a.getAttribute(f),"string"===typeof f){try{f="true"===f?!0:"false"===f?!1:"null"===f?null:!d.isNaN(f)?parseFloat(f):Ra.test(f)?d.parseJSON(f):f}catch(i){}d.data(a,c,f)}else f=e;return f}function j(a){for(var c in a)if("toJSON"!==c)return!1;return!0}function k(a,c,f){var i=c+"defer",m=c+"queue",u=c+"mark",b=d.data(a,i,e,!0);b&&("queue"===f||!d.data(a,m,e,!0))&&("mark"===f||!d.data(a,u,e,!0))&&
setTimeout(function(){!d.data(a,m,e,!0)&&!d.data(a,u,e,!0)&&(d.removeData(a,i,!0),b.resolve())},0)}function q(){return!1}function n(){return!0}function v(a,c,f){var i=d.extend({},f[0]);i.type=a;i.originalEvent={};i.liveFired=e;d.event.handle.call(c,i);i.isDefaultPrevented()&&f[0].preventDefault()}function A(a){var c,f,i,m,u,b,h,e,l,g,j,o=[];m=[];u=d._data(this,"events");if(!(a.liveFired===this||!u||!u.live||a.target.disabled||a.button&&"click"===a.type)){a.namespace&&(j=RegExp("(^|\\.)"+a.namespace.split(".").join("\\.(?:.*\\.)?")+
"(\\.|$)"));a.liveFired=this;var k=u.live.slice(0);for(h=0;h<k.length;h++)u=k[h],u.origType.replace(ga,"")===a.type?m.push(u.selector):k.splice(h--,1);m=d(a.target).closest(m,a.currentTarget);e=0;for(l=m.length;e<l;e++){g=m[e];for(h=0;h<k.length;h++)if(u=k[h],g.selector===u.selector&&(!j||j.test(u.namespace))&&!g.elem.disabled){b=g.elem;i=null;if("mouseenter"===u.preType||"mouseleave"===u.preType)a.type=u.preType,(i=d(a.relatedTarget).closest(u.selector)[0])&&d.contains(b,i)&&(i=b);(!i||i!==b)&&o.push({elem:b,
handleObj:u,level:g.level})}}e=0;for(l=o.length;e<l;e++){m=o[e];if(f&&m.level>f)break;a.currentTarget=m.elem;a.data=m.handleObj.data;a.handleObj=m.handleObj;j=m.handleObj.origHandler.apply(m.elem,arguments);if(!1===j||a.isPropagationStopped())if(f=m.level,!1===j&&(c=!1),a.isImmediatePropagationStopped())break}return c}}function G(a,c){return(a&&"*"!==a?a+".":"")+c.replace(Ta,"`").replace(Ua,"&")}function z(a,c,f){c=c||0;if(d.isFunction(c))return d.grep(a,function(a,d){return!!c.call(a,d,a)===f});
if(c.nodeType)return d.grep(a,function(a){return a===c===f});if("string"===typeof c){var i=d.grep(a,function(a){return 1===a.nodeType});if(Va.test(c))return d.filter(c,i,!f);c=d.filter(c,i)}return d.grep(a,function(a){return 0<=d.inArray(a,c)===f})}function I(a,c){if(1===c.nodeType&&d.hasData(a)){var f=d.expando,i=d.data(a),m=d.data(c,i);if(i=i[f]){var u=i.events,m=m[f]=d.extend({},i);if(u){delete m.handle;m.events={};for(var b in u){f=0;for(i=u[b].length;f<i;f++)d.event.add(c,b+(u[b][f].namespace?
".":"")+u[b][f].namespace,u[b][f],u[b][f].data)}}}}}function r(a,c){var f;if(1===c.nodeType){c.clearAttributes&&c.clearAttributes();c.mergeAttributes&&c.mergeAttributes(a);f=c.nodeName.toLowerCase();if("object"===f)c.outerHTML=a.outerHTML;else if("input"===f&&("checkbox"===a.type||"radio"===a.type)){if(a.checked&&(c.defaultChecked=c.checked=a.checked),c.value!==a.value)c.value=a.value}else if("option"===f)c.selected=a.defaultSelected;else if("input"===f||"textarea"===f)c.defaultValue=a.defaultValue;
c.removeAttribute(d.expando)}}function w(a){return"getElementsByTagName"in a?a.getElementsByTagName("*"):"querySelectorAll"in a?a.querySelectorAll("*"):[]}function E(a){if("checkbox"===a.type||"radio"===a.type)a.defaultChecked=a.checked}function h(a){d.nodeName(a,"input")?E(a):"getElementsByTagName"in a&&d.grep(a.getElementsByTagName("input"),E)}function l(a,c){c.src?d.ajax({url:c.src,async:!1,dataType:"script"}):d.globalEval((c.text||c.textContent||c.innerHTML||"").replace(Wa,"/*$0*/"));c.parentNode&&
c.parentNode.removeChild(c)}function o(a,c,f){var i="width"===c?a.offsetWidth:a.offsetHeight,m="width"===c?Xa:Ya;if(0<i)return"border"!==f&&d.each(m,function(){f||(i-=parseFloat(d.css(a,"padding"+this))||0);i="margin"===f?i+(parseFloat(d.css(a,f+this))||0):i-(parseFloat(d.css(a,"border"+this+"Width"))||0)}),i+"px";i=T(a,c,c);if(0>i||null==i)i=a.style[c]||0;i=parseFloat(i)||0;f&&d.each(m,function(){i+=parseFloat(d.css(a,"padding"+this))||0;"padding"!==f&&(i+=parseFloat(d.css(a,"border"+this+"Width"))||
0);"margin"===f&&(i+=parseFloat(d.css(a,f+this))||0)});return i+"px"}function y(a){return function(c,f){"string"!==typeof c&&(f=c,c="*");if(d.isFunction(f))for(var i=c.toLowerCase().split(ra),m=0,u=i.length,b,h;m<u;m++)b=i[m],(h=/^\+/.test(b))&&(b=b.substr(1)||"*"),b=a[b]=a[b]||[],b[h?"unshift":"push"](f)}}function H(a,c,d,i,m,u){m=m||c.dataTypes[0];u=u||{};u[m]=!0;for(var m=a[m],b=0,h=m?m.length:0,l=a===ha,g;b<h&&(l||!g);b++)g=m[b](c,d,i),"string"===typeof g&&(!l||u[g]?g=e:(c.dataTypes.unshift(g),
g=H(a,c,d,i,g,u)));if((l||!g)&&!u["*"])g=H(a,c,d,i,"*",u);return g}function x(a,c){var f,i,m=d.ajaxSettings.flatOptions||{};for(f in c)c[f]!==e&&((m[f]?a:i||(i={}))[f]=c[f]);i&&d.extend(!0,a,i)}function C(a,c,f,i){if(d.isArray(c))d.each(c,function(c,m){f||Za.test(a)?i(a,m):C(a+"["+("object"===typeof m||d.isArray(m)?c:"")+"]",m,f,i)});else if(!f&&null!=c&&"object"===typeof c)for(var m in c)C(a+"["+m+"]",c[m],f,i);else i(a,c)}function J(){try{return new g.XMLHttpRequest}catch(a){}}function t(){setTimeout(B,
0);return ba=d.now()}function B(){ba=e}function F(a,c){var f={};d.each(sa.concat.apply([],sa.slice(0,c)),function(){f[this]=a});return f}function U(a){if(!ia[a]){var c=s.body,f=d("<"+a+">").appendTo(c),i=f.css("display");f.remove();if("none"===i||""===i){L||(L=s.createElement("iframe"),L.frameBorder=L.width=L.height=0);c.appendChild(L);if(!V||!L.createElement)V=(L.contentWindow||L.contentDocument).document,V.write(("CSS1Compat"===s.compatMode?"<!doctype html>":"")+"<html><body>"),V.close();f=V.createElement(a);
V.body.appendChild(f);i=d.css(f,"display");c.removeChild(L)}ia[a]=i}return ia[a]}function p(a){return d.isWindow(a)?a:9===a.nodeType?a.defaultView||a.parentWindow:!1}var s=g.document,P=g.navigator,R=g.location,d=function(){function a(){if(!c.isReady){try{s.documentElement.doScroll("left")}catch(d){setTimeout(a,1);return}c.ready()}}var c=function(a,d){return new c.fn.init(a,d,m)},d=g.jQuery,i=g.$,m,b=/^(?:[^#<]*(<[\w\W]+>)[^>]*$|#([\w\-]*)$)/,h=/\S/,l=/^\s+/,j=/\s+$/,o=/\d/,k=/^<(\w+)\s*\/?>(?:<\/\1>)?$/,
t=/^[\],:{}\s]*$/,n=/\\(?:["\\\/bfnrt]|u[0-9a-fA-F]{4})/g,p=/"[^"\\\n\r]*"|true|false|null|-?\d+(?:\.\d*)?(?:[eE][+\-]?\d+)?/g,y=/(?:^|:|,)(?:\s*\[)+/g,r=/(webkit)[ \/]([\w.]+)/,q=/(opera)(?:.*version)?[ \/]([\w.]+)/,B=/(msie) ([\w.]+)/,F=/(mozilla)(?:.*? rv:([\w.]+))?/,Y=/-([a-z]|[0-9])/ig,$a=/^-ms-/,ab=function(a,c){return(c+"").toUpperCase()},Z=P.userAgent,ca,W,bb=Object.prototype.toString,ja=Object.prototype.hasOwnProperty,z=Array.prototype.push,H=Array.prototype.slice,x=String.prototype.trim,
C=Array.prototype.indexOf,ta={};c.fn=c.prototype={constructor:c,init:function(a,d,f){var i;if(!a)return this;if(a.nodeType)return this.context=this[0]=a,this.length=1,this;if("body"===a&&!d&&s.body)return this.context=s,this[0]=s.body,this.selector=a,this.length=1,this;if("string"===typeof a){if((i="<"===a.charAt(0)&&">"===a.charAt(a.length-1)&&3<=a.length?[null,a,null]:b.exec(a))&&(i[1]||!d)){if(i[1])return f=(d=d instanceof c?d[0]:d)?d.ownerDocument||d:s,(a=k.exec(a))?c.isPlainObject(d)?(a=[s.createElement(a[1])],
...
jquery:"1.6.4",length:0,size:function(){return this.length},toArray:function(){return H.call(this,0)},get:function(a){return null==a?this.toArray():0>a?this[this.length+a]:this[a]},pushStack:function(a,d,f){var i=this.constructor();c.isArray(a)?z.apply(i,a):c.merge(i,a);i.prevObject=this;i.context=this.context;"find"===d?i.selector=this.selector+(this.selector?" ":"")+f:d&&(i.selector=this.selector+"."+d+"("+f+")");return i},each:function(a,d){return c.each(this,a,d)},ready:function(a){c.bindReady();
ca.done(a);return this},eq:function(a){return-1===a?this.slice(a):this.slice(a,+a+1)},first:function(){return this.eq(0)},last:function(){return this.eq(-1)},slice:function(){return this.pushStack(H.apply(this,arguments),"slice",H.call(arguments).join(","))},map:function(a){return this.pushStack(c.map(this,function(c,d){return a.call(c,d,c)}))},end:function(){return this.prevObject||this.constructor(null)},push:z,sort:[].sort,splice:[].splice};c.fn.init.prototype=c.fn;c.extend=c.fn.extend=function(){var a,
d,f,i,m,b=arguments[0]||{},u=1,h=arguments.length,Y=!1;"boolean"===typeof b&&(Y=b,b=arguments[1]||{},u=2);"object"!==typeof b&&!c.isFunction(b)&&(b={});h===u&&(b=this,--u);for(;u<h;u++)if(null!=(a=arguments[u]))for(d in a)f=b[d],i=a[d],b!==i&&(Y&&i&&(c.isPlainObject(i)||(m=c.isArray(i)))?(m?(m=!1,f=f&&c.isArray(f)?f:[]):f=f&&c.isPlainObject(f)?f:{},b[d]=c.extend(Y,f,i)):i!==e&&(b[d]=i));return b};c.extend({noConflict:function(a){g.$===c&&(g.$=i);a&&g.jQuery===c&&(g.jQuery=d);return c},isReady:!1,
readyWait:1,holdReady:function(a){a?c.readyWait++:c.ready(!0)},ready:function(a){if(!0===a&&!--c.readyWait||!0!==a&&!c.isReady){if(!s.body)return setTimeout(c.ready,1);c.isReady=!0;!0!==a&&0<--c.readyWait||(ca.resolveWith(s,[c]),c.fn.trigger&&c(s).trigger("ready").unbind("ready"))}},bindReady:function(){if(!ca){ca=c._Deferred();if("complete"===s.readyState)return setTimeout(c.ready,1);if(s.addEventListener)s.addEventListener("DOMContentLoaded",W,!1),g.addEventListener("load",c.ready,!1);else if(s.attachEvent){s.attachEvent("onreadystatechange",
W);g.attachEvent("onload",c.ready);var d=!1;try{d=null==g.frameElement}catch(f){}s.documentElement.doScroll&&d&&a()}}},isFunction:function(a){return"function"===c.type(a)},isArray:Array.isArray||function(a){return"array"===c.type(a)},isWindow:function(a){return a&&"object"===typeof a&&"setInterval"in a},isNaN:function(a){return null==a||!o.test(a)||isNaN(a)},type:function(a){return null==a?""+a:ta[bb.call(a)]||"object"},isPlainObject:function(a){if(!a||"object"!==c.type(a)||a.nodeType||c.isWindow(a))return!1;
try{if(a.constructor&&!ja.call(a,"constructor")&&!ja.call(a.constructor.prototype,"isPrototypeOf"))return!1}catch(d){return!1}for(var f in a);return f===e||ja.call(a,f)},isEmptyObject:function(a){for(var c in a)return!1;return!0},error:function(a){throw a;},parseJSON:function(a){if("string"!==typeof a||!a)return null;a=c.trim(a);if(g.JSON&&g.JSON.parse)return g.JSON.parse(a);if(t.test(a.replace(n,"@").replace(p,"]").replace(y,"")))return(new Function("return "+a))();c.error("Invalid JSON: "+a)},parseXML:function(a){var d,
f;try{g.DOMParser?(f=new DOMParser,d=f.parseFromString(a,"text/xml")):(d=new ActiveXObject("Microsoft.XMLDOM"),d.async="false",d.loadXML(a))}catch(i){d=e}(!d||!d.documentElement||d.getElementsByTagName("parsererror").length)&&c.error("Invalid XML: "+a);return d},noop:function(){},globalEval:function(a){a&&h.test(a)&&(g.execScript||function(a){g.eval.call(g,a)})(a)},camelCase:function(a){return a.replace($a,"ms-").replace(Y,ab)},nodeName:function(a,c){return a.nodeName&&a.nodeName.toUpperCase()===
c.toUpperCase()},each:function(a,d,f){var i,m=0,b=a.length,u=b===e||c.isFunction(a);if(f)if(u)for(i in a){if(!1===d.apply(a[i],f))break}else for(;m<b&&!1!==d.apply(a[m++],f););else if(u)for(i in a){if(!1===d.call(a[i],i,a[i]))break}else for(;m<b&&!1!==d.call(a[m],m,a[m++]););return a},trim:x?function(a){return null==a?"":x.call(a)}:function(a){return null==a?"":a.toString().replace(l,"").replace(j,"")},makeArray:function(a,d){var f=d||[];if(null!=a){var i=c.type(a);null==a.length||"string"===i||"function"===
i||"regexp"===i||c.isWindow(a)?z.call(f,a):c.merge(f,a)}return f},inArray:function(a,c){if(!c)return-1;if(C)return C.call(c,a);for(var d=0,f=c.length;d<f;d++)if(c[d]===a)return d;return-1},merge:function(a,c){var d=a.length,f=0;if("number"===typeof c.length)for(var i=c.length;f<i;f++)a[d++]=c[f];else for(;c[f]!==e;)a[d++]=c[f++];a.length=d;return a},grep:function(a,c,d){for(var f=[],i,d=!!d,m=0,b=a.length;m<b;m++)i=!!c(a[m],m),d!==i&&f.push(a[m]);return f},map:function(a,d,f){var i,m,b=[],u=0,h=a.length;
if(a instanceof c||h!==e&&"number"===typeof h&&(0<h&&a[0]&&a[h-1]||0===h||c.isArray(a)))for(;u<h;u++)i=d(a[u],u,f),null!=i&&(b[b.length]=i);else for(m in a)i=d(a[m],m,f),null!=i&&(b[b.length]=i);return b.concat.apply([],b)},guid:1,proxy:function(a,d){if("string"===typeof d)var f=a[d],d=a,a=f;if(!c.isFunction(a))return e;var i=H.call(arguments,2),f=function(){return a.apply(d,i.concat(H.call(arguments)))};f.guid=a.guid=a.guid||f.guid||c.guid++;return f},access:function(a,d,f,i,m,b){var u=a.length;
if("object"===typeof d){for(var h in d)c.access(a,h,d[h],i,m,f);return a}if(f!==e){i=!b&&i&&c.isFunction(f);for(h=0;h<u;h++)m(a[h],d,i?f.call(a[h],h,m(a[h],d)):f,b);return a}return u?m(a[0],d):e},now:function(){return(new Date).getTime()},uaMatch:function(a){a=a.toLowerCase();a=r.exec(a)||q.exec(a)||B.exec(a)||0>a.indexOf("compatible")&&F.exec(a)||[];return{browser:a[1]||"",version:a[2]||"0"}},sub:function(){function a(c,d){return new a.fn.init(c,d)}c.extend(!0,a,this);a.superclass=this;a.fn=a.prototype=
this();a.fn.constructor=a;a.sub=this.sub;a.fn.init=function(f,i){i&&i instanceof c&&!(i instanceof a)&&(i=a(i));return c.fn.init.call(this,f,i,d)};a.fn.init.prototype=a.fn;var d=a(s);return a},browser:{}});c.each("Boolean,Number,String,Function,Array,Date,RegExp,Object".split(","),function(a,c){ta["[object "+c+"]"]=c.toLowerCase()});Z=c.uaMatch(Z);Z.browser&&(c.browser[Z.browser]=!0,c.browser.version=Z.version);c.browser.webkit&&(c.browser.safari=!0);h.test("\u00a0")&&(l=/^[\s\xA0]+/,j=/[\s\xA0]+$/);
m=c(s);s.addEventListener?W=function(){s.removeEventListener("DOMContentLoaded",W,false);c.ready()}:s.attachEvent&&(W=function(){if(s.readyState==="complete"){s.detachEvent("onreadystatechange",W);c.ready()}});return c}(),ka="done,fail,isResolved,isRejected,promise,then,always,pipe".split(","),ua=[].slice;d.extend({_Deferred:function(){var a=[],c,f,i,m={done:function(){if(!i){var f=arguments,b,h,e,l,g;c&&(g=c,c=0);b=0;for(h=f.length;b<h;b++)e=f[b],l=d.type(e),"array"===l?m.done.apply(m,e):"function"===
...
arguments)},fail:f.done,rejectWith:f.resolveWith,reject:f.resolve,isRejected:f.isResolved,pipe:function(a,f){return d.Deferred(function(i){d.each({done:[a,"resolve"],fail:[f,"reject"]},function(a,f){var m=f[0],b=f[1],h;if(d.isFunction(m))c[a](function(){if((h=m.apply(this,arguments))&&d.isFunction(h.promise))h.promise().then(i.resolve,i.reject);else i[b+"With"](this===c?i:this,[h])});else c[a](i[b])})}).promise()},promise:function(a){if(null==a){if(i)return i;i=a={}}for(var d=ka.length;d--;)a[ka[d]]=
c[ka[d]];return a}});c.done(f.cancel).fail(c.cancel);delete c.cancel;a&&a.call(c,c);return c},when:function(a){function c(a){return function(c){f[a]=1<arguments.length?ua.call(arguments,0):c;--b||h.resolveWith(h,ua.call(f,0))}}var f=arguments,i=0,m=f.length,b=m,h=1>=m&&a&&d.isFunction(a.promise)?a:d.Deferred();if(1<m){for(;i<m;i++)f[i]&&d.isFunction(f[i].promise)?f[i].promise().then(c(i),h.reject):--b;b||h.resolveWith(h,f)}else h!==a&&h.resolveWith(h,m?[a]:[]);return h.promise()}});d.support=function(){var a=
...
d.attrHooks[c])||(wa.test(c)?h=xa:K&&(h=K));if(f!==e){if(null===f)return d.removeAttr(a,c),e;if(h&&"set"in h&&i&&(b=h.set(a,f,c))!==e)return b;a.setAttribute(c,""+f);return f}if(h&&"get"in h&&i&&null!==(b=h.get(a,c)))return b;b=a.getAttribute(c);return null===b?e:b},removeAttr:function(a,c){var f;if(1===a.nodeType&&(c=d.attrFix[c]||c,d.attr(a,c,""),a.removeAttribute(c),wa.test(c)&&(f=d.propFix[c]||c)in a))a[f]=!1},attrHooks:{type:{set:function(a,c){if(db.test(a.nodeName)&&a.parentNode)d.error("type property can't be changed");
else if(!d.support.radioValue&&"radio"===c&&d.nodeName(a,"input")){var f=a.value;a.setAttribute("type",c);f&&(a.value=f);return c}}},value:{get:function(a,c){return K&&d.nodeName(a,"button")?K.get(a,c):c in a?a.value:null},set:function(a,c,f){if(K&&d.nodeName(a,"button"))return K.set(a,c,f);a.value=c}}},propFix:{tabindex:"tabIndex",readonly:"readOnly","for":"htmlFor","class":"className",maxlength:"maxLength",cellspacing:"cellSpacing",cellpadding:"cellPadding",rowspan:"rowSpan",colspan:"colSpan",usemap:"useMap",
...
d.extend(d.propHooks.selected,{get:function(a){if(a=a.parentNode){a.selectedIndex;a.parentNode&&a.parentNode.selectedIndex}return null}}));d.support.checkOn||d.each(["radio","checkbox"],function(){d.valHooks[this]={get:function(a){return a.getAttribute("value")===null?"on":a.value}}});d.each(["radio","checkbox"],function(){d.valHooks[this]=d.extend(d.valHooks[this],{set:function(a,c){if(d.isArray(c))return a.checked=d.inArray(d(a).val(),c)>=0}})});var ga=/\.(.*)$/,ma=/^(?:textarea|input|select)$/i,
Ta=/\./g,Ua=/ /g,gb=/[^\w\s.|`]/g,hb=function(a){return a.replace(gb,"\\$&")};d.event={add:function(a,c,f,i){if(!(a.nodeType===3||a.nodeType===8)){if(f===false)f=q;else if(!f)return;var b,h;if(f.handler){b=f;f=b.handler}if(!f.guid)f.guid=d.guid++;if(h=d._data(a)){var l=h.events,g=h.handle;if(!l)h.events=l={};if(!g)h.handle=g=function(a){return typeof d!=="undefined"&&(!a||d.event.triggered!==a.type)?d.event.handle.apply(g.elem,arguments):e};g.elem=a;for(var c=c.split(" "),j,o=0,k;j=c[o++];){h=b?d.extend({},
b):{handler:f,data:i};if(j.indexOf(".")>-1){k=j.split(".");j=k.shift();h.namespace=k.slice(0).sort().join(".")}else{k=[];h.namespace=""}h.type=j;if(!h.guid)h.guid=f.guid;var t=l[j],n=d.event.special[j]||{};if(!t){t=l[j]=[];if(!n.setup||n.setup.call(a,i,k,g)===false)a.addEventListener?a.addEventListener(j,g,false):a.attachEvent&&a.attachEvent("on"+j,g)}if(n.add){n.add.call(a,h);if(!h.handler.guid)h.handler.guid=f.guid}t.push(h);d.event.global[j]=true}a=null}}},global:{},remove:function(a,c,f,i){if(!(a.nodeType===
3||a.nodeType===8)){f===false&&(f=q);var b,h,l=0,g,j,o,k,t,n,p=d.hasData(a)&&d._data(a),s=p&&p.events;if(p&&s){if(c&&c.type){f=c.handler;c=c.type}if(!c||typeof c==="string"&&c.charAt(0)==="."){c=c||"";for(b in s)d.event.remove(a,b+c)}else{for(c=c.split(" ");b=c[l++];){k=b;g=b.indexOf(".")<0;j=[];if(!g){j=b.split(".");b=j.shift();o=RegExp("(^|\\.)"+d.map(j.slice(0).sort(),hb).join("\\.(?:.*\\.)?")+"(\\.|$)")}if(t=s[b])if(f){k=d.event.special[b]||{};for(h=i||0;h<t.length;h++){n=t[h];if(f.guid===n.guid){if(g||
o.test(n.namespace)){i==null&&t.splice(h--,1);k.remove&&k.remove.call(a,n)}if(i!=null)break}}if(t.length===0||i!=null&&t.length===1){(!k.teardown||k.teardown.call(a,j)===false)&&d.removeEvent(a,b,p.handle);delete s[b]}}else for(h=0;h<t.length;h++){n=t[h];if(g||o.test(n.namespace)){d.event.remove(a,k,n.handler,h);t.splice(h--,1)}}}if(d.isEmptyObject(s)){if(c=p.handle)c.elem=null;delete p.events;delete p.handle;d.isEmptyObject(p)&&d.removeData(a,e,true)}}}}},customEvent:{getData:!0,setData:!0,changeData:!0},
...
f[b]){(j=f[i])&&(f[i]=null);d.event.triggered=b;f[b]()}}catch(o){}j&&(f[i]=j);d.event.triggered=e}}return a.result}}else d.each(d.cache,function(){var f=this[d.expando];f&&f.events&&f.events[b]&&d.event.trigger(a,c,f.handle.elem)})}},handle:function(a){var a=d.event.fix(a||g.event),c=((d._data(this,"events")||{})[a.type]||[]).slice(0),f=!a.exclusive&&!a.namespace,i=Array.prototype.slice.call(arguments,0);i[0]=a;a.currentTarget=this;for(var h=0,b=c.length;h<b;h++){var l=c[h];if(f||a.namespace_re.test(l.namespace)){a.handler=
...
d(c).closest("form").length&&a.keyCode===13&&v("submit",this,arguments)})},teardown:function(){d.event.remove(this,".specialSubmit")}});if(!d.support.changeBubbles){var aa,Aa=function(a){var c=d.nodeName(a,"input")?a.type:"",f=a.value;if(c==="radio"||c==="checkbox")f=a.checked;else if(c==="select-multiple")f=a.selectedIndex>-1?d.map(a.options,function(a){return a.selected}).join("-"):"";else if(d.nodeName(a,"select"))f=a.selectedIndex;return f},da=function(a,c){var f=a.target,i,h;if(ma.test(f.nodeName)&&
!f.readOnly){i=d._data(f,"_change_data");h=Aa(f);(a.type!=="focusout"||f.type!=="radio")&&d._data(f,"_change_data",h);if(!(i===e||h===i))if(i!=null||h){a.type="change";a.liveFired=e;d.event.trigger(a,c,f)}}};d.event.special.change={filters:{focusout:da,beforedeactivate:da,click:function(a){var c=a.target,f=d.nodeName(c,"input")?c.type:"";(f==="radio"||f==="checkbox"||d.nodeName(c,"select"))&&da.call(this,a)},keydown:function(a){var c=a.target,f=d.nodeName(c,"input")?c.type:"";(a.keyCode===13&&!d.nodeName(c,
"textarea")||a.keyCode===32&&(f==="checkbox"||f==="radio")||f==="select-multiple")&&da.call(this,a)},beforeactivate:function(a){a=a.target;d._data(a,"_change_data",Aa(a))}},setup:function(){if(this.type==="file")return false;for(var a in aa)d.event.add(this,a+".specialChange",aa[a]);return ma.test(this.nodeName)},teardown:function(){d.event.remove(this,".specialChange");return ma.test(this.nodeName)}};aa=d.event.special.change.filters;aa.focus=aa.beforeactivate}d.support.focusinBubbles||d.each({focus:"focusin",
blur:"focusout"},function(a,c){function f(a){var f=d.event.fix(a);f.type=c;f.originalEvent={};d.event.trigger(f,null,f.target);f.isDefaultPrevented()&&a.preventDefault()}var i=0;d.event.special[c]={setup:function(){i++===0&&s.addEventListener(a,f,true)},teardown:function(){--i===0&&s.removeEventListener(a,f,true)}}});d.each(["bind","one"],function(a,c){d.fn[c]=function(a,i,h){var b;if(typeof a==="object"){for(var l in a)this[c](l,i,a[l],h);return this}if(arguments.length===2||i===false){h=i;i=e}if(c===
"one"){b=function(a){d(this).unbind(a,b);return h.apply(this,arguments)};b.guid=h.guid||d.guid++}else b=h;if(a==="unload"&&c!=="one")this.one(a,i,h);else{l=0;for(var g=this.length;l<g;l++)d.event.add(this[l],a,b,i)}return this}});d.fn.extend({unbind:function(a,c){if(typeof a==="object"&&!a.preventDefault)for(var f in a)this.unbind(f,a[f]);else{f=0;for(var i=this.length;f<i;f++)d.event.remove(this[f],a,c)}return this},delegate:function(a,c,d,i){return this.live(c,d,i,a)},undelegate:function(a,c,d){return arguments.length===
0?this.unbind("live"):this.die(c,null,d,a)},trigger:function(a,c){return this.each(function(){d.event.trigger(a,c,this)})},triggerHandler:function(a,c){if(this[0])return d.event.trigger(a,c,this[0],true)},toggle:function(a){var c=arguments,f=a.guid||d.guid++,i=0,h=function(f){var h=(d.data(this,"lastToggle"+a.guid)||0)%i;d.data(this,"lastToggle"+a.guid,h+1);f.preventDefault();return c[h].apply(this,arguments)||false};for(h.guid=f;i<c.length;)c[i++].guid=f;return this.click(h)},hover:function(a,c){return this.mouseenter(a).mouseleave(c||
a)}});var na={focus:"focusin",blur:"focusout",mouseenter:"mouseover",mouseleave:"mouseout"};d.each(["live","die"],function(a,c){d.fn[c]=function(a,i,h,b){var l=0,g,j,o=b||this.selector,k=b?this:d(this.context);if(typeof a==="object"&&!a.preventDefault){for(g in a)k[c](g,i,a[g],o);return this}if(c==="die"&&!a&&b&&b.charAt(0)==="."){k.unbind(b);return this}if(i===false||d.isFunction(i)){h=i||q;i=e}for(a=(a||"").split(" ");(b=a[l++])!=null;){g=ga.exec(b);j="";if(g){j=g[0];b=b.replace(ga,"")}if(b==="hover")a.push("mouseenter"+
j,"mouseleave"+j);else{g=b;if(na[b]){a.push(na[b]+j);b=b+j}else b=(na[b]||b)+j;if(c==="live"){j=0;for(var t=k.length;j<t;j++)d.event.add(k[j],"live."+G(b,o),{data:i,selector:o,handler:h,origType:b,origHandler:h,preType:g})}else k.unbind("live."+G(b,o),h)}}return this}});d.each("blur,focus,focusin,focusout,load,resize,scroll,unload,click,dblclick,mousedown,mouseup,mousemove,mouseover,mouseout,mouseenter,mouseleave,change,select,submit,keydown,keypress,keyup,error".split(","),function(a,c){d.fn[c]=
function(a,d){if(d==null){d=a;a=null}return arguments.length>0?this.bind(c,a,d):this.trigger(c)};d.attrFn&&(d.attrFn[c]=true)});(function(){function a(a,c,d,f,i,h){for(var i=0,b=f.length;i<b;i++){var m=f[i];if(m){for(var e=false,m=m[a];m;){if(m.sizcache===d){e=f[m.sizset];break}if(m.nodeType===1&&!h){m.sizcache=d;m.sizset=i}if(m.nodeName.toLowerCase()===c){e=m;break}m=m[a]}f[i]=e}}}function c(a,c,d,f,i,h){for(var i=0,b=f.length;i<b;i++){var m=f[i];if(m){for(var e=false,m=m[a];m;){if(m.sizcache===
d){e=f[m.sizset];break}if(m.nodeType===1){if(!h){m.sizcache=d;m.sizset=i}if(typeof c!=="string"){if(m===c){e=true;break}}else if(o.filter(c,[m]).length>0){e=m;break}}m=m[a]}f[i]=e}}}var f=/((?:\((?:\([^()]+\)|[^()]+)+\)|\[(?:\[[^\[\]]*\]|['"][^'"]*['"]|[^\[\]'"]+)+\]|\\.|[^ >+~,(\[\\]+)+|[>+~])(\s*,\s*)?((?:.|\r|\n)*)/g,i=0,b=Object.prototype.toString,h=false,l=true,g=/\\/g,j=/\W/;[0,0].sort(function(){l=false;return 0});var o=function(a,c,d,i){var d=d||[],h=c=c||s;if(c.nodeType!==1&&c.nodeType!==
9)return[];if(!a||typeof a!=="string")return d;var e,l,g,j,u,n=true,N=o.isXML(c),p=[],r=a;do{f.exec("");if(e=f.exec(r)){r=e[3];p.push(e[1]);if(e[2]){j=e[3];break}}}while(e);if(p.length>1&&t.exec(a))if(p.length===2&&k.relative[p[0]])l=F(p[0]+p[1],c);else for(l=k.relative[p[0]]?[c]:o(p.shift(),c);p.length;){a=p.shift();k.relative[a]&&(a=a+p.shift());l=F(a,l)}else{if(!i&&p.length>1&&c.nodeType===9&&!N&&k.match.ID.test(p[0])&&!k.match.ID.test(p[p.length-1])){e=o.find(p.shift(),c,N);c=e.expr?o.filter(e.expr,
e.set)[0]:e.set[0]}if(c){e=i?{expr:p.pop(),set:y(i)}:o.find(p.pop(),p.length===1&&(p[0]==="~"||p[0]==="+")&&c.parentNode?c.parentNode:c,N);l=e.expr?o.filter(e.expr,e.set):e.set;for(p.length>0?g=y(l):n=false;p.length;){e=u=p.pop();k.relative[u]?e=p.pop():u="";e==null&&(e=c);k.relative[u](g,e,N)}}else g=[]}g||(g=l);g||o.error(u||a);if(b.call(g)==="[object Array]")if(n)if(c&&c.nodeType===1)for(a=0;g[a]!=null;a++)g[a]&&(g[a]===true||g[a].nodeType===1&&o.contains(c,g[a]))&&d.push(l[a]);else for(a=0;g[a]!=
null;a++)g[a]&&g[a].nodeType===1&&d.push(l[a]);else d.push.apply(d,g);else y(g,d);if(j){o(j,h,d,i);o.uniqueSort(d)}return d};o.uniqueSort=function(a){if(q){h=l;a.sort(q);if(h)for(var c=1;c<a.length;c++)a[c]===a[c-1]&&a.splice(c--,1)}return a};o.matches=function(a,c){return o(a,null,null,c)};o.matchesSelector=function(a,c){return o(c,null,null,[a]).length>0};o.find=function(a,c,d){var f;if(!a)return[];for(var i=0,h=k.order.length;i<h;i++){var b,m=k.order[i];if(b=k.leftMatch[m].exec(a)){var e=b[1];
b.splice(1,1);if(e.substr(e.length-1)!=="\\"){b[1]=(b[1]||"").replace(g,"");f=k.find[m](b,c,d);if(f!=null){a=a.replace(k.match[m],"");break}}}}f||(f=typeof c.getElementsByTagName!=="undefined"?c.getElementsByTagName("*"):[]);return{set:f,expr:a}};o.filter=function(a,c,d,f){for(var i,b,h=a,m=[],l=c,g=c&&c[0]&&o.isXML(c[0]);a&&c.length;){for(var j in k.filter)if((i=k.leftMatch[j].exec(a))!=null&&i[2]){var u,t,p=k.filter[j];t=i[1];b=false;i.splice(1,1);if(t.substr(t.length-1)!=="\\"){l===m&&(m=[]);if(k.preFilter[j])if(i=
k.preFilter[j](i,l,d,m,f,g)){if(i===true)continue}else b=u=true;if(i)for(var N=0;(t=l[N])!=null;N++)if(t){u=p(t,i,N,l);var n=f^!!u;if(d&&u!=null)n?b=true:l[N]=false;else if(n){m.push(t);b=true}}if(u!==e){d||(l=m);a=a.replace(k.match[j],"");if(!b)return[];break}}}if(a===h)if(b==null)o.error(a);else break;h=a}return l};o.error=function(a){throw"Syntax error, unrecognized expression: "+a;};var k=o.selectors={order:["ID","NAME","TAG"],match:{ID:/#((?:[\w\u00c0-\uFFFF\-]|\\.)+)/,CLASS:/\.((?:[\w\u00c0-\uFFFF\-]|\\.)+)/,
...
"for":"htmlFor"},attrHandle:{href:function(a){return a.getAttribute("href")},type:function(a){return a.getAttribute("type")}},relative:{"+":function(a,c){var d=typeof c==="string",f=d&&!j.test(c),d=d&&!f;f&&(c=c.toLowerCase());for(var f=0,i=a.length,b;f<i;f++)if(b=a[f]){for(;(b=b.previousSibling)&&b.nodeType!==1;);a[f]=d||b&&b.nodeName.toLowerCase()===c?b||false:b===c}d&&o.filter(c,a,true)},">":function(a,c){var d,f=typeof c==="string",i=0,b=a.length;if(f&&!j.test(c))for(c=c.toLowerCase();i<b;i++){if(d=
a[i]){d=d.parentNode;a[i]=d.nodeName.toLowerCase()===c?d:false}}else{for(;i<b;i++)(d=a[i])&&(a[i]=f?d.parentNode:d.parentNode===c);f&&o.filter(c,a,true)}},"":function(d,f,b){var h,m=i++,e=c;if(typeof f==="string"&&!j.test(f)){h=f=f.toLowerCase();e=a}e("parentNode",f,m,d,h,b)},"~":function(d,f,b){var h,m=i++,e=c;if(typeof f==="string"&&!j.test(f)){h=f=f.toLowerCase();e=a}e("previousSibling",f,m,d,h,b)}},find:{ID:function(a,c,d){if(typeof c.getElementById!=="undefined"&&!d)return(a=c.getElementById(a[1]))&&
...
" ").indexOf(a)>=0)?d||f.push(h):d&&(c[b]=false));return false},ID:function(a){return a[1].replace(g,"")},TAG:function(a){return a[1].replace(g,"").toLowerCase()},CHILD:function(a){if(a[1]==="nth"){a[2]||o.error(a[0]);a[2]=a[2].replace(/^\+|\s*/g,"");var c=/(-?)(\d*)(?:n([+\-]?\d*))?/.exec(a[2]==="even"&&"2n"||a[2]==="odd"&&"2n+1"||!/\D/.test(a[2])&&"0n+"+a[2]||a[2]);a[2]=c[1]+(c[2]||1)-0;a[3]=c[3]-0}else a[2]&&o.error(a[0]);a[0]=i++;return a},ATTR:function(a,c,d,f,i,b){c=a[1]=a[1].replace(g,"");
...
d[3]-0},nth:function(a,c,d){return d[3]-0===c},eq:function(a,c,d){return d[3]-0===c}},filter:{PSEUDO:function(a,c,d,f){var i=c[1],b=k.filters[i];if(b)return b(a,d,c,f);if(i==="contains")return(a.textContent||a.innerText||o.getText([a])||"").indexOf(c[3])>=0;if(i==="not"){c=c[3];d=0;for(f=c.length;d<f;d++)if(c[d]===a)return false;return true}o.error(i)},CHILD:function(a,c){var d=c[1],f=a;switch(d){case "only":case "first":for(;f=f.previousSibling;)if(f.nodeType===1)return false;if(d==="first")return true;
...
d,c,f)}}},t=k.match.POS,n=function(a,c){return"\\"+(c-0+1)},p;for(p in k.match){k.match[p]=RegExp(k.match[p].source+/(?![^\[]*\])(?![^\(]*\))/.source);k.leftMatch[p]=RegExp(/(^(?:.|\r|\n)*?)/.source+k.match[p].source.replace(/\\(\d+)/g,n))}var y=function(a,c){a=Array.prototype.slice.call(a,0);if(c){c.push.apply(c,a);return c}return a};try{Array.prototype.slice.call(s.documentElement.childNodes,0)[0].nodeType}catch(r){y=function(a,c){var d=0,f=c||[];if(b.call(a)==="[object Array]")Array.prototype.push.apply(f,
a);else if(typeof a.length==="number")for(var i=a.length;d<i;d++)f.push(a[d]);else for(;a[d];d++)f.push(a[d]);return f}}var q,B;if(s.documentElement.compareDocumentPosition)q=function(a,c){if(a===c){h=true;return 0}return!a.compareDocumentPosition||!c.compareDocumentPosition?a.compareDocumentPosition?-1:1:a.compareDocumentPosition(c)&4?-1:1};else{q=function(a,c){if(a===c){h=true;return 0}if(a.sourceIndex&&c.sourceIndex)return a.sourceIndex-c.sourceIndex;var d,f,i=[],b=[];d=a.parentNode;f=c.parentNode;
var m=d;if(d===f)return B(a,c);if(d){if(!f)return 1}else return-1;for(;m;){i.unshift(m);m=m.parentNode}for(m=f;m;){b.unshift(m);m=m.parentNode}d=i.length;f=b.length;for(m=0;m<d&&m<f;m++)if(i[m]!==b[m])return B(i[m],b[m]);return m===d?B(a,b[m],-1):B(i[m],c,1)};B=function(a,c,d){if(a===c)return d;for(a=a.nextSibling;a;){if(a===c)return-1;a=a.nextSibling}return 1}}o.getText=function(a){for(var c="",d,f=0;a[f];f++){d=a[f];d.nodeType===3||d.nodeType===4?c=c+d.nodeValue:d.nodeType!==8&&(c=c+o.getText(d.childNodes))}return c};
...
d,f,i)};for(var d in a)o[d]=a[d];c=null}}();(function(){var a=s.documentElement,c=a.matchesSelector||a.mozMatchesSelector||a.webkitMatchesSelector||a.msMatchesSelector;if(c){var d=!c.call(s.createElement("div"),"div"),f=false;try{c.call(s.documentElement,"[test!='']:sizzle")}catch(i){f=true}o.matchesSelector=function(a,i){i=i.replace(/\=\s*([^'"\]]*)\s*\]/g,"='$1']");if(!o.isXML(a))try{if(f||!k.match.PSEUDO.test(i)&&!/!=/.test(i)){var b=c.call(a,i);if(b||!d||a.document&&a.document.nodeType!==11)return b}}catch(h){}return o(i,
...
c&&(a.contains?a.contains(c):true)}:s.documentElement.compareDocumentPosition?function(a,c){return!!(a.compareDocumentPosition(c)&16)}:function(){return false};o.isXML=function(a){return(a=(a?a.ownerDocument||a:0).documentElement)?a.nodeName!=="HTML":false};var F=function(a,c){for(var d,f=[],i="",b=c.nodeType?[c]:c;d=k.match.PSEUDO.exec(a);){i=i+d[0];a=a.replace(k.match.PSEUDO,"")}a=k.relative[a]?a+"*":a;d=0;for(var h=b.length;d<h;d++)o(a,b[d],f);return o.filter(i,f)};d.find=o;d.expr=o.selectors;
d.expr[":"]=d.expr.filters;d.unique=o.uniqueSort;d.text=o.getText;d.isXMLDoc=o.isXML;d.contains=o.contains})();var ib=/Until$/,jb=/^(?:parents|prevUntil|prevAll)/,kb=/,/,Va=/^.[^:#\[\.,]*$/,lb=Array.prototype.slice,Ba=d.expr.match.POS,mb={children:!0,contents:!0,next:!0,prev:!0};d.fn.extend({find:function(a){var c=this,f,i;if(typeof a!=="string")return d(a).filter(function(){f=0;for(i=c.length;f<i;f++)if(d.contains(c[f],this))return true});var b=this.pushStack("","find",a),h,e,l;f=0;for(i=this.length;f<
...
"nextSibling",f)},prevUntil:function(a,c,f){return d.dir(a,"previousSibling",f)},siblings:function(a){return d.sibling(a.parentNode.firstChild,a)},children:function(a){return d.sibling(a.firstChild)},contents:function(a){return d.nodeName(a,"iframe")?a.contentDocument||a.contentWindow.document:d.makeArray(a.childNodes)}},function(a,c){d.fn[a]=function(f,i){var b=d.map(this,c,f),h=lb.call(arguments);ib.test(a)||(i=f);i&&typeof i==="string"&&(b=d.filter(i,b));b=this.length>1&&!mb[a]?d.unique(b):b;if((this.length>
1||kb.test(i))&&jb.test(a))b=b.reverse();return this.pushStack(b,a,h.join(","))}});d.extend({filter:function(a,c,f){f&&(a=":not("+a+")");return c.length===1?d.find.matchesSelector(c[0],a)?[c[0]]:[]:d.find.matches(a,c)},dir:function(a,c,f){for(var i=[],a=a[c];a&&a.nodeType!==9&&(f===e||a.nodeType!==1||!d(a).is(f));){a.nodeType===1&&i.push(a);a=a[c]}return i},nth:function(a,c,d){for(var c=c||1,i=0;a;a=a[d])if(a.nodeType===1&&++i===c)break;return a},sibling:function(a,c){for(var d=[];a;a=a.nextSibling)a.nodeType===
1&&a!==c&&d.push(a);return d}});var nb=/ jQuery\d+="(?:\d+|null)"/g,oa=/^\s+/,Ca=/<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/ig,Da=/<([\w:]+)/,ob=/<tbody/i,pb=/<|&#?\w+;/,Ea=/<(?:script|object|embed|option|style)/i,Fa=/checked\s*(?:[^=]|=\s*.checked.)/i,qb=/\/(java|ecma)script/i,Wa=/^\s*<!(?:\[CDATA\[|\-\-)/,D={option:[1,"<select multiple='multiple'>","</select>"],legend:[1,"<fieldset>","</fieldset>"],thead:[1,"<table>","</table>"],tr:[2,"<table><tbody>","</tbody></table>"],
td:[3,"<table><tbody><tr>","</tr></tbody></table>"],col:[2,"<table><tbody></tbody><colgroup>","</colgroup></table>"],area:[1,"<map>","</map>"],_default:[0,"",""]};D.optgroup=D.option;D.tbody=D.tfoot=D.colgroup=D.caption=D.thead;D.th=D.td;d.support.htmlSerialize||(D._default=[1,"div<div>","</div>"]);d.fn.extend({text:function(a){return d.isFunction(a)?this.each(function(c){var f=d(this);f.text(a.call(this,c,f.text()))}):typeof a!=="object"&&a!==e?this.empty().append((this[0]&&this[0].ownerDocument||
...
e)return this[0]&&this[0].nodeType===1?this[0].innerHTML.replace(nb,""):null;if(typeof a==="string"&&!Ea.test(a)&&(d.support.leadingWhitespace||!oa.test(a))&&!D[(Da.exec(a)||["",""])[1].toLowerCase()]){a=a.replace(Ca,"<$1></$2>");try{for(var c=0,f=this.length;c<f;c++)if(this[c].nodeType===1){d.cleanData(this[c].getElementsByTagName("*"));this[c].innerHTML=a}}catch(i){this.empty().append(a)}}else d.isFunction(a)?this.each(function(c){var f=d(this);f.html(a.call(this,c,f.html()))}):this.empty().append(a);
...
0,h=f.length;b<h;b++){var e=(b>0?this.clone(true):this).get();d(f[b])[c](e);i=i.concat(e)}return this.pushStack(i,a,f.selector)}});d.extend({clone:function(a,c,f){var i=a.cloneNode(true),b,h,e;if((!d.support.noCloneEvent||!d.support.noCloneChecked)&&(a.nodeType===1||a.nodeType===11)&&!d.isXMLDoc(a)){r(a,i);b=w(a);h=w(i);for(e=0;b[e];++e)h[e]&&r(b[e],h[e])}if(c){I(a,i);if(f){b=w(a);h=w(i);for(e=0;b[e];++e)I(b[e],h[e])}}return i},clean:function(a,c,f,i){c=c||s;typeof c.createElement==="undefined"&&
(c=c.ownerDocument||c[0]&&c[0].ownerDocument||s);for(var b=[],e,l=0,g;(g=a[l])!=null;l++){typeof g==="number"&&(g=g+"");if(g){if(typeof g==="string")if(pb.test(g)){g=g.replace(Ca,"<$1></$2>");e=(Da.exec(g)||["",""])[1].toLowerCase();var j=D[e]||D._default,o=j[0],k=c.createElement("div");for(k.innerHTML=j[1]+g+j[2];o--;)k=k.lastChild;if(!d.support.tbody){o=ob.test(g);j=e==="table"&&!o?k.firstChild&&k.firstChild.childNodes:j[1]==="<table>"&&!o?k.childNodes:[];for(e=j.length-1;e>=0;--e)d.nodeName(j[e],
"tbody")&&!j[e].childNodes.length&&j[e].parentNode.removeChild(j[e])}!d.support.leadingWhitespace&&oa.test(g)&&k.insertBefore(c.createTextNode(oa.exec(g)[0]),k.firstChild);g=k.childNodes}else g=c.createTextNode(g);var t;if(!d.support.appendChecked)if(g[0]&&typeof(t=g.length)==="number")for(e=0;e<t;e++)h(g[e]);else h(g);g.nodeType?b.push(g):b=d.merge(b,g)}}if(f){a=function(a){return!a.type||qb.test(a.type)};for(l=0;b[l];l++)if(i&&d.nodeName(b[l],"script")&&(!b[l].type||b[l].type.toLowerCase()==="text/javascript"))i.push(b[l].parentNode?
...
null}e?delete g[d.expando]:g.removeAttribute&&g.removeAttribute(d.expando);delete i[f]}}});var pa=/alpha\([^)]*\)/i,rb=/opacity=([^)]*)/,sb=/([A-Z]|^ms)/g,Ga=/^-?\d+(?:px)?$/i,tb=/^-?\d/,ub=/^([\-+])=([\-+.\de]+)/,vb={position:"absolute",visibility:"hidden",display:"block"},Xa=["Left","Right"],Ya=["Top","Bottom"],T,Ha,Ia;d.fn.css=function(a,c){return arguments.length===2&&c===e?this:d.access(this,a,c,true,function(a,c,b){return b!==e?d.style(a,c,b):d.css(a,c)})};d.extend({cssHooks:{opacity:{get:function(a,
c){if(c){var d=T(a,"opacity","opacity");return d===""?"1":d}return a.style.opacity}}},cssNumber:{fillOpacity:!0,fontWeight:!0,lineHeight:!0,opacity:!0,orphans:!0,widows:!0,zIndex:!0,zoom:!0},cssProps:{"float":d.support.cssFloat?"cssFloat":"styleFloat"},style:function(a,c,f,i){if(a&&!(a.nodeType===3||a.nodeType===8||!a.style)){var b,h=d.camelCase(c),l=a.style,g=d.cssHooks[h],c=d.cssProps[h]||h;if(f!==e){i=typeof f;if(i==="string"&&(b=ub.exec(f))){f=+(b[1]+1)*+b[2]+parseFloat(d.css(a,c));i="number"}if(!(f==
null||i==="number"&&isNaN(f))){i==="number"&&!d.cssNumber[h]&&(f=f+"px");if(!g||!("set"in g)||(f=g.set(a,f))!==e)try{l[c]=f}catch(j){}}}else return g&&"get"in g&&(b=g.get(a,false,i))!==e?b:l[c]}},css:function(a,c,f){var b,h,c=d.camelCase(c);h=d.cssHooks[c];c=d.cssProps[c]||c;c==="cssFloat"&&(c="float");if(h&&"get"in h&&(b=h.get(a,true,f))!==e)return b;if(T)return T(a,c)},swap:function(a,c,d){var b={},h;for(h in c){b[h]=a.style[h];a.style[h]=c[h]}d.call(a);for(h in c)a.style[h]=b[h]}});d.curCSS=d.css;
d.each(["height","width"],function(a,c){d.cssHooks[c]={get:function(a,b,h){var e;if(b){if(a.offsetWidth!==0)return o(a,c,h);d.swap(a,vb,function(){e=o(a,c,h)});return e}},set:function(a,c){if(Ga.test(c)){c=parseFloat(c);if(c>=0)return c+"px"}else return c}}});d.support.opacity||(d.cssHooks.opacity={get:function(a,c){return rb.test((c&&a.currentStyle?a.currentStyle.filter:a.style.filter)||"")?parseFloat(RegExp.$1)/100+"":c?"1":""},set:function(a,c){var f=a.style,b=a.currentStyle,h=d.isNaN(c)?"":"alpha(opacity="+
c*100+")",e=b&&b.filter||f.filter||"";f.zoom=1;if(c>=1&&d.trim(e.replace(pa,""))===""){f.removeAttribute("filter");if(b&&!b.filter)return}f.filter=pa.test(e)?e.replace(pa,h):e+" "+h}});d(function(){if(!d.support.reliableMarginRight)d.cssHooks.marginRight={get:function(a,c){var f;d.swap(a,{display:"inline-block"},function(){f=c?T(a,"margin-right","marginRight"):a.style.marginRight});return f}}});s.defaultView&&s.defaultView.getComputedStyle&&(Ha=function(a,c){var f,b,c=c.replace(sb,"-$1").toLowerCase();
if(!(b=a.ownerDocument.defaultView))return e;if(b=b.getComputedStyle(a,null)){f=b.getPropertyValue(c);f===""&&!d.contains(a.ownerDocument.documentElement,a)&&(f=d.style(a,c))}return f});s.documentElement.currentStyle&&(Ia=function(a,c){var d,b=a.currentStyle&&a.currentStyle[c],h=a.runtimeStyle&&a.runtimeStyle[c],e=a.style;if(!Ga.test(b)&&tb.test(b)){d=e.left;if(h)a.runtimeStyle.left=a.currentStyle.left;e.left=c==="fontSize"?"1em":b||0;b=e.pixelLeft+"px";e.left=d;if(h)a.runtimeStyle.left=h}return b===
""?"auto":b});T=Ha||Ia;d.expr&&d.expr.filters&&(d.expr.filters.hidden=function(a){var c=a.offsetHeight;return a.offsetWidth===0&&c===0||!d.support.reliableHiddenOffsets&&(a.style.display||d.css(a,"display"))==="none"},d.expr.filters.visible=function(a){return!d.expr.filters.hidden(a)});var wb=/%20/g,Za=/\[\]$/,Ja=/\r?\n/g,xb=/#.*$/,yb=/^(.*?):[ \t]*([^\r\n]*)\r?$/mg,zb=/^(?:color|date|datetime|datetime-local|email|hidden|month|number|password|range|search|tel|text|time|url|week)$/i,Ab=/^(?:GET|HEAD)$/,
Bb=/^\/\//,Ka=/\?/,Cb=/<script\b[^<]*(?:(?!<\/script>)<[^<]*)*<\/script>/gi,Db=/^(?:select|textarea)/i,ra=/\s+/,Eb=/([?&])_=[^&]*/,La=/^([\w\+\.\-]+:)(?:\/\/([^\/?#:]*)(?::(\d+))?)?/,Ma=d.fn.load,ha={},Na={},M,O,Oa=["*/"]+["*"];try{M=R.href}catch(Kb){M=s.createElement("a"),M.href="",M=M.href}O=La.exec(M.toLowerCase())||[];d.fn.extend({load:function(a,c,f){if(typeof a!=="string"&&Ma)return Ma.apply(this,arguments);if(!this.length)return this;var b=a.indexOf(" ");if(b>=0)var h=a.slice(b,a.length),a=
a.slice(0,b);b="GET";if(c)if(d.isFunction(c)){f=c;c=e}else if(typeof c==="object"){c=d.param(c,d.ajaxSettings.traditional);b="POST"}var l=this;d.ajax({url:a,type:b,dataType:"html",data:c,complete:function(a,c,b){b=a.responseText;if(a.isResolved()){a.done(function(a){b=a});l.html(h?d("<div>").append(b.replace(Cb,"")).find(h):b)}f&&l.each(f,[b,c,a])}});return this},serialize:function(){return d.param(this.serializeArray())},serializeArray:function(){return this.map(function(){return this.elements?d.makeArray(this.elements):
this}).filter(function(){return this.name&&!this.disabled&&(this.checked||Db.test(this.nodeName)||zb.test(this.type))}).map(function(a,c){var f=d(this).val();return f==null?null:d.isArray(f)?d.map(f,function(a){return{name:c.name,value:a.replace(Ja,"\r\n")}}):{name:c.name,value:f.replace(Ja,"\r\n")}}).get()}});d.each("ajaxStart,ajaxStop,ajaxComplete,ajaxError,ajaxSuccess,ajaxSend".split(","),function(a,c){d.fn[c]=function(a){return this.bind(c,a)}});d.each(["get","post"],function(a,c){d[c]=function(a,
b,h,l){if(d.isFunction(b)){l=l||h;h=b;b=e}return d.ajax({type:c,url:a,data:b,success:h,dataType:l})}});d.extend({getScript:function(a,c){return d.get(a,e,c,"script")},getJSON:function(a,c,f){return d.get(a,c,f,"json")},ajaxSetup:function(a,c){if(c)x(a,d.ajaxSettings);else{c=a;a=d.ajaxSettings}x(a,c);return a},ajaxSettings:{url:M,isLocal:/^(?:about|app|app\-storage|.+\-extension|file|res|widget):$/.test(O[1]),global:!0,type:"GET",contentType:"application/x-www-form-urlencoded",processData:!0,async:!0,
accepts:{xml:"application/xml, text/xml",html:"text/html",text:"text/plain",json:"application/json, text/javascript","*":Oa},contents:{xml:/xml/,html:/html/,json:/json/},responseFields:{xml:"responseXML",text:"responseText"},converters:{"* text":g.String,"text html":!0,"text json":d.parseJSON,"text xml":d.parseXML},flatOptions:{context:!0,url:!0}},ajaxPrefilter:y(ha),ajaxTransport:y(Na),ajax:function(a,c){function f(a,c,f,t){if(B!==2){B=2;r&&clearTimeout(r);s=e;n=t||"";x.readyState=a>0?4:0;var p,
y,q,t=c;if(f){var z=b,H=x,P=z.contents,C=z.dataTypes,I=z.responseFields,v,w,J,U;for(w in I)w in f&&(H[I[w]]=f[w]);for(;C[0]==="*";){C.shift();v===e&&(v=z.mimeType||H.getResponseHeader("content-type"))}if(v)for(w in P)if(P[w]&&P[w].test(v)){C.unshift(w);break}if(C[0]in f)J=C[0];else{for(w in f){if(!C[0]||z.converters[w+" "+C[0]]){J=w;break}U||(U=w)}J=J||U}if(J){J!==C[0]&&C.unshift(J);f=f[J]}else f=void 0}else f=e;if(a>=200&&a<300||a===304){if(b.ifModified){if(v=x.getResponseHeader("Last-Modified"))d.lastModified[k]=
v;if(v=x.getResponseHeader("Etag"))d.etag[k]=v}if(a===304){t="notmodified";p=true}else try{v=b;v.dataFilter&&(f=v.dataFilter(f,v.dataType));var E=v.dataTypes;w={};var R,A,Sa=E.length,G,D=E[0],S,L,Q,K,M;for(R=1;R<Sa;R++){if(R===1)for(A in v.converters)typeof A==="string"&&(w[A.toLowerCase()]=v.converters[A]);S=D;D=E[R];if(D==="*")D=S;else if(S!=="*"&&S!==D){L=S+" "+D;Q=w[L]||w["* "+D];if(!Q){M=e;for(K in w){G=K.split(" ");if(G[0]===S||G[0]==="*")if(M=w[G[1]+" "+D]){K=w[K];K===true?Q=M:M===true&&(Q=
K);break}}}!Q&&!M&&d.error("No conversion from "+L.replace(" "," to "));Q!==true&&(f=Q?Q(f):M(K(f)))}}y=f;t="success";p=true}catch(O){t="parsererror";q=O}}else{q=t;if(!t||a){t="error";a<0&&(a=0)}}x.status=a;x.statusText=""+(c||t);p?g.resolveWith(h,[y,t,x]):g.rejectWith(h,[x,t,q]);x.statusCode(o);o=e;F&&l.trigger("ajax"+(p?"Success":"Error"),[x,b,p?y:q]);j.resolveWith(h,[x,t]);if(F){l.trigger("ajaxComplete",[x,b]);--d.active||d.event.trigger("ajaxStop")}}}if(typeof a==="object"){c=a;a=e}var c=c||{},
b=d.ajaxSetup({},c),h=b.context||b,l=h!==b&&(h.nodeType||h instanceof d)?d(h):d.event,g=d.Deferred(),j=d._Deferred(),o=b.statusCode||{},k,t={},p={},n,y,s,r,q,B=0,F,z,x={readyState:0,setRequestHeader:function(a,c){if(!B){var d=a.toLowerCase(),a=p[d]=p[d]||a;t[a]=c}return this},getAllResponseHeaders:function(){return B===2?n:null},getResponseHeader:function(a){var c;if(B===2){if(!y)for(y={};c=yb.exec(n);)y[c[1].toLowerCase()]=c[2];c=y[a.toLowerCase()]}return c===e?null:c},overrideMimeType:function(a){if(!B)b.mimeType=
a;return this},abort:function(a){a=a||"abort";s&&s.abort(a);f(0,a);return this}};g.promise(x);x.success=x.done;x.error=x.fail;x.complete=j.done;x.statusCode=function(a){if(a){var c;if(B<2)for(c in a)o[c]=[o[c],a[c]];else{c=a[x.status];x.then(c,c)}}return this};b.url=((a||b.url)+"").replace(xb,"").replace(Bb,O[1]+"//");b.dataTypes=d.trim(b.dataType||"*").toLowerCase().split(ra);if(b.crossDomain==null){q=La.exec(b.url.toLowerCase());b.crossDomain=!(!q||!(q[1]!=O[1]||q[2]!=O[2]||(q[3]||(q[1]==="http:"?
80:443))!=(O[3]||(O[1]==="http:"?80:443))))}if(b.data&&b.processData&&typeof b.data!=="string")b.data=d.param(b.data,b.traditional);H(ha,b,c,x);if(B===2)return false;F=b.global;b.type=b.type.toUpperCase();b.hasContent=!Ab.test(b.type);F&&d.active++===0&&d.event.trigger("ajaxStart");if(!b.hasContent){if(b.data){b.url=b.url+((Ka.test(b.url)?"&":"?")+b.data);delete b.data}k=b.url;if(b.cache===false){q=d.now();var P=b.url.replace(Eb,"$1_="+q);b.url=P+(P===b.url?(Ka.test(b.url)?"&":"?")+"_="+q:"")}}(b.data&&
b.hasContent&&b.contentType!==false||c.contentType)&&x.setRequestHeader("Content-Type",b.contentType);if(b.ifModified){k=k||b.url;d.lastModified[k]&&x.setRequestHeader("If-Modified-Since",d.lastModified[k]);d.etag[k]&&x.setRequestHeader("If-None-Match",d.etag[k])}x.setRequestHeader("Accept",b.dataTypes[0]&&b.accepts[b.dataTypes[0]]?b.accepts[b.dataTypes[0]]+(b.dataTypes[0]!=="*"?", "+Oa+"; q=0.01":""):b.accepts["*"]);for(z in b.headers)x.setRequestHeader(z,b.headers[z]);if(b.beforeSend&&(b.beforeSend.call(h,
x,b)===false||B===2)){x.abort();return false}for(z in{success:1,error:1,complete:1})x[z](b[z]);if(s=H(Na,b,c,x)){x.readyState=1;F&&l.trigger("ajaxSend",[x,b]);b.async&&b.timeout>0&&(r=setTimeout(function(){x.abort("timeout")},b.timeout));try{B=1;s.send(t,f)}catch(C){B<2?f(-1,C):d.error(C)}}else f(-1,"No Transport");return x},param:function(a,c){var b=[],h=function(a,c){c=d.isFunction(c)?c():c;b[b.length]=encodeURIComponent(a)+"="+encodeURIComponent(c)};if(c===e)c=d.ajaxSettings.traditional;if(d.isArray(a)||
a.jquery&&!d.isPlainObject(a))d.each(a,function(){h(this.name,this.value)});else for(var l in a)C(l,a[l],c,h);return b.join("&").replace(wb,"+")}});d.extend({active:0,lastModified:{},etag:{}});var Fb=d.now(),ea=/(\=)\?(&|$)|\?\?/i;d.ajaxSetup({jsonp:"callback",jsonpCallback:function(){return d.expando+"_"+Fb++}});d.ajaxPrefilter("json jsonp",function(a,c,b){c=a.contentType==="application/x-www-form-urlencoded"&&typeof a.data==="string";if(a.dataTypes[0]==="jsonp"||a.jsonp!==false&&(ea.test(a.url)||
c&&ea.test(a.data))){var h,e=a.jsonpCallback=d.isFunction(a.jsonpCallback)?a.jsonpCallback():a.jsonpCallback,l=g[e],j=a.url,o=a.data,k="$1"+e+"$2";if(a.jsonp!==false){j=j.replace(ea,k);if(a.url===j){c&&(o=o.replace(ea,k));a.data===o&&(j=j+((/\?/.test(j)?"&":"?")+a.jsonp+"="+e))}}a.url=j;a.data=o;g[e]=function(a){h=[a]};b.always(function(){g[e]=l;if(h&&d.isFunction(l))g[e](h[0])});a.converters["script json"]=function(){h||d.error(e+" was not called");return h[0]};a.dataTypes[0]="json";return"script"}});
...
c.async="async";if(a.scriptCharset)c.charset=a.scriptCharset;c.src=a.url;c.onload=c.onreadystatechange=function(a,b){if(b||!c.readyState||/loaded|complete/.test(c.readyState)){c.onload=c.onreadystatechange=null;d&&c.parentNode&&d.removeChild(c);c=e;b||h(200,"success")}};d.insertBefore(c,d.firstChild)},abort:function(){if(c)c.onload(0,1)}}}});var qa=g.ActiveXObject?function(){for(var a in X)X[a](0,1)}:!1,Gb=0,X;d.ajaxSettings.xhr=g.ActiveXObject?function(){var a;if(!(a=!this.isLocal&&J()))a:{try{a=
new g.ActiveXObject("Microsoft.XMLHTTP");break a}catch(c){}a=void 0}return a}:J;(function(a){d.extend(d.support,{ajax:!!a,cors:!!a&&"withCredentials"in a})})(d.ajaxSettings.xhr());d.support.ajax&&d.ajaxTransport(function(a){if(!a.crossDomain||d.support.cors){var c;return{send:function(b,h){var l=a.xhr(),j,o;a.username?l.open(a.type,a.url,a.async,a.username,a.password):l.open(a.type,a.url,a.async);if(a.xhrFields)for(o in a.xhrFields)l[o]=a.xhrFields[o];a.mimeType&&l.overrideMimeType&&l.overrideMimeType(a.mimeType);
!a.crossDomain&&!b["X-Requested-With"]&&(b["X-Requested-With"]="XMLHttpRequest");try{for(o in b)l.setRequestHeader(o,b[o])}catch(k){}l.send(a.hasContent&&a.data||null);c=function(b,f){var g,o,k,t,p;try{if(c&&(f||l.readyState===4)){c=e;if(j){l.onreadystatechange=d.noop;qa&&delete X[j]}if(f)l.readyState!==4&&l.abort();else{g=l.status;k=l.getAllResponseHeaders();t={};if((p=l.responseXML)&&p.documentElement)t.xml=p;t.text=l.responseText;try{o=l.statusText}catch(n){o=""}!g&&a.isLocal&&!a.crossDomain?g=
t.text?200:404:g===1223&&(g=204)}}}catch(y){f||h(-1,y)}t&&h(g,o,t,k)};if(!a.async||l.readyState===4)c();else{j=++Gb;if(qa){if(!X){X={};d(g).unload(qa)}X[j]=c}l.onreadystatechange=c}},abort:function(){c&&c(0,1)}}}});var ia={},L,V,Hb=/^(?:toggle|show|hide)$/,Ib=/^([+\-]=)?([\d+.\-]+)([a-z%]*)$/i,fa,sa=[["height","marginTop","marginBottom","paddingTop","paddingBottom"],["width","marginLeft","marginRight","paddingLeft","paddingRight"],["opacity"]],ba;d.fn.extend({show:function(a,c,b){if(a||a===0)return this.animate(F("show",
3),a,c,b);for(var b=0,h=this.length;b<h;b++){a=this[b];if(a.style){c=a.style.display;if(!d._data(a,"olddisplay")&&c==="none")c=a.style.display="";c===""&&d.css(a,"display")==="none"&&d._data(a,"olddisplay",U(a.nodeName))}}for(b=0;b<h;b++){a=this[b];if(a.style){c=a.style.display;if(c===""||c==="none")a.style.display=d._data(a,"olddisplay")||""}}return this},hide:function(a,c,b){if(a||a===0)return this.animate(F("hide",3),a,c,b);a=0;for(c=this.length;a<c;a++)if(this[a].style){b=d.css(this[a],"display");
b!=="none"&&!d._data(this[a],"olddisplay")&&d._data(this[a],"olddisplay",b)}for(a=0;a<c;a++)if(this[a].style)this[a].style.display="none";return this},_toggle:d.fn.toggle,toggle:function(a,c,b){var h=typeof a==="boolean";d.isFunction(a)&&d.isFunction(c)?this._toggle.apply(this,arguments):a==null||h?this.each(function(){var c=h?a:d(this).is(":hidden");d(this)[c?"show":"hide"]()}):this.animate(F("toggle",3),a,c,b);return this},fadeTo:function(a,c,d,b){return this.filter(":hidden").css("opacity",0).show().end().animate({opacity:c},
...
for(l in a){b=new d.fx(this,c,l);i=a[l];if(Hb.test(i))b[i==="toggle"?f?"show":"hide":i]();else{h=Ib.exec(i);g=b.cur();if(h){i=parseFloat(h[2]);j=h[3]||(d.cssNumber[l]?"":"px");if(j!=="px"){d.style(this,l,(i||1)+j);g=(i||1)/b.cur()*g;d.style(this,l,g+j)}h[1]&&(i=(h[1]==="-="?-1:1)*i+g);b.custom(g,i,j)}else b.custom(g,i,"")}}return true})},stop:function(a,c){a&&this.queue([]);this.each(function(){var a=d.timers,b=a.length;for(c||d._unmark(true,this);b--;)if(a[b].elem===this){if(c)a[b](true);a.splice(b,
1)}});c||this.dequeue();return this}});d.each({slideDown:F("show",1),slideUp:F("hide",1),slideToggle:F("toggle",1),fadeIn:{opacity:"show"},fadeOut:{opacity:"hide"},fadeToggle:{opacity:"toggle"}},function(a,c){d.fn[a]=function(a,d,b){return this.animate(c,a,d,b)}});d.extend({speed:function(a,c,b){var h=a&&typeof a==="object"?d.extend({},a):{complete:b||!b&&c||d.isFunction(a)&&a,duration:a,easing:b&&c||c&&!d.isFunction(c)&&c};h.duration=d.fx.off?0:typeof h.duration==="number"?h.duration:h.duration in
...
a.now)+a.unit:a.elem[a.prop]=a.now}}});d.expr&&d.expr.filters&&(d.expr.filters.animated=function(a){return d.grep(d.timers,function(c){return a===c.elem}).length});var Jb=/^t(?:able|d|h)$/i,Pa=/^(?:body|html)$/i;d.fn.offset="getBoundingClientRect"in s.documentElement?function(a){var c=this[0],b;if(a)return this.each(function(c){d.offset.setOffset(this,a,c)});if(!c||!c.ownerDocument)return null;if(c===c.ownerDocument.body)return d.offset.bodyOffset(c);try{b=c.getBoundingClientRect()}catch(h){}var e=
...
d.offset.initialize();var b,h=c.offsetParent,e=c.ownerDocument,l=e.documentElement,g=e.body;b=(e=e.defaultView)?e.getComputedStyle(c,null):c.currentStyle;for(var j=c.offsetTop,o=c.offsetLeft;(c=c.parentNode)&&c!==g&&c!==l;){if(d.offset.supportsFixedPosition&&b.position==="fixed")break;b=e?e.getComputedStyle(c,null):c.currentStyle;j=j-c.scrollTop;o=o-c.scrollLeft;if(c===h){j=j+c.offsetTop;o=o+c.offsetLeft;if(d.offset.doesNotAddBorder&&(!d.offset.doesAddBorderForTableAndCells||!Jb.test(c.nodeName))){j=
j+(parseFloat(b.borderTopWidth)||0);o=o+(parseFloat(b.borderLeftWidth)||0)}h=c.offsetParent}if(d.offset.subtractsBorderForOverflowNotVisible&&b.overflow!=="visible"){j=j+(parseFloat(b.borderTopWidth)||0);o=o+(parseFloat(b.borderLeftWidth)||0)}}if(b.position==="relative"||b.position==="static"){j=j+g.offsetTop;o=o+g.offsetLeft}if(d.offset.supportsFixedPosition&&b.position==="fixed"){j=j+Math.max(l.scrollTop,g.scrollTop);o=o+Math.max(l.scrollLeft,g.scrollLeft)}return{top:j,left:o}};d.offset={initialize:function(){var a=
...
(function(g){function e(b,e){for(var g=b.length;g--;)if(b[g]===e)return g;return-1}function b(b,e,g){var j,k,h,l;void 0===g&&(g=e,e="all");b=b.replace(/\s/g,"");j=b.split(",");""==j[j.length-1]&&(j[j.length-2]+=",");for(h=0;h<j.length;h++){k=[];b=j[h].split("+");if(1<b.length){k=b.slice(0,b.length-1);for(l=0;l<k.length;l++)k[l]=A[k[l]];b=[b[b.length-1]]}b=b[0];b=G[b]||b.toUpperCase().charCodeAt(0);b in q||(q[b]=[]);q[b].push({shortcut:j[h],scope:e,method:g,key:j[h],mods:k})}}function j(b,e,g){b.addEventListener?
b.addEventListener(e,g,!1):b.attachEvent&&b.attachEvent("on"+e,function(){g(window.event)})}var k,q={},n={16:!1,18:!1,17:!1,91:!1},v="all",A={"\u21e7":16,shift:16,"\u2325":18,alt:18,option:18,"\u2303":17,ctrl:17,control:17,"\u2318":91,command:91},G={backspace:8,tab:9,clear:12,enter:13,"return":13,esc:27,escape:27,space:32,left:37,up:38,right:39,down:40,del:46,"delete":46,home:36,end:35,pageup:33,pagedown:34,",":188,".":190,"/":191,"`":192,"-":189,"=":187,";":186,"'":222,"[":219,"]":221,"\\":220};
for(k=1;20>k;k++)A["f"+k]=111+k;for(k in A)b[k]=!1;j(document,"keydown",function(g){var j,k,w,E,h;k=(g.target||g.srcElement).tagName;j=g.keyCode;if(93==j||224==j)j=91;if(j in n)for(w in n[j]=!0,A)A[w]==j&&(b[w]=!0);else if(!("INPUT"==k||"SELECT"==k||"TEXTAREA"==k)&&j in q)for(E=0;E<q[j].length;E++)if(k=q[j][E],k.scope==v||"all"==k.scope){h=0<k.mods.length;for(w in n)if(!n[w]&&-1<e(k.mods,+w)||n[w]&&-1==e(k.mods,+w))h=!1;if((0==k.mods.length&&!n[16]&&!n[18]&&!n[17]&&!n[91]||h)&&!1===k.method(g,k))g.preventDefault?
g.preventDefault():g.returnValue=!1,g.stopPropagation&&g.stopPropagation(),g.cancelBubble&&(g.cancelBubble=!0)}});j(document,"keyup",function(e){var e=e.keyCode,g;if(93==e||224==e)e=91;if(e in n)for(g in n[e]=!1,A)A[g]==e&&(b[g]=!1)});g.key=b;g.key.setScope=function(b){v=b||"all"};"undefined"!==typeof module&&(module.exports=key)})(this);
(function(g,e){var b,j=/:([\w\d]+)/g,k=/\?([^#]*)?$/,q=function(b){return Array.prototype.slice.call(b)},n=function(b){return"[object Function]"===Object.prototype.toString.call(b)},v=function(b){return"[object Array]"===Object.prototype.toString.call(b)},A=function(b){return decodeURIComponent((b||"").replace(/\+/g," "))},G=encodeURIComponent,z=function(b){return(""+b).replace(/&(?!\w+;)/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")},I=function(b){return function(e,
g){return this.route.apply(this,[b,e,g])}},r={},w=!(!e.history||!history.pushState),E=[];b=function(){var h=q(arguments),e,j;b.apps=b.apps||{};if(0===h.length||h[0]&&n(h[0]))return b.apply(b,["body"].concat(h));if("string"==typeof(j=h.shift()))return e=b.apps[j]||new b.Application,e.element_selector=j,0<h.length&&g.each(h,function(b,h){e.use(h)}),e.element_selector!=j&&delete b.apps[j],b.apps[e.element_selector]=e};b.VERSION="0.7.0";b.addLogger=function(b){E.push(b)};b.log=function(){var h=q(arguments);
h.unshift("["+Date()+"]");g.each(E,function(e,g){g.apply(b,h)})};"undefined"!=typeof e.console?n(e.console.log.apply)?b.addLogger(function(){e.console.log.apply(e.console,arguments)}):b.addLogger(function(){e.console.log(arguments)}):"undefined"!=typeof console&&b.addLogger(function(){console.log.apply(console,arguments)});g.extend(b,{makeArray:q,isFunction:n,isArray:v,extend:g.extend});b.Object=function(b){return g.extend(this,b||{})};g.extend(b.Object.prototype,{escapeHTML:z,h:z,toHash:function(){var b=
{};g.each(this,function(e,g){n(g)||(b[e]=g)});return b},toHTML:function(){var b="";g.each(this,function(e,g){n(g)||(b+="<strong>"+e+"</strong> "+g+"<br />")});return b},keys:function(b){var e=[],g;for(g in this)(!n(this[g])||!b)&&e.push(g);return e},has:function(b){return this[b]&&""!==g.trim(this[b].toString())},join:function(){var b=q(arguments),e=b.shift();return b.join(e)},log:function(){b.log.apply(b,arguments)},toString:function(b){var e=[];g.each(this,function(g,j){(!n(j)||b)&&e.push('"'+g+
'": '+j.toString())});return"Sammy.Object: {"+e.join(",")+"}"}});b.DefaultLocationProxy=function(b,e){this.app=b;this.is_native=!1;this.has_history=w;this._startPolling(e)};b.DefaultLocationProxy.fullPath=function(b){var e=b.toString().match(/^[^#]*(#.+)$/);return[b.pathname,b.search,e?e[1]:""].join("")};b.DefaultLocationProxy.prototype={bind:function(){var h=this,l=this.app,j=b.DefaultLocationProxy;g(e).bind("hashchange."+this.app.eventNamespace(),function(b,g){!1===h.is_native&&!g&&(h.is_native=
!0,e.clearInterval(j._interval));l.trigger("location-changed")});w&&!l.disable_push_state&&(g(e).bind("popstate."+this.app.eventNamespace(),function(){l.trigger("location-changed")}),g("a").live("click.history-"+this.app.eventNamespace(),function(b){var g=j.fullPath(this);if(this.hostname==e.location.hostname&&l.lookupRoute("get",g))return b.preventDefault(),h.setLocation(g),!1}));j._bindings||(j._bindings=0);j._bindings++},unbind:function(){g(e).unbind("hashchange."+this.app.eventNamespace());g(e).unbind("popstate."+
this.app.eventNamespace());g("a").die("click.history-"+this.app.eventNamespace());b.DefaultLocationProxy._bindings--;0>=b.DefaultLocationProxy._bindings&&e.clearInterval(b.DefaultLocationProxy._interval)},getLocation:function(){return b.DefaultLocationProxy.fullPath(e.location)},setLocation:function(b){/^([^#\/]|$)/.test(b)&&(b=w?"/"+b:"#!/"+b);if(b!=this.getLocation())if(w&&/^\//.test(b))history.pushState({path:b},e.title,b),this.app.trigger("location-changed");else return e.location=b},_startPolling:function(h){var l=
...
g.toString()+") is not defined",j):n(e)?this.error("Plugin Error",j):this.error("Plugin Error: called use() but '"+g.toString()+"' is not a function",j)}return this},setLocationProxy:function(b){var e=this._location_proxy;this._location_proxy=b;this.isRunning()&&(e&&e.unbind(),this._location_proxy.bind())},log:function(){b.log.apply(b,Array.prototype.concat.apply([this.element_selector],arguments))},route:function(b,e,k){var y=this,q=[],x,r;!k&&n(e)&&(k=e=b,b="any");b=b.toLowerCase();if(e.constructor==
String){for(j.lastIndex=0;null!==(r=j.exec(e));)q.push(r[1]);e=RegExp(e.replace(j,"([^/]+)")+"$")}"string"==typeof k&&(k=y[k]);x=function(b){var h={verb:b,path:e,callback:k,param_names:q};y.routes[b]=y.routes[b]||[];y.routes[b].push(h)};"any"===b?g.each(this.ROUTE_VERBS,function(b,h){x(h)}):x(b);return this},get:I("get"),post:I("post"),put:I("put"),del:I("delete"),any:I("any"),mapRoutes:function(b){var e=this;g.each(b,function(b,h){e.route.apply(e,h)});return this},eventNamespace:function(){return["sammy-app",
...
"")},lookupRoute:function(b,e){var g=!1,j=0,k,n;if("undefined"!=typeof this.routes[b])for(k=this.routes[b].length;j<k;j++)if(n=this.routes[b][j],this.routablePath(e).match(n.path)){g=n;break}return g},runRoute:function(b,e,j,k){var n=this,q=this.lookupRoute(b,e),r,v,t,B,F,w,p;this.log("runRoute",[b,e].join(" "));this.trigger("run-route",{verb:b,path:e,params:j});"undefined"==typeof j&&(j={});g.extend(j,this._parseQueryString(e));if(q){this.trigger("route-found",{route:q});if(null!==(w=q.path.exec(this.routablePath(e))))w.shift(),
g.each(w,function(b,h){q.param_names[b]?j[q.param_names[b]]=A(h):(j.splat||(j.splat=[]),j.splat.push(A(h)))});r=new this.context_prototype(this,b,e,j,k);k=this.arounds.slice(0);t=this.befores.slice(0);F=[r].concat(j.splat);v=function(){for(var b;0<t.length;)if(B=t.shift(),n.contextMatchesOptions(r,B[0])&&(b=B[1].apply(r,[r]),!1===b))return!1;n.last_route=q;r.trigger("event-context-before",{context:r});b=q.callback.apply(r,F);r.trigger("event-context-after",{context:r});return b};g.each(k.reverse(),
function(b,h){var d=v;v=function(){return h.apply(r,[d])}});try{p=v()}catch(s){this.error(["500 Error",b,e].join(" "),s)}return p}return this.notFound(b,e)},contextMatchesOptions:function(b,e,g){if("undefined"===typeof e||e=={})return!0;"undefined"===typeof g&&(g=!0);if("string"===typeof e||n(e.test))e={path:e};if(e.only)return this.contextMatchesOptions(b,e.only,!0);if(e.except)return this.contextMatchesOptions(b,e.except,!1);var j=!0,k=!0;e.path&&(n(e.path.test)||(e.path=RegExp(e.path.toString()+
...
g;if(0<b.length){e=this._encodeFormPair(b[0].name,b[0].value);for(g=1;g<b.length;g++)e=e+"&"+this._encodeFormPair(b[g].name,b[g].value)}return e},_encodeFormPair:function(b,e){return G(b)+"="+G(e)},_parseFormParams:function(b){var e={},b=b.serializeArray(),g;for(g=0;g<b.length;g++)e=this._parseParamPair(e,b[g].name,b[g].value);return e},_parseQueryString:function(b){var e={},g,j;if(b=b.match(k)){b=b[1].split("&");for(j=0;j<b.length;j++)g=b[j].split("="),e=this._parseParamPair(e,A(g[0]),A(g[1]||""))}return e},
_parseParamPair:function(b,e,g){b[e]?v(b[e])?b[e].push(g):b[e]=[b[e],g]:b[e]=g;return b},_listen:function(b,e){return this.$element().bind([b,this.eventNamespace()].join("."),e)},_unlisten:function(b,e){return this.$element().unbind([b,this.eventNamespace()].join("."),e)}});b.RenderContext=function(b){this.event_context=b;this.callbacks=[];this.content=this.previous_content=null;this.waiting=this.next_engine=!1};b.RenderContext.prototype=g.extend({},b.Object.prototype,{then:function(b){if(!n(b))if("string"===
...
load:function(b,e,j){var k=this;return this.then(function(){var q,r,v;n(e)?(j=e,e={}):e=g.extend({},e);j&&this.then(j);if("string"===typeof b){q=(v=b.match(/\.json$/)||e.json)&&!0===e.cache||!1!==e.cache;k.next_engine=k.event_context.engineFor(b);delete e.cache;delete e.json;e.engine&&(k.next_engine=e.engine,delete e.engine);if(q&&(r=this.event_context.app.templateCache(b)))return r;this.wait();g.ajax(g.extend({url:b,data:{},dataType:v?"json":null,type:"get",success:function(e){q&&k.event_context.app.templateCache(b,
e);k.next(e)}},e));return!1}if(b.nodeType)return b.innerHTML;if(b.selector)return k.next_engine=b.attr("data-engine"),!1===e.clone?b.remove()[0].innerHTML.toString():b[0].innerHTML.toString()})},loadPartials:function(b){if(b)for(name in this.partials=this.partials||{},b)this.load(b[name]).then(function(b){this.partials[name]=b});return this},render:function(b,e,g,j){return n(b)&&!e?this.then(b):this.loadPartials(j).load(b).interpolate(e,b).then(g)},partial:function(b,e){return this.render(b,e).swap()},
send:function(){var b=this,e=q(arguments),g=e.shift();v(e[0])&&(e=e[0]);return this.then(function(){e.push(function(e){b.next(e)});b.wait();g.apply(g,e);return!1})},collect:function(b,e,j){var k=this,q=function(){n(b)&&(e=b,b=this.content);var j=[],o=!1;g.each(b,function(b,h){var g=e.apply(k,[b,h]);if(g.jquery&&g.length==1){g=g[0];o=true}j.push(g);return g});return o?j:j.join("")};return j?q():this.then(q)},renderEach:function(b,e,j,k){v(e)&&(k=j,j=e,e=null);return this.load(b).then(function(n){var q=
this;j||(j=v(this.previous_content)?this.previous_content:[]);if(k)g.each(j,function(g,j){var t={},o=this.next_engine||b;e?t[e]=j:t=j;k(j,q.event_context.interpolate(n,t,o))});else return this.collect(j,function(g,j){var k={},o=this.next_engine||b;e?k[e]=j:k=j;return this.event_context.interpolate(n,k,o)},true)})},interpolate:function(b,e,g){var j=this;return this.then(function(k,n){!b&&n&&(b=n);this.next_engine&&(e=this.next_engine,this.next_engine=!1);var q=j.event_context.interpolate(k,b,e,this.partials);
return g?n+q:q})},swap:function(){return this.then(function(b){this.event_context.swap(b)}).trigger("changed",{})},appendTo:function(b){return this.then(function(e){g(b).append(e)}).trigger("changed",{})},prependTo:function(b){return this.then(function(e){g(b).prepend(e)}).trigger("changed",{})},replace:function(b){return this.then(function(e){g(b).html(e)}).trigger("changed",{})},trigger:function(b,e){return this.then(function(g){"undefined"==typeof e&&(e={content:g});this.event_context.trigger(b,
e)})}});b.EventContext=function(e,g,j,k,n){this.app=e;this.verb=g;this.path=j;this.params=new b.Object(k);this.target=n};b.EventContext.prototype=g.extend({},b.Object.prototype,{$element:function(){return this.app.$element(q(arguments).shift())},engineFor:function(b){var e;if(n(b))return b;b=(b||this.app.template_engine).toString();if(e=b.match(/\.([^\.\?\#]+)$/))b=e[1];return b&&n(this[b])?this[b]:this.app.template_engine?this.engineFor(this.app.template_engine):function(b){return b}},interpolate:function(b,
...
(function(g){function e(b){b=unescape(b);return"true"===b?!0:"false"===b?!1:b}function b(j,k,q){var n;if(k.match(/^[^\[]+$/))j[k]=e(q);else if(n=k.match(/^([^\[]+)\[\](.*)$/)){k=n[1];n=n[2];if(j[k]&&!g.isArray(j[k]))throw"400 Bad Request";if(n){n=n.match(/^\[([^\]]+)\](.*)$/);if(!n)throw"400 Bad Request";j[k]?j[k][j[k].length-1][n[1]]?j[k].push(b({},n[1]+n[2],q)):g.extend(!0,j[k][j[k].length-1],b({},n[1]+n[2],q)):j[k]=[b({},n[1]+n[2],q)]}else j[k]?j[k].push(e(q)):j[k]=[e(q)]}else if(n=k.match(/^([^\[]+)\[([^\[]+)\](.*)$/)){k=
n[1];n=n[2]+n[3];if(j[k]&&g.isArray(j[k]))throw"400 Bad Request";j[k]?g.extend(!0,j[k],b(j[k],n,q)):j[k]=b({},n,q)}return j}Sammy=Sammy||{};Sammy.NestedParams=function(e){e._parseParamPair=b}})(jQuery);
...
this.options)};Sammy.Store.stores={memory:"Memory",local:"LocalStorage",session:"SessionStorage",cookie:"Cookie"};Sammy.extend(Sammy.Store.prototype,{isAvailable:function(){return Sammy.isFunction(this.storage.isAvailable)?this.storage.isAvailable():!0},exists:function(b,e){this.storage.exists(b,e);return this},set:function(b,g,k){var q="string"==typeof g?g:JSON.stringify(g),n=this,b=b.toString();this.storage.set(b,q,function(){n.app&&(n.app.trigger("set-"+n.name,{key:b,value:g}),n.app.trigger("set-"+
n.name+"-"+b,{key:b,value:g}));e(k,n,g,b)});return this},get:function(b,g){var k=this;this.storage.get(b,function(b){var n;if("undefined"==typeof b||null===b||""===b)n=b;try{n=JSON.parse(b)}catch(v){n=b}e(g,k,n)});return this},clear:function(b,g){var k=this;this.storage.clear(b,function(){e(g,k)});return this},clearAll:function(b){var g=this;this.storage.clearAll(function(){e(b,g)});return this}});Sammy.Store.isAvailable=function(b){try{return Sammy.Store[Sammy.Store.stores[b]].prototype.isAvailable()}catch(e){return!1}};
...
g);e(k,this,g,b)},get:function(b,g){var k=this.storage.getItem(this._key(b));k&&"undefined"!=typeof k.value&&(k=k.value);e(g,this,k)},clear:function(b,g){this.storage.removeItem(this._key(b));e(g,this,b)},clearAll:function(b){for(var g=0,k=this.storage.length,q,n=RegExp("^"+this.key_prefix.replace(".","\\.")+"\\.");g<k;g++)try{q=this.storage.key(g),n.test(q)&&this.storage.removeItem(q)}catch(v){}e(b,this,!0)},_key:function(b){return[this.key_prefix,b].join(".")}});Sammy.Store.SessionStorage=function(b){this.name=
...
p.box.onmouseout=function(){g.focus()};p.box.onmousedown=function(){E=!0};p.box.onmousemove=function(b){if(o||y)o&&G(b),y&&z(b),document.selection?document.selection.empty():window.getSelection&&window.getSelection().removeAllRanges()};p.padM.onmouseup=p.padM.onmouseout=function(){o&&(o=!1,jscolor.fireEvent(h,"change"))};p.padM.onmousedown=function(b){o=!0;G(b)};p.sldM.onmouseup=p.sldM.onmouseout=function(){y&&(y=!1,jscolor.fireEvent(h,"change"))};p.sldM.onmousedown=function(b){y=!0;z(b)};j=k(r);
...
"pointer"}catch(v){p.btn.style.cursor="hand"}p.btn.onmousedown=function(){r.hidePicker()};p.btnS.style.lineHeight=p.btn.style.height;switch(w){case 0:var x="hs.png";break;case 1:x="hv.png"}p.padM.style.backgroundImage="url('"+jscolor.getDir()+"cross.gif')";p.padM.style.backgroundRepeat="no-repeat";p.sldM.style.backgroundImage="url('"+jscolor.getDir()+"arrow.gif')";p.sldM.style.backgroundRepeat="no-repeat";p.pad.style.backgroundImage="url('"+jscolor.getDir()+x+"')";p.pad.style.backgroundRepeat="no-repeat";
p.pad.style.backgroundPosition="0 0";q();n();jscolor.picker.owner=r;document.getElementsByTagName("body")[0].appendChild(p.boxB)}function k(b){return[2*b.pickerInset+2*b.pickerFace+jscolor.images.pad[0]+(b.slider?2*b.pickerInset+2*jscolor.images.arrow[0]+jscolor.images.sld[0]:0),b.pickerClosable?4*b.pickerInset+3*b.pickerFace+jscolor.images.pad[1]+b.pickerButtonHeight:2*b.pickerInset+2*b.pickerFace+jscolor.images.pad[1]]}function q(){switch(w){case 0:var e=1;break;case 1:e=2}var g=Math.round(r.hsv[0]/
6*(jscolor.images.pad[0]-1)),e=Math.round((1-r.hsv[e])*(jscolor.images.pad[1]-1));jscolor.picker.padM.style.backgroundPosition=r.pickerFace+r.pickerInset+g-Math.floor(jscolor.images.cross[0]/2)+"px "+(r.pickerFace+r.pickerInset+e-Math.floor(jscolor.images.cross[1]/2))+"px";g=jscolor.picker.sld.childNodes;switch(w){case 0:for(var h=b(r.hsv[0],r.hsv[1],1),e=0;e<g.length;e+=1)g[e].style.backgroundColor="rgb("+100*h[0]*(1-e/g.length)+"%,"+100*h[1]*(1-e/g.length)+"%,"+100*h[2]*(1-e/g.length)+"%)";break;
case 1:var j,k=[r.hsv[2],0,0],e=Math.floor(r.hsv[0]),l=e%2?r.hsv[0]-e:1-(r.hsv[0]-e);switch(e){case 6:case 0:h=[0,1,2];break;case 1:h=[1,0,2];break;case 2:h=[2,0,1];break;case 3:h=[2,1,0];break;case 4:h=[1,2,0];break;case 5:h=[0,2,1]}for(e=0;e<g.length;e+=1)j=1-1/(g.length-1)*e,k[1]=k[0]*(1-j*l),k[2]=k[0]*(1-j),g[e].style.backgroundColor="rgb("+100*k[h[0]]+"%,"+100*k[h[1]]+"%,"+100*k[h[2]]+"%)"}}function n(){switch(w){case 0:var b=2;break;case 1:b=1}b=Math.round((1-r.hsv[b])*(jscolor.images.sld[1]-
1));jscolor.picker.sldM.style.backgroundPosition="0 "+(r.pickerFace+r.pickerInset+b-Math.floor(jscolor.images.arrow[1]/2))+"px"}function v(){return jscolor.picker&&jscolor.picker.owner===r}function A(){h!==g&&r.importColor()}function G(b){var e=jscolor.getRelMousePos(b),b=e.x-r.pickerFace-r.pickerInset,e=e.y-r.pickerFace-r.pickerInset;switch(w){case 0:r.fromHSV(b*(6/(jscolor.images.pad[0]-1)),1-e/(jscolor.images.pad[1]-1),null,J);break;case 1:r.fromHSV(b*(6/(jscolor.images.pad[0]-1)),null,1-e/(jscolor.images.pad[1]-
1),J)}}function z(b){b=jscolor.getRelMousePos(b).y-r.pickerFace-r.pickerInset;switch(w){case 0:r.fromHSV(null,null,1-b/(jscolor.images.sld[1]-1),C);break;case 1:r.fromHSV(null,1-b/(jscolor.images.sld[1]-1),null,C)}}this.adjust=this.required=!0;this.hash=!1;this.slider=this.caps=!0;this.styleElement=this.valueElement=g;this.hsv=[0,0,1];this.rgb=[1,1,1];this.pickerOnfocus=!0;this.pickerMode="HSV";this.pickerPosition="bottom";this.pickerButtonHeight=20;this.pickerClosable=!1;this.pickerCloseText="Close";
this.pickerButtonColor="ButtonText";this.pickerFace=10;this.pickerFaceColor="ThreeDFace";this.pickerBorder=1;this.pickerBorderColor="ThreeDHighlight ThreeDShadow ThreeDShadow ThreeDHighlight";this.pickerInset=1;this.pickerInsetColor="ThreeDShadow ThreeDHighlight ThreeDHighlight ThreeDShadow";this.pickerZIndex=1E4;for(var I in e)e.hasOwnProperty(I)&&(this[I]=e[I]);this.hidePicker=function(){v()&&(delete jscolor.picker.owner,document.getElementsByTagName("body")[0].removeChild(jscolor.picker.boxB))};
this.showPicker=function(){if(!v()){var b=jscolor.getElementPos(g),e=jscolor.getElementSize(g),h=jscolor.getViewPos(),l=jscolor.getViewSize(),n=k(this),o,q,r;switch(this.pickerPosition.toLowerCase()){case "left":o=1;q=0;r=-1;break;case "right":o=1;q=0;r=1;break;case "top":o=0;q=1;r=-1;break;default:o=0,r=q=1}var d=(e[q]+n[q])/2,b=[-h[o]+b[o]+n[o]>l[o]?-h[o]+b[o]+e[o]/2>l[o]/2&&0<=b[o]+e[o]-n[o]?b[o]+e[o]-n[o]:b[o]:b[o],-h[q]+b[q]+e[q]+n[q]-d+d*r>l[q]?-h[q]+b[q]+e[q]/2>l[q]/2&&0<=b[q]+e[q]-d-d*r?b[q]+
e[q]-d-d*r:b[q]+e[q]-d+d*r:0<=b[q]+e[q]-d+d*r?b[q]+e[q]-d+d*r:b[q]+e[q]-d-d*r];j(b[o],b[q])}};this.importColor=function(){h?this.adjust?!this.required&&/^\s*$/.test(h.value)?(h.value="",l.style.backgroundColor=l.jscStyle.backgroundColor,l.style.color=l.jscStyle.color,this.exportColor(H|x)):this.fromString(h.value)||this.exportColor():this.fromString(h.value,H)||(l.style.backgroundColor=l.jscStyle.backgroundColor,l.style.color=l.jscStyle.color,this.exportColor(H|x)):this.exportColor()};this.exportColor=
function(b){if(!(b&H)&&h){var e=this.toString();this.caps&&(e=e.toUpperCase());this.hash&&(e="#"+e);h.value=e}!(b&x)&&l&&(l.style.backgroundColor="#"+this.toString(),l.style.color=0.5>0.213*this.rgb[0]+0.715*this.rgb[1]+0.072*this.rgb[2]?"#FFF":"#000");!(b&C)&&v()&&q();!(b&J)&&v()&&n()};this.fromHSV=function(e,g,h,j){0>e&&(e=0)||6<e&&(e=6);0>g&&(g=0)||1<g&&(g=1);0>h&&(h=0)||1<h&&(h=1);this.rgb=b(null===e?this.hsv[0]:this.hsv[0]=e,null===g?this.hsv[1]:this.hsv[1]=g,null===h?this.hsv[2]:this.hsv[2]=
...
(256|Math.round(255*this.rgb[2])).toString(16).substr(1)};var r=this,w="hvs"===this.pickerMode.toLowerCase()?1:0,E=!1,h=jscolor.fetchElement(this.valueElement),l=jscolor.fetchElement(this.styleElement),o=!1,y=!1,H=1,x=2,C=4,J=8;jscolor.addEvent(g,"focus",function(){r.pickerOnfocus&&r.showPicker()});jscolor.addEvent(g,"blur",function(){E?E=!1:window.setTimeout(function(){E||(h===g&&r.importColor(),r.pickerOnfocus&&r.hidePicker());E=!1},0)});h&&(I=function(){r.fromString(h.value,H)},jscolor.addEvent(h,
"keyup",I),jscolor.addEvent(h,"input",I),jscolor.addEvent(h,"blur",A),h.setAttribute("autocomplete","off"));l&&(l.jscStyle={backgroundColor:l.style.backgroundColor,color:l.style.color});switch(w){case 0:jscolor.requireImage("hs.png");break;case 1:jscolor.requireImage("hv.png")}jscolor.requireImage("cross.gif");jscolor.requireImage("arrow.gif");this.importColor()}};jscolor.install();(function(g){g.extend(g.fn,{dimensions:function(){var e=g(this);return{width:e.width(),height:e.height()}}})})(jQuery);
...
$("#metrics-list ul.search-results");g.html("");""!==$("#metrics-menu input.search").val()&&$("<li>").addClass("root").text("..").appendTo(g);for(var k=Graphiti.graphiti_base_url+jscolor.getDir()+"folder.png",q=Graphiti.graphiti_base_url+jscolor.getDir()+"metric.gif",n=0,v=e.length;n<v;n++)Sammy.log(e[n]),$("<li>").addClass("folder").text(e[n]).prepend("<img src="+k+">").hover(function(){$(this).css("font-weight","bold")},function(){$(this).css("font-weight","normal")}).appendTo(g);n=0;for(v=b.length;n<
v;n++)Sammy.log(b[n]),$("<li>").addClass("key").append($("<a rel='add'>Add</a>")).append($("<strong>").text(b[n])).prepend("<img src="+q+">").appendTo(g)},appendFolderToSearchKey:function(e){var b=$("#metrics-menu input.search");""!==b.val()&&b.val(b.val()+".");b.val(b.val()+e)},removeFolderFromSearchKey:function(){var e=$("#metrics-menu input.search");""!==e.val()?e.val(e.val().replace(/\.?\w*$/,"")):e.val("")},bindMetricsList:function(){var e=this,b=$("#metrics-list ul.search-results"),g=$("#metrics-menu input.search");
b.delegate("li.root","click",function(b){b.preventDefault();e.removeFolderFromSearchKey();e.searchFolderAndKeyList(g.val())}).addClass(".bound");b.delegate("li.folder","click",function(b){b.preventDefault();e.appendFolderToSearchKey($(this).text());e.searchFolderAndKeyList(g.val())}).addClass(".bound");b.delegate("li.key","click",function(b){b.preventDefault();var q=g.val(),b=$(this).find("a").attr("rel"),q=q+"."+$(this).find("strong").text();Sammy.log("clicked",b,q);e[b+"GraphMetric"](q)}).addClass(".bound");
g.change(function(){e.searchFolderAndKeyList(g.val())});""==g.val()&&e.searchFolderAndKeyList("")},keywordRequestPending:0,searchFolderAndKeyList:function(e){var b=this,g=++b.keywordRequestPending;this.load("/keywords.js",{cache:!1,data:{q:e}}).then(function(e){g==b.keywordRequestPending&&b.buildMetricsList(e.folders,e.metrics)})},addGraphMetric:function(e){var b=this.getEditorJSON();b.targets.push([e,{}]);this.graphPreview(b);this.setEditorJSON(b)},replaceGraphMetric:function(e){var b=this.getEditorJSON();
b.targets=[[e,{}]];this.graphPreview(b);this.setEditorJSON(b)},timestamp:function(e){"string"==typeof e&&(e=parseInt(e,10));return(new Date(1E3*e)).toString()},buildDashboardsDropdown:function(e){this.load("/dashboards.js",{cache:!1,data:{uuid:e}}).then(function(b){var e=$('select[name="dashboard"]');e.html("");for(var b=b.dashboards,g=0,q=b.length,n;g<q;g++)n=b[g],$("<option />",{value:n.slug,text:n.title}).appendTo(e)})},buildSnapshotsDropdown:function(e,b){var g=$('select[name="snapshot"]');b&&
g.html("");for(var k=0,q=e.length,n,v;k<q;k++)n=e[k],v=this.snapshotURLToDate(n),$("<option />",{value:n,text:v}).prependTo(g).attr("selected","selected")},loadAndRenderGraphs:function(e){var b=this,g=this.showPane("graphs"," ");this.load(e,{cache:!1}).then(function(e){var q="All Graphs",n;e.title?(n=!1,q=e.title):n=!0;g.append("<h2>"+q+"</h2>");var q=e.graphs,v=0,A=q.length,G=$("#templates .graph").clone(),z;if(0==e.graphs.length)return g.append($("#graphs-empty")),!0;for(;v<A;v++)z=q[v],G.clone().find(".title").text(z.title||
"Untitled").end().find("a.edit").attr("href","/graphs/"+z.uuid).end().show().data("graph",z.json).appendTo(g).each(function(){b.drawGraph(z.json,$(this).find("img"));(v+1)%2==0&&$(this).addClass("last");n?$(this).find(".delete").attr("action","/graphs/"+z.uuid):$(this).find(".delete").attr("action","/graphs/dashboards").find("[name=dashboard]").val(e.slug).end().find("[name=uuid]").val(z.uuid).end().find("[type=submit]").val("Remove")})})},drawGraph:function(e,b){var g=JSON.parse(e);$.extend(!0,g,
this.getOptionOverrides());graph_obj=new Graphiti.Graph(g);graph_obj.image(b)},redrawGraphs:function(){var e=this,b=$("#graphs-pane");b.is(":visible")&&b.find(".graph").each(function(){e.drawGraph($(this).data("graph"),$(this).find("img"))})},loadAndRenderDashboards:function(){var e=this.showPane("dashboards","<h2>Dashboards</h2>"),b=this;this.load("/dashboards.js",{cache:!1}).then(function(g){var g=g.dashboards,k=0,q=g.length,n,v,A=$("#templates .dashboard").clone();if(0==g.length)e.append($("#dashboards-empty"));
else for(;k<q;k++)n=g[k],v=0==(k+1)%2?"alt":"",A.clone().find("a.view").attr("href","/dashboards/"+n.slug).end().find(".title").text(n.title).end().find(".graphs-count").text(n.graphs.length).end().find(".updated-at").text(b.timestamp(n.updated_at)).end().find("form.delete").attr("action","/dashboards/"+n.slug).end().addClass(v).show().appendTo(e)})},loadAndRenderSnapshots:function(){var e=this;this.load("/graphs/"+this.params.uuid+".js",{cache:!1}).then(function(b){for(var g=e.showPane("snapshots",
"<h2>"+b.title+" - Snapshots</h2>"),b=b.snapshots,k=0,q=b.length,n,v=$("#templates .snapshot").clone();k<q;k++)n=b[k],v.clone().find("a.view").attr("href",n).end().find("img").attr("src",n).end().find("h3.title").text(e.snapshotURLToDate(n)).end().show().appendTo(g)})},snapshotURLToDate:function(e){var b;try{b=(new Date(parseInt(e.match(/\/(\d+)\.png/)[1],10))).toString()}catch(g){}return b},bindEditorPanes:function(){var e=this;$("#editor-pane").delegate(".edit-group .edit-head","click",function(b){b.preventDefault();
...
confirmDelete:function(e){return confirm("Are you sure you want to delete this "+e+"? There is no undo. You may regret this later.")},showSaving:function(){this.$button=$(this.target).find("input");this.original_button_val=this.$button.val();this.$button.val("Saving").attr("disabled","disabled")},hideSaving:function(){this.$button.val(this.original_button_val).removeAttr("disabled")},bindTimeSelector:function(){var e=this;$("#time-selector").delegate("button","click",function(){var b=$(this);b.val();
b.siblings("button").removeClass("selected");b.addClass("selected");e.redrawGraphs()})},getOptionOverrides:function(){var e=$("#time-selector button.selected").val();return e?{options:{from:e,until:""}}:{}}});this.before({only:{verb:"get"}},function(){this.showPane("loading")});this.get("/graphs/new",function(e){this.session("lastPreview",Graphiti.defaultGraph,function(){e.redirect("/graphs/workspace")})});this.get("/graphs/workspace",function(e){this.session("lastPreview",function(b){e.showEditor(b)})});
this.get("/graphs/:uuid",function(e){this.load("/graphs/"+this.params.uuid+".js",{cache:!1}).then(function(b){e.buildSnapshotsDropdown(b.snapshots,!0);e.showEditor(b.json,e.params.uuid)})});this.get("/graphs/:uuid/snapshots",function(){this.params.snapshot?(window.open(this.params.snapshot,this.snapshotURLToDate(this.params.snapshot)),this.redirect("/graphs",this.params.uuid)):this.loadAndRenderSnapshots()});this.get("/graphs",function(){this.loadAndRenderGraphs("/graphs.js")});this.get("/dashboards/:slug",
function(){this.loadAndRenderGraphs("/dashboards/"+this.params.slug+".js")});this.get("/dashboards",function(){this.loadAndRenderDashboards()});this.del("/dashboards/:slug",function(e){var b=this.params.slug;this.confirmDelete("dashboard")&&$.ajax({type:"post",data:"_method=DELETE",url:"/dashboards/"+b,complete:function(){e.loadAndRenderDashboards()}})});this.del("/graphs/dashboards",function(e){this.confirmDelete("graph")&&$.ajax({type:"post",data:$(e.target).serialize()+"&_method=DELETE",url:"/graphs/dashboards",
success:function(){e.app.refresh()}})});this.del("/graphs/:uuid",function(e){this.confirmDelete("graph")&&$.ajax({type:"post",data:"_method=DELETE",url:"/graphs/"+this.params.uuid,success:function(){e.app.refresh()}})});this.get("",function(){this.loadAndRenderDashboards()});this.post("/graphs",function(e){e.showSaving();(new Graphiti.Graph(this.getEditorJSON())).save(function(b){e.hideSaving();Sammy.log("created",b);b.uuid&&e.redirect("/graphs/"+b.uuid)})});this.put("/graphs/options",function(){this.saveOptions(this.params.options)});
this.post("/graphs/:uuid/snapshots",function(e){e.showSaving();(new Graphiti.Graph(this.getEditorJSON())).snapshot(this.params.uuid,function(b){e.hideSaving();Sammy.log("snapshotted",b);b&&e.buildSnapshotsDropdown([b])})});this.put("/graphs/:uuid",function(e){e.showSaving();(new Graphiti.Graph(this.getEditorJSON())).save(this.params.uuid,function(b){Sammy.log("updated",b);e.hideSaving();e.redrawPreview()})});this.post("/graphs/dashboards",function(e){var b=$(this.target);$.post("/graphs/dashboards",
b.serialize(),function(b){e.buildDashboardsDropdown(b.uuid)})});this.post("/dashboards",function(e){var b=$(this.target);$.post("/dashboards",b.serialize(),function(){b.find("input[type=text]").val("");e.buildDashboardsDropdown();e.trigger("toggle-dashboard-creation",{target:b.parents(".dashboard")})})});this.bind("toggle-dashboard-creation",function(e,b){var g=$(b.target),k=g.find(".new-dashboard"),g=g.find(".add-to-dashboard");k.is(":visible")?(k.hide(),g.show()):(k.show(),g.hide())});this.registerShortcut("redraw-preview",
"g",function(){this.redrawPreview()});this.bind("run",function(){var e=this;this.bindEditorPanes();this.bindMetricsList();this.bindTimeSelector();var b=function(){""==$(this).val().toString()?$(this).siblings(".save").attr("disabled","disabled"):$(this).siblings(".save").removeAttr("disabled")};$('select[name="dashboard"]').live("click",b).live("focus",b).live("blur",b);$('.dashboard button[rel=create], .dashboard a[rel="cancel"]').live("click",function(b){b.preventDefault();e.trigger("toggle-dashboard-creation",
{target:$(this).parents(".dashboard")})});$("#graph-actions").delegate(".redraw","click",function(b){b.preventDefault();e.redrawPreview()})})});$(function(){app.run()});Graphiti=window.Graphiti||{};Graphiti.startRefresh=function(g){this.refreshTimer=setInterval(function(){$("#graphs-pane div.graph img.ggraph").each(function(){var e=$(this),b=e.attr("src");b.replace(/(^.*_timestamp_=).*/,function(b,e){return e+(new Date).getTime()+"000#.png"});e.attr("src",b)})},1E3*g)};Graphiti.stopRefresh=function(){clearInterval(this.refreshTimer)};
