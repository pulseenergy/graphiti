...
setTimeout(function(){!d.data(a,m,e,!0)&&!d.data(a,t,e,!0)&&(d.removeData(a,i,!0),b.resolve())},0)}function p(){return!1}function n(){return!0}function v(a,c,f){var i=d.extend({},f[0]);i.type=a;i.originalEvent={};i.liveFired=e;d.event.handle.call(c,i);i.isDefaultPrevented()&&f[0].preventDefault()}function A(a){var c,f,i,m,t,b,e,h,l,g,j,o=[];m=[];t=d._data(this,"events");if(!(a.liveFired===this||!t||!t.live||a.target.disabled||a.button&&"click"===a.type)){a.namespace&&(j=RegExp("(^|\\.)"+a.namespace.split(".").join("\\.(?:.*\\.)?")+
"(\\.|$)"));a.liveFired=this;var k=t.live.slice(0);for(e=0;e<k.length;e++)t=k[e],t.origType.replace(ga,"")===a.type?m.push(t.selector):k.splice(e--,1);m=d(a.target).closest(m,a.currentTarget);h=0;for(l=m.length;h<l;h++){g=m[h];for(e=0;e<k.length;e++)if(t=k[e],g.selector===t.selector&&(!j||j.test(t.namespace))&&!g.elem.disabled){b=g.elem;i=null;if("mouseenter"===t.preType||"mouseleave"===t.preType)a.type=t.preType,(i=d(a.relatedTarget).closest(t.selector)[0])&&d.contains(b,i)&&(i=b);(!i||i!==b)&&o.push({elem:b,
handleObj:t,level:g.level})}}h=0;for(l=o.length;h<l;h++){m=o[h];if(f&&m.level>f)break;a.currentTarget=m.elem;a.data=m.handleObj.data;a.handleObj=m.handleObj;j=m.handleObj.origHandler.apply(m.elem,arguments);if(!1===j||a.isPropagationStopped())if(f=m.level,!1===j&&(c=!1),a.isImmediatePropagationStopped())break}return c}}function G(a,c){return(a&&"*"!==a?a+".":"")+c.replace(Ta,"`").replace(Ua,"&")}function z(a,c,f){c=c||0;if(d.isFunction(c))return d.grep(a,function(a,d){return!!c.call(a,d,a)===f});
if(c.nodeType)return d.grep(a,function(a){return a===c===f});if("string"===typeof c){var i=d.grep(a,function(a){return 1===a.nodeType});if(Va.test(c))return d.filter(c,i,!f);c=d.filter(c,i)}return d.grep(a,function(a){return 0<=d.inArray(a,c)===f})}function I(a,c){if(1===c.nodeType&&d.hasData(a)){var f=d.expando,i=d.data(a),m=d.data(c,i);if(i=i[f]){var t=i.events,m=m[f]=d.extend({},i);if(t){delete m.handle;m.events={};for(var b in t){f=0;for(i=t[b].length;f<i;f++)d.event.add(c,b+(t[b][f].namespace?
...
V.body.appendChild(f);i=d.css(f,"display");c.removeChild(L)}ia[a]=i}return ia[a]}function q(a){return d.isWindow(a)?a:9===a.nodeType?a.defaultView||a.parentWindow:!1}var s=g.document,O=g.navigator,R=g.location,d=function(){function a(){if(!c.isReady){try{s.documentElement.doScroll("left")}catch(d){setTimeout(a,1);return}c.ready()}}var c=function(a,d){return new c.fn.init(a,d,m)},d=g.jQuery,i=g.$,m,b=/^(?:[^#<]*(<[\w\W]+>)[^>]*$|#([\w\-]*)$)/,h=/\S/,l=/^\s+/,j=/\s+$/,o=/\d/,k=/^<(\w+)\s*\/?>(?:<\/\1>)?$/,
u=/^[\],:{}\s]*$/,n=/\\(?:["\\\/bfnrt]|u[0-9a-fA-F]{4})/g,q=/"[^"\\\n\r]*"|true|false|null|-?\d+(?:\.\d*)?(?:[eE][+\-]?\d+)?/g,y=/(?:^|:|,)(?:\s*\[)+/g,r=/(webkit)[ \/]([\w.]+)/,p=/(opera)(?:.*version)?[ \/]([\w.]+)/,B=/(msie) ([\w.]+)/,F=/(mozilla)(?:.*? rv:([\w.]+))?/,Y=/-([a-z]|[0-9])/ig,$a=/^-ms-/,ab=function(a,c){return(c+"").toUpperCase()},Z=O.userAgent,ca,W,bb=Object.prototype.toString,ja=Object.prototype.hasOwnProperty,z=Array.prototype.push,H=Array.prototype.slice,x=String.prototype.trim,
...
d,f,i,m,b=arguments[0]||{},t=1,h=arguments.length,Y=!1;"boolean"===typeof b&&(Y=b,b=arguments[1]||{},t=2);"object"!==typeof b&&!c.isFunction(b)&&(b={});h===t&&(b=this,--t);for(;t<h;t++)if(null!=(a=arguments[t]))for(d in a)f=b[d],i=a[d],b!==i&&(Y&&i&&(c.isPlainObject(i)||(m=c.isArray(i)))?(m?(m=!1,f=f&&c.isArray(f)?f:[]):f=f&&c.isPlainObject(f)?f:{},b[d]=c.extend(Y,f,i)):i!==e&&(b[d]=i));return b};c.extend({noConflict:function(a){g.$===c&&(g.$=i);a&&g.jQuery===c&&(g.jQuery=d);return c},isReady:!1,
...
try{if(a.constructor&&!ja.call(a,"constructor")&&!ja.call(a.constructor.prototype,"isPrototypeOf"))return!1}catch(d){return!1}for(var f in a);return f===e||ja.call(a,f)},isEmptyObject:function(a){for(var c in a)return!1;return!0},error:function(a){throw a;},parseJSON:function(a){if("string"!==typeof a||!a)return null;a=c.trim(a);if(g.JSON&&g.JSON.parse)return g.JSON.parse(a);if(u.test(a.replace(n,"@").replace(q,"]").replace(y,"")))return(new Function("return "+a))();c.error("Invalid JSON: "+a)},parseXML:function(a){var d,
...
c.toUpperCase()},each:function(a,d,f){var i,m=0,b=a.length,t=b===e||c.isFunction(a);if(f)if(t)for(i in a){if(!1===d.apply(a[i],f))break}else for(;m<b&&!1!==d.apply(a[m++],f););else if(t)for(i in a){if(!1===d.call(a[i],i,a[i]))break}else for(;m<b&&!1!==d.call(a[m],m,a[m++]););return a},trim:x?function(a){return null==a?"":x.call(a)}:function(a){return null==a?"":a.toString().replace(l,"").replace(j,"")},makeArray:function(a,d){var f=d||[];if(null!=a){var i=c.type(a);null==a.length||"string"===i||"function"===
...
if(a instanceof c||h!==e&&"number"===typeof h&&(0<h&&a[0]&&a[h-1]||0===h||c.isArray(a)))for(;t<h;t++)i=d(a[t],t,f),null!=i&&(b[b.length]=i);else for(m in a)i=d(a[m],m,f),null!=i&&(b[b.length]=i);return b.concat.apply([],b)},guid:1,proxy:function(a,d){if("string"===typeof d)var f=a[d],d=a,a=f;if(!c.isFunction(a))return e;var i=H.call(arguments,2),f=function(){return a.apply(d,i.concat(H.call(arguments)))};f.guid=a.guid=a.guid||f.guid||c.guid++;return f},access:function(a,d,f,i,m,b){var t=a.length;
if("object"===typeof d){for(var h in d)c.access(a,h,d[h],i,m,f);return a}if(f!==e){i=!b&&i&&c.isFunction(f);for(h=0;h<t;h++)m(a[h],d,i?f.call(a[h],h,m(a[h],d)):f,b);return a}return t?m(a[0],d):e},now:function(){return(new Date).getTime()},uaMatch:function(a){a=a.toLowerCase();a=r.exec(a)||p.exec(a)||B.exec(a)||0>a.indexOf("compatible")&&F.exec(a)||[];return{browser:a[1]||"",version:a[2]||"0"}},sub:function(){function a(c,d){return new a.fn.init(c,d)}c.extend(!0,a,this);a.superclass=this;a.fn=a.prototype=
...
Ta=/\./g,Ua=/ /g,gb=/[^\w\s.|`]/g,hb=function(a){return a.replace(gb,"\\$&")};d.event={add:function(a,c,f,i){if(!(a.nodeType===3||a.nodeType===8)){if(f===false)f=p;else if(!f)return;var m,b;if(f.handler){m=f;f=m.handler}if(!f.guid)f.guid=d.guid++;if(b=d._data(a)){var h=b.events,l=b.handle;if(!h)b.events=h={};if(!l)b.handle=l=function(a){return typeof d!=="undefined"&&(!a||d.event.triggered!==a.type)?d.event.handle.apply(l.elem,arguments):e};l.elem=a;for(var c=c.split(" "),g,j=0,o;g=c[j++];){b=m?d.extend({},
m):{handler:f,data:i};if(g.indexOf(".")>-1){o=g.split(".");g=o.shift();b.namespace=o.slice(0).sort().join(".")}else{o=[];b.namespace=""}b.type=g;if(!b.guid)b.guid=f.guid;var k=h[g],u=d.event.special[g]||{};if(!k){k=h[g]=[];if(!u.setup||u.setup.call(a,i,o,l)===false)a.addEventListener?a.addEventListener(g,l,false):a.attachEvent&&a.attachEvent("on"+g,l)}if(u.add){u.add.call(a,b);if(!b.handler.guid)b.handler.guid=f.guid}k.push(b);d.event.global[g]=true}a=null}}},global:{},remove:function(a,c,f,i){if(!(a.nodeType===
3||a.nodeType===8)){f===false&&(f=p);var b,h,l=0,g,j,o,k,u,n,q=d.hasData(a)&&d._data(a),s=q&&q.events;if(q&&s){if(c&&c.type){f=c.handler;c=c.type}if(!c||typeof c==="string"&&c.charAt(0)==="."){c=c||"";for(b in s)d.event.remove(a,b+c)}else{for(c=c.split(" ");b=c[l++];){k=b;g=b.indexOf(".")<0;j=[];if(!g){j=b.split(".");b=j.shift();o=RegExp("(^|\\.)"+d.map(j.slice(0).sort(),hb).join("\\.(?:.*\\.)?")+"(\\.|$)")}if(u=s[b])if(f){k=d.event.special[b]||{};for(h=i||0;h<u.length;h++){n=u[h];if(f.guid===n.guid){if(g||
o.test(n.namespace)){i==null&&u.splice(h--,1);k.remove&&k.remove.call(a,n)}if(i!=null)break}}if(u.length===0||i!=null&&u.length===1){(!k.teardown||k.teardown.call(a,j)===false)&&d.removeEvent(a,b,q.handle);delete s[b]}}else for(h=0;h<u.length;h++){n=u[h];if(g||o.test(n.namespace)){d.event.remove(a,k,n.handler,h);u.splice(h--,1)}}}if(d.isEmptyObject(s)){if(c=q.handle)c.elem=null;delete q.events;delete q.handle;d.isEmptyObject(q)&&d.removeData(a,e,true)}}}}},customEvent:{getData:!0,setData:!0,changeData:!0},
...
a)}});var na={focus:"focusin",blur:"focusout",mouseenter:"mouseover",mouseleave:"mouseout"};d.each(["live","die"],function(a,c){d.fn[c]=function(a,i,b,h){var l=0,g,j,o=h||this.selector,k=h?this:d(this.context);if(typeof a==="object"&&!a.preventDefault){for(g in a)k[c](g,i,a[g],o);return this}if(c==="die"&&!a&&h&&h.charAt(0)==="."){k.unbind(h);return this}if(i===false||d.isFunction(i)){b=i||p;i=e}for(a=(a||"").split(" ");(h=a[l++])!=null;){g=ga.exec(h);j="";if(g){j=g[0];h=h.replace(ga,"")}if(h==="hover")a.push("mouseenter"+
j,"mouseleave"+j);else{g=h;if(na[h]){a.push(na[h]+j);h=h+j}else h=(na[h]||h)+j;if(c==="live"){j=0;for(var u=k.length;j<u;j++)d.event.add(k[j],"live."+G(h,o),{data:i,selector:o,handler:b,origType:h,origHandler:b,preType:g})}else k.unbind("live."+G(h,o),b)}}return this}});d.each("blur,focus,focusin,focusout,load,resize,scroll,unload,click,dblclick,mousedown,mouseup,mousemove,mouseover,mouseout,mouseenter,mouseleave,change,select,submit,keydown,keypress,keyup,error".split(","),function(a,c){d.fn[c]=
...
d){e=f[m.sizset];break}if(m.nodeType===1){if(!b){m.sizcache=d;m.sizset=i}if(typeof c!=="string"){if(m===c){e=true;break}}else if(o.filter(c,[m]).length>0){e=m;break}}m=m[a]}f[i]=e}}}var f=/((?:\((?:\([^()]+\)|[^()]+)+\)|\[(?:\[[^\[\]]*\]|['"][^'"]*['"]|[^\[\]'"]+)+\]|\\.|[^ >+~,(\[\\]+)+|[>+~])(\s*,\s*)?((?:.|\r|\n)*)/g,i=0,b=Object.prototype.toString,h=false,l=true,g=/\\/g,j=/\W/;[0,0].sort(function(){l=false;return 0});var o=function(a,c,d,i){var d=d||[],h=c=c||s;if(c.nodeType!==1&&c.nodeType!==
9)return[];if(!a||typeof a!=="string")return d;var e,l,g,j,t,Q=true,n=o.isXML(c),q=[],r=a;do{f.exec("");if(e=f.exec(r)){r=e[3];q.push(e[1]);if(e[2]){j=e[3];break}}}while(e);if(q.length>1&&u.exec(a))if(q.length===2&&k.relative[q[0]])l=F(q[0]+q[1],c);else for(l=k.relative[q[0]]?[c]:o(q.shift(),c);q.length;){a=q.shift();k.relative[a]&&(a=a+q.shift());l=F(a,l)}else{if(!i&&q.length>1&&c.nodeType===9&&!n&&k.match.ID.test(q[0])&&!k.match.ID.test(q[q.length-1])){e=o.find(q.shift(),c,n);c=e.expr?o.filter(e.expr,
e.set)[0]:e.set[0]}if(c){e=i?{expr:q.pop(),set:y(i)}:o.find(q.pop(),q.length===1&&(q[0]==="~"||q[0]==="+")&&c.parentNode?c.parentNode:c,n);l=e.expr?o.filter(e.expr,e.set):e.set;for(q.length>0?g=y(l):Q=false;q.length;){e=t=q.pop();k.relative[t]?e=q.pop():t="";e==null&&(e=c);k.relative[t](g,e,n)}}else g=[]}g||(g=l);g||o.error(t||a);if(b.call(g)==="[object Array]")if(Q)if(c&&c.nodeType===1)for(a=0;g[a]!=null;a++)g[a]&&(g[a]===true||g[a].nodeType===1&&o.contains(c,g[a]))&&d.push(l[a]);else for(a=0;g[a]!=
null;a++)g[a]&&g[a].nodeType===1&&d.push(l[a]);else d.push.apply(d,g);else y(g,d);if(j){o(j,h,d,i);o.uniqueSort(d)}return d};o.uniqueSort=function(a){if(p){h=l;a.sort(p);if(h)for(var c=1;c<a.length;c++)a[c]===a[c-1]&&a.splice(c--,1)}return a};o.matches=function(a,c){return o(a,null,null,c)};o.matchesSelector=function(a,c){return o(c,null,null,[a]).length>0};o.find=function(a,c,d){var f;if(!a)return[];for(var i=0,b=k.order.length;i<b;i++){var h,m=k.order[i];if(h=k.leftMatch[m].exec(a)){var e=h[1];
h.splice(1,1);if(e.substr(e.length-1)!=="\\"){h[1]=(h[1]||"").replace(g,"");f=k.find[m](h,c,d);if(f!=null){a=a.replace(k.match[m],"");break}}}}f||(f=typeof c.getElementsByTagName!=="undefined"?c.getElementsByTagName("*"):[]);return{set:f,expr:a}};o.filter=function(a,c,d,f){for(var i,b,h=a,m=[],l=c,g=c&&c[0]&&o.isXML(c[0]);a&&c.length;){for(var j in k.filter)if((i=k.leftMatch[j].exec(a))!=null&&i[2]){var t,u,q=k.filter[j];u=i[1];b=false;i.splice(1,1);if(u.substr(u.length-1)!=="\\"){l===m&&(m=[]);if(k.preFilter[j])if(i=
k.preFilter[j](i,l,d,m,f,g)){if(i===true)continue}else b=t=true;if(i)for(var Q=0;(u=l[Q])!=null;Q++)if(u){t=q(u,i,Q,l);var n=f^!!t;if(d&&t!=null)n?b=true:l[Q]=false;else if(n){m.push(u);b=true}}if(t!==e){d||(l=m);a=a.replace(k.match[j],"");if(!b)return[];break}}}if(a===h)if(b==null)o.error(a);else break;h=a}return l};o.error=function(a){throw"Syntax error, unrecognized expression: "+a;};var k=o.selectors={order:["ID","NAME","TAG"],match:{ID:/#((?:[\w\u00c0-\uFFFF\-]|\\.)+)/,CLASS:/\.((?:[\w\u00c0-\uFFFF\-]|\\.)+)/,
...
d,c,f)}}},u=k.match.POS,n=function(a,c){return"\\"+(c-0+1)},q;for(q in k.match){k.match[q]=RegExp(k.match[q].source+/(?![^\[]*\])(?![^\(]*\))/.source);k.leftMatch[q]=RegExp(/(^(?:.|\r|\n)*?)/.source+k.match[q].source.replace(/\\(\d+)/g,n))}var y=function(a,c){a=Array.prototype.slice.call(a,0);if(c){c.push.apply(c,a);return c}return a};try{Array.prototype.slice.call(s.documentElement.childNodes,0)[0].nodeType}catch(r){y=function(a,c){var d=0,f=c||[];if(b.call(a)==="[object Array]")Array.prototype.push.apply(f,
a);else if(typeof a.length==="number")for(var i=a.length;d<i;d++)f.push(a[d]);else for(;a[d];d++)f.push(a[d]);return f}}var p,B;if(s.documentElement.compareDocumentPosition)p=function(a,c){if(a===c){h=true;return 0}return!a.compareDocumentPosition||!c.compareDocumentPosition?a.compareDocumentPosition?-1:1:a.compareDocumentPosition(c)&4?-1:1};else{p=function(a,c){if(a===c){h=true;return 0}if(a.sourceIndex&&c.sourceIndex)return a.sourceIndex-c.sourceIndex;var d,f,i=[],b=[];d=a.parentNode;f=c.parentNode;
...
"tbody")&&!j[e].childNodes.length&&j[e].parentNode.removeChild(j[e])}!d.support.leadingWhitespace&&oa.test(g)&&k.insertBefore(c.createTextNode(oa.exec(g)[0]),k.firstChild);g=k.childNodes}else g=c.createTextNode(g);var u;if(!d.support.appendChecked)if(g[0]&&typeof(u=g.length)==="number")for(e=0;e<u;e++)h(g[e]);else h(g);g.nodeType?b.push(g):b=d.merge(b,g)}}if(f){a=function(a){return!a.type||qb.test(a.type)};for(l=0;b[l];l++)if(i&&d.nodeName(b[l],"script")&&(!b[l].type||b[l].type.toLowerCase()==="text/javascript"))i.push(b[l].parentNode?
...
Bb=/^\/\//,Ka=/\?/,Cb=/<script\b[^<]*(?:(?!<\/script>)<[^<]*)*<\/script>/gi,Db=/^(?:select|textarea)/i,ra=/\s+/,Eb=/([?&])_=[^&]*/,La=/^([\w\+\.\-]+:)(?:\/\/([^\/?#:]*)(?::(\d+))?)?/,Ma=d.fn.load,ha={},Na={},M,N,Oa=["*/"]+["*"];try{M=R.href}catch(Kb){M=s.createElement("a"),M.href="",M=M.href}N=La.exec(M.toLowerCase())||[];d.fn.extend({load:function(a,c,f){if(typeof a!=="string"&&Ma)return Ma.apply(this,arguments);if(!this.length)return this;var b=a.indexOf(" ");if(b>=0)var h=a.slice(b,a.length),a=
...
b,h,l){if(d.isFunction(b)){l=l||h;h=b;b=e}return d.ajax({type:c,url:a,data:b,success:h,dataType:l})}});d.extend({getScript:function(a,c){return d.get(a,e,c,"script")},getJSON:function(a,c,f){return d.get(a,c,f,"json")},ajaxSetup:function(a,c){if(c)x(a,d.ajaxSettings);else{c=a;a=d.ajaxSettings}x(a,c);return a},ajaxSettings:{url:M,isLocal:/^(?:about|app|app\-storage|.+\-extension|file|res|widget):$/.test(N[1]),global:!0,type:"GET",contentType:"application/x-www-form-urlencoded",processData:!0,async:!0,
accepts:{xml:"application/xml, text/xml",html:"text/html",text:"text/plain",json:"application/json, text/javascript","*":Oa},contents:{xml:/xml/,html:/html/,json:/json/},responseFields:{xml:"responseXML",text:"responseText"},converters:{"* text":g.String,"text html":!0,"text json":d.parseJSON,"text xml":d.parseXML},flatOptions:{context:!0,url:!0}},ajaxPrefilter:y(ha),ajaxTransport:y(Na),ajax:function(a,c){function f(a,c,f,u){if(B!==2){B=2;r&&clearTimeout(r);s=e;n=u||"";x.readyState=a>0?4:0;var q,
y,p,u=c;if(f){var z=b,H=x,O=z.contents,C=z.dataTypes,I=z.responseFields,v,w,J,U;for(w in I)w in f&&(H[I[w]]=f[w]);for(;C[0]==="*";){C.shift();v===e&&(v=z.mimeType||H.getResponseHeader("content-type"))}if(v)for(w in O)if(O[w]&&O[w].test(v)){C.unshift(w);break}if(C[0]in f)J=C[0];else{for(w in f){if(!C[0]||z.converters[w+" "+C[0]]){J=w;break}U||(U=w)}J=J||U}if(J){J!==C[0]&&C.unshift(J);f=f[J]}else f=void 0}else f=e;if(a>=200&&a<300||a===304){if(b.ifModified){if(v=x.getResponseHeader("Last-Modified"))d.lastModified[k]=
v;if(v=x.getResponseHeader("Etag"))d.etag[k]=v}if(a===304){u="notmodified";q=true}else try{v=b;v.dataFilter&&(f=v.dataFilter(f,v.dataType));var E=v.dataTypes;w={};var R,A,Sa=E.length,G,D=E[0],S,L,P,K,M;for(R=1;R<Sa;R++){if(R===1)for(A in v.converters)typeof A==="string"&&(w[A.toLowerCase()]=v.converters[A]);S=D;D=E[R];if(D==="*")D=S;else if(S!=="*"&&S!==D){L=S+" "+D;P=w[L]||w["* "+D];if(!P){M=e;for(K in w){G=K.split(" ");if(G[0]===S||G[0]==="*")if(M=w[G[1]+" "+D]){K=w[K];K===true?P=M:M===true&&(P=
K);break}}}!P&&!M&&d.error("No conversion from "+L.replace(" "," to "));P!==true&&(f=P?P(f):M(K(f)))}}y=f;u="success";q=true}catch(N){u="parsererror";p=N}}else{p=u;if(!u||a){u="error";a<0&&(a=0)}}x.status=a;x.statusText=""+(c||u);q?g.resolveWith(h,[y,u,x]):g.rejectWith(h,[x,u,p]);x.statusCode(o);o=e;F&&l.trigger("ajax"+(q?"Success":"Error"),[x,b,q?y:p]);j.resolveWith(h,[x,u]);if(F){l.trigger("ajaxComplete",[x,b]);--d.active||d.event.trigger("ajaxStop")}}}if(typeof a==="object"){c=a;a=e}var c=c||{},
b=d.ajaxSetup({},c),h=b.context||b,l=h!==b&&(h.nodeType||h instanceof d)?d(h):d.event,g=d.Deferred(),j=d._Deferred(),o=b.statusCode||{},k,u={},q={},n,y,s,r,p,B=0,F,z,x={readyState:0,setRequestHeader:function(a,c){if(!B){var d=a.toLowerCase(),a=q[d]=q[d]||a;u[a]=c}return this},getAllResponseHeaders:function(){return B===2?n:null},getResponseHeader:function(a){var c;if(B===2){if(!y)for(y={};c=yb.exec(n);)y[c[1].toLowerCase()]=c[2];c=y[a.toLowerCase()]}return c===e?null:c},overrideMimeType:function(a){if(!B)b.mimeType=
a;return this},abort:function(a){a=a||"abort";s&&s.abort(a);f(0,a);return this}};g.promise(x);x.success=x.done;x.error=x.fail;x.complete=j.done;x.statusCode=function(a){if(a){var c;if(B<2)for(c in a)o[c]=[o[c],a[c]];else{c=a[x.status];x.then(c,c)}}return this};b.url=((a||b.url)+"").replace(xb,"").replace(Bb,N[1]+"//");b.dataTypes=d.trim(b.dataType||"*").toLowerCase().split(ra);if(b.crossDomain==null){p=La.exec(b.url.toLowerCase());b.crossDomain=!(!p||!(p[1]!=N[1]||p[2]!=N[2]||(p[3]||(p[1]==="http:"?
80:443))!=(N[3]||(N[1]==="http:"?80:443))))}if(b.data&&b.processData&&typeof b.data!=="string")b.data=d.param(b.data,b.traditional);H(ha,b,c,x);if(B===2)return false;F=b.global;b.type=b.type.toUpperCase();b.hasContent=!Ab.test(b.type);F&&d.active++===0&&d.event.trigger("ajaxStart");if(!b.hasContent){if(b.data){b.url=b.url+((Ka.test(b.url)?"&":"?")+b.data);delete b.data}k=b.url;if(b.cache===false){p=d.now();var O=b.url.replace(Eb,"$1_="+p);b.url=O+(O===b.url?(Ka.test(b.url)?"&":"?")+"_="+p:"")}}(b.data&&
...
x,b)===false||B===2)){x.abort();return false}for(z in{success:1,error:1,complete:1})x[z](b[z]);if(s=H(Na,b,c,x)){x.readyState=1;F&&l.trigger("ajaxSend",[x,b]);b.async&&b.timeout>0&&(r=setTimeout(function(){x.abort("timeout")},b.timeout));try{B=1;s.send(u,f)}catch(C){B<2?f(-1,C):d.error(C)}}else f(-1,"No Transport");return x},param:function(a,c){var b=[],h=function(a,c){c=d.isFunction(c)?c():c;b[b.length]=encodeURIComponent(a)+"="+encodeURIComponent(c)};if(c===e)c=d.ajaxSettings.traditional;if(d.isArray(a)||
...
!a.crossDomain&&!b["X-Requested-With"]&&(b["X-Requested-With"]="XMLHttpRequest");try{for(o in b)l.setRequestHeader(o,b[o])}catch(k){}l.send(a.hasContent&&a.data||null);c=function(b,f){var g,o,k,u,q;try{if(c&&(f||l.readyState===4)){c=e;if(j){l.onreadystatechange=d.noop;qa&&delete X[j]}if(f)l.readyState!==4&&l.abort();else{g=l.status;k=l.getAllResponseHeaders();u={};if((q=l.responseXML)&&q.documentElement)u.xml=q;u.text=l.responseText;try{o=l.statusText}catch(n){o=""}!g&&a.isLocal&&!a.crossDomain?g=
u.text?200:404:g===1223&&(g=204)}}}catch(y){f||h(-1,y)}u&&h(g,o,u,k)};if(!a.async||l.readyState===4)c();else{j=++Gb;if(qa){if(!X){X={};d(g).unload(qa)}X[j]=c}l.onreadystatechange=c}},abort:function(){c&&c(0,1)}}}});var ia={},L,V,Hb=/^(?:toggle|show|hide)$/,Ib=/^([+\-]=)?([\d+.\-]+)([a-z%]*)$/i,fa,sa=[["height","marginTop","marginBottom","paddingTop","paddingBottom"],["width","marginLeft","marginRight","paddingLeft","paddingRight"],["opacity"]],ba;d.fn.extend({show:function(a,c,b){if(a||a===0)return this.animate(F("show",
...
(function(g){function e(b,e){for(var g=b.length;g--;)if(b[g]===e)return g;return-1}function b(b,e,g){var j,k,h,l;void 0===g&&(g=e,e="all");b=b.replace(/\s/g,"");j=b.split(",");""==j[j.length-1]&&(j[j.length-2]+=",");for(h=0;h<j.length;h++){k=[];b=j[h].split("+");if(1<b.length){k=b.slice(0,b.length-1);for(l=0;l<k.length;l++)k[l]=A[k[l]];b=[b[b.length-1]]}b=b[0];b=G[b]||b.toUpperCase().charCodeAt(0);b in p||(p[b]=[]);p[b].push({shortcut:j[h],scope:e,method:g,key:j[h],mods:k})}}function j(b,e,g){b.addEventListener?
b.addEventListener(e,g,!1):b.attachEvent&&b.attachEvent("on"+e,function(){g(window.event)})}var k,p={},n={16:!1,18:!1,17:!1,91:!1},v="all",A={"\u21e7":16,shift:16,"\u2325":18,alt:18,option:18,"\u2303":17,ctrl:17,control:17,"\u2318":91,command:91},G={backspace:8,tab:9,clear:12,enter:13,"return":13,esc:27,escape:27,space:32,left:37,up:38,right:39,down:40,del:46,"delete":46,home:36,end:35,pageup:33,pagedown:34,",":188,".":190,"/":191,"`":192,"-":189,"=":187,";":186,"'":222,"[":219,"]":221,"\\":220};
for(k=1;20>k;k++)A["f"+k]=111+k;for(k in A)b[k]=!1;j(document,"keydown",function(g){var j,k,w,E,h;k=(g.target||g.srcElement).tagName;j=g.keyCode;if(93==j||224==j)j=91;if(j in n)for(w in n[j]=!0,A)A[w]==j&&(b[w]=!0);else if(!("INPUT"==k||"SELECT"==k||"TEXTAREA"==k)&&j in p)for(E=0;E<p[j].length;E++)if(k=p[j][E],k.scope==v||"all"==k.scope){h=0<k.mods.length;for(w in n)if(!n[w]&&-1<e(k.mods,+w)||n[w]&&-1==e(k.mods,+w))h=!1;if((0==k.mods.length&&!n[16]&&!n[18]&&!n[17]&&!n[91]||h)&&!1===k.method(g,k))g.preventDefault?
...
(function(g,e){var b,j=/:([\w\d]+)/g,k=/\?([^#]*)?$/,p=function(b){return Array.prototype.slice.call(b)},n=function(b){return"[object Function]"===Object.prototype.toString.call(b)},v=function(b){return"[object Array]"===Object.prototype.toString.call(b)},A=function(b){return decodeURIComponent((b||"").replace(/\+/g," "))},G=encodeURIComponent,z=function(b){return(""+b).replace(/&(?!\w+;)/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")},I=function(b){return function(e,
g){return this.route.apply(this,[b,e,g])}},r={},w=!(!e.history||!history.pushState),E=[];b=function(){var h=p(arguments),e,j;b.apps=b.apps||{};if(0===h.length||h[0]&&n(h[0]))return b.apply(b,["body"].concat(h));if("string"==typeof(j=h.shift()))return e=b.apps[j]||new b.Application,e.element_selector=j,0<h.length&&g.each(h,function(b,h){e.use(h)}),e.element_selector!=j&&delete b.apps[j],b.apps[e.element_selector]=e};b.VERSION="0.7.0";b.addLogger=function(b){E.push(b)};b.log=function(){var h=p(arguments);
h.unshift("["+Date()+"]");g.each(E,function(e,g){g.apply(b,h)})};"undefined"!=typeof e.console?n(e.console.log.apply)?b.addLogger(function(){e.console.log.apply(e.console,arguments)}):b.addLogger(function(){e.console.log(arguments)}):"undefined"!=typeof console&&b.addLogger(function(){console.log.apply(console,arguments)});g.extend(b,{makeArray:p,isFunction:n,isArray:v,extend:g.extend});b.Object=function(b){return g.extend(this,b||{})};g.extend(b.Object.prototype,{escapeHTML:z,h:z,toHash:function(){var b=
{};g.each(this,function(e,g){n(g)||(b[e]=g)});return b},toHTML:function(){var b="";g.each(this,function(e,g){n(g)||(b+="<strong>"+e+"</strong> "+g+"<br />")});return b},keys:function(b){var e=[],g;for(g in this)(!n(this[g])||!b)&&e.push(g);return e},has:function(b){return this[b]&&""!==g.trim(this[b].toString())},join:function(){var b=p(arguments),e=b.shift();return b.join(e)},log:function(){b.log.apply(b,arguments)},toString:function(b){var e=[];g.each(this,function(g,j){(!n(j)||b)&&e.push('"'+g+
...
_last_route:null,_location_proxy:null,_running:!1,element_selector:"body",debug:!1,raise_errors:!1,run_interval_every:50,disable_push_state:!1,template_engine:null,toString:function(){return"Sammy.Application:"+this.element_selector},$element:function(b){return b?g(this.element_selector).find(b):g(this.element_selector)},use:function(){var h=p(arguments),e=h.shift(),g=e||"";try{h.unshift(this),"string"==typeof e&&(g="Sammy."+e,e=b[e]),e.apply(this,h)}catch(j){"undefined"===typeof e?this.error("Plugin Error: called use() but plugin ("+
g.toString()+") is not defined",j):n(e)?this.error("Plugin Error",j):this.error("Plugin Error: called use() but '"+g.toString()+"' is not a function",j)}return this},setLocationProxy:function(b){var e=this._location_proxy;this._location_proxy=b;this.isRunning()&&(e&&e.unbind(),this._location_proxy.bind())},log:function(){b.log.apply(b,Array.prototype.concat.apply([this.element_selector],arguments))},route:function(b,e,k){var y=this,p=[],x,r;!k&&n(e)&&(k=e=b,b="any");b=b.toLowerCase();if(e.constructor==
String){for(j.lastIndex=0;null!==(r=j.exec(e));)p.push(r[1]);e=RegExp(e.replace(j,"([^/]+)")+"$")}"string"==typeof k&&(k=y[k]);x=function(b){var h={verb:b,path:e,callback:k,param_names:p};y.routes[b]=y.routes[b]||[];y.routes[b].push(h)};"any"===b?g.each(this.ROUTE_VERBS,function(b,h){x(h)}):x(b);return this},get:I("get"),post:I("post"),put:I("put"),del:I("delete"),any:I("any"),mapRoutes:function(b){var e=this;g.each(b,function(b,h){e.route.apply(e,h)});return this},eventNamespace:function(){return["sammy-app",
...
"")},lookupRoute:function(b,e){var g=!1,j=0,k,n;if("undefined"!=typeof this.routes[b])for(k=this.routes[b].length;j<k;j++)if(n=this.routes[b][j],this.routablePath(e).match(n.path)){g=n;break}return g},runRoute:function(b,e,j,k){var n=this,p=this.lookupRoute(b,e),r,v,u,B,F,w,q;this.log("runRoute",[b,e].join(" "));this.trigger("run-route",{verb:b,path:e,params:j});"undefined"==typeof j&&(j={});g.extend(j,this._parseQueryString(e));if(p){this.trigger("route-found",{route:p});if(null!==(w=p.path.exec(this.routablePath(e))))w.shift(),
g.each(w,function(b,h){p.param_names[b]?j[p.param_names[b]]=A(h):(j.splat||(j.splat=[]),j.splat.push(A(h)))});r=new this.context_prototype(this,b,e,j,k);k=this.arounds.slice(0);u=this.befores.slice(0);F=[r].concat(j.splat);v=function(){for(var b;0<u.length;)if(B=u.shift(),n.contextMatchesOptions(r,B[0])&&(b=B[1].apply(r,[r]),!1===b))return!1;n.last_route=p;r.trigger("event-context-before",{context:r});b=p.callback.apply(r,F);r.trigger("event-context-after",{context:r});return b};g.each(k.reverse(),
function(b,h){var d=v;v=function(){return h.apply(r,[d])}});try{q=v()}catch(s){this.error(["500 Error",b,e].join(" "),s)}return q}return this.notFound(b,e)},contextMatchesOptions:function(b,e,g){if("undefined"===typeof e||e=={})return!0;"undefined"===typeof g&&(g=!0);if("string"===typeof e||n(e.test))e={path:e};if(e.only)return this.contextMatchesOptions(b,e.only,!0);if(e.except)return this.contextMatchesOptions(b,e.except,!1);var j=!0,k=!0;e.path&&(n(e.path.test)||(e.path=RegExp(e.path.toString()+
...
load:function(b,e,j){var k=this;return this.then(function(){var p,r,v;n(e)?(j=e,e={}):e=g.extend({},e);j&&this.then(j);if("string"===typeof b){p=(v=b.match(/\.json$/)||e.json)&&!0===e.cache||!1!==e.cache;k.next_engine=k.event_context.engineFor(b);delete e.cache;delete e.json;e.engine&&(k.next_engine=e.engine,delete e.engine);if(p&&(r=this.event_context.app.templateCache(b)))return r;this.wait();g.ajax(g.extend({url:b,data:{},dataType:v?"json":null,type:"get",success:function(e){p&&k.event_context.app.templateCache(b,
...
send:function(){var b=this,e=p(arguments),g=e.shift();v(e[0])&&(e=e[0]);return this.then(function(){e.push(function(e){b.next(e)});b.wait();g.apply(g,e);return!1})},collect:function(b,e,j){var k=this,p=function(){n(b)&&(e=b,b=this.content);var j=[],o=!1;g.each(b,function(b,h){var g=e.apply(k,[b,h]);if(g.jquery&&g.length==1){g=g[0];o=true}j.push(g);return g});return o?j:j.join("")};return j?p():this.then(p)},renderEach:function(b,e,j,k){v(e)&&(k=j,j=e,e=null);return this.load(b).then(function(n){var p=
this;j||(j=v(this.previous_content)?this.previous_content:[]);if(k)g.each(j,function(g,j){var u={},o=this.next_engine||b;e?u[e]=j:u=j;k(j,p.event_context.interpolate(n,u,o))});else return this.collect(j,function(g,j){var k={},o=this.next_engine||b;e?k[e]=j:k=j;return this.event_context.interpolate(n,k,o)},true)})},interpolate:function(b,e,g){var j=this;return this.then(function(k,n){!b&&n&&(b=n);this.next_engine&&(e=this.next_engine,this.next_engine=!1);var p=j.event_context.interpolate(k,b,e,this.partials);
return g?n+p:p})},swap:function(){return this.then(function(b){this.event_context.swap(b)}).trigger("changed",{})},appendTo:function(b){return this.then(function(e){g(b).append(e)}).trigger("changed",{})},prependTo:function(b){return this.then(function(e){g(b).prepend(e)}).trigger("changed",{})},replace:function(b){return this.then(function(e){g(b).html(e)}).trigger("changed",{})},trigger:function(b,e){return this.then(function(g){"undefined"==typeof e&&(e={content:g});this.event_context.trigger(b,
...
(function(g){function e(b){b=unescape(b);return"true"===b?!0:"false"===b?!1:b}function b(j,k,p){var n;if(k.match(/^[^\[]+$/))j[k]=e(p);else if(n=k.match(/^([^\[]+)\[\](.*)$/)){k=n[1];n=n[2];if(j[k]&&!g.isArray(j[k]))throw"400 Bad Request";if(n){n=n.match(/^\[([^\]]+)\](.*)$/);if(!n)throw"400 Bad Request";j[k]?j[k][j[k].length-1][n[1]]?j[k].push(b({},n[1]+n[2],p)):g.extend(!0,j[k][j[k].length-1],b({},n[1]+n[2],p)):j[k]=[b({},n[1]+n[2],p)]}else j[k]?j[k].push(e(p)):j[k]=[e(p)]}else if(n=k.match(/^([^\[]+)\[([^\[]+)\](.*)$/)){k=
n[1];n=n[2]+n[3];if(j[k]&&g.isArray(j[k]))throw"400 Bad Request";j[k]?g.extend(!0,j[k],b(j[k],n,p)):j[k]=b({},n,p)}return j}Sammy=Sammy||{};Sammy.NestedParams=function(e){e._parseParamPair=b}})(jQuery);
...
this.options)};Sammy.Store.stores={memory:"Memory",local:"LocalStorage",session:"SessionStorage",cookie:"Cookie"};Sammy.extend(Sammy.Store.prototype,{isAvailable:function(){return Sammy.isFunction(this.storage.isAvailable)?this.storage.isAvailable():!0},exists:function(b,e){this.storage.exists(b,e);return this},set:function(b,g,k){var p="string"==typeof g?g:JSON.stringify(g),n=this,b=b.toString();this.storage.set(b,p,function(){n.app&&(n.app.trigger("set-"+n.name,{key:b,value:g}),n.app.trigger("set-"+
...
g);e(k,this,g,b)},get:function(b,g){var k=this.storage.getItem(this._key(b));k&&"undefined"!=typeof k.value&&(k=k.value);e(g,this,k)},clear:function(b,g){this.storage.removeItem(this._key(b));e(g,this,b)},clearAll:function(b){for(var g=0,k=this.storage.length,p,n=RegExp("^"+this.key_prefix.replace(".","\\.")+"\\.");g<k;g++)try{p=this.storage.key(g),n.test(p)&&this.storage.removeItem(p)}catch(v){}e(b,this,!0)},_key:function(b){return[this.key_prefix,b].join(".")}});Sammy.Store.SessionStorage=function(b){this.name=
...
q.box.onmouseout=function(){g.focus()};q.box.onmousedown=function(){E=!0};q.box.onmousemove=function(b){if(o||y)o&&G(b),y&&z(b),document.selection?document.selection.empty():window.getSelection&&window.getSelection().removeAllRanges()};q.padM.onmouseup=q.padM.onmouseout=function(){o&&(o=!1,jscolor.fireEvent(h,"change"))};q.padM.onmousedown=function(b){o=!0;G(b)};q.sldM.onmouseup=q.sldM.onmouseout=function(){y&&(y=!1,jscolor.fireEvent(h,"change"))};q.sldM.onmousedown=function(b){y=!0;z(b)};j=k(r);
q.box.style.width=j[0]+"px";q.box.style.height=j[1]+"px";q.boxB.style.position="absolute";q.boxB.style.clear="both";q.boxB.style.left=b+"px";q.boxB.style.top=e+"px";q.boxB.style.zIndex=r.pickerZIndex;q.boxB.style.border=r.pickerBorder+"px solid";q.boxB.style.borderColor=r.pickerBorderColor;q.boxB.style.background=r.pickerFaceColor;q.pad.style.width=jscolor.images.pad[0]+"px";q.pad.style.height=jscolor.images.pad[1]+"px";q.padB.style.position="absolute";q.padB.style.left=r.pickerFace+"px";q.padB.style.top=
...
"pointer"}catch(v){q.btn.style.cursor="hand"}q.btn.onmousedown=function(){r.hidePicker()};q.btnS.style.lineHeight=q.btn.style.height;switch(w){case 0:var x="hs.png";break;case 1:x="hv.png"}q.padM.style.backgroundImage="url('"+jscolor.getDir()+"cross.gif')";q.padM.style.backgroundRepeat="no-repeat";q.sldM.style.backgroundImage="url('"+jscolor.getDir()+"arrow.gif')";q.sldM.style.backgroundRepeat="no-repeat";q.pad.style.backgroundImage="url('"+jscolor.getDir()+x+"')";q.pad.style.backgroundRepeat="no-repeat";
q.pad.style.backgroundPosition="0 0";p();n();jscolor.picker.owner=r;document.getElementsByTagName("body")[0].appendChild(q.boxB)}function k(b){return[2*b.pickerInset+2*b.pickerFace+jscolor.images.pad[0]+(b.slider?2*b.pickerInset+2*jscolor.images.arrow[0]+jscolor.images.sld[0]:0),b.pickerClosable?4*b.pickerInset+3*b.pickerFace+jscolor.images.pad[1]+b.pickerButtonHeight:2*b.pickerInset+2*b.pickerFace+jscolor.images.pad[1]]}function p(){switch(w){case 0:var e=1;break;case 1:e=2}var g=Math.round(r.hsv[0]/
...
this.showPicker=function(){if(!v()){var b=jscolor.getElementPos(g),e=jscolor.getElementSize(g),h=jscolor.getViewPos(),l=jscolor.getViewSize(),n=k(this),o,p,r;switch(this.pickerPosition.toLowerCase()){case "left":o=1;p=0;r=-1;break;case "right":o=1;p=0;r=1;break;case "top":o=0;p=1;r=-1;break;default:o=0,r=p=1}var d=(e[p]+n[p])/2,b=[-h[o]+b[o]+n[o]>l[o]?-h[o]+b[o]+e[o]/2>l[o]/2&&0<=b[o]+e[o]-n[o]?b[o]+e[o]-n[o]:b[o]:b[o],-h[p]+b[p]+e[p]+n[p]-d+d*r>l[p]?-h[p]+b[p]+e[p]/2>l[p]/2&&0<=b[p]+e[p]-d-d*r?b[p]+
e[p]-d-d*r:b[p]+e[p]-d+d*r:0<=b[p]+e[p]-d+d*r?b[p]+e[p]-d+d*r:b[p]+e[p]-d-d*r];j(b[o],b[p])}};this.importColor=function(){h?this.adjust?!this.required&&/^\s*$/.test(h.value)?(h.value="",l.style.backgroundColor=l.jscStyle.backgroundColor,l.style.color=l.jscStyle.color,this.exportColor(H|x)):this.fromString(h.value)||this.exportColor():this.fromString(h.value,H)||(l.style.backgroundColor=l.jscStyle.backgroundColor,l.style.color=l.jscStyle.color,this.exportColor(H|x)):this.exportColor()};this.exportColor=
function(b){if(!(b&H)&&h){var e=this.toString();this.caps&&(e=e.toUpperCase());this.hash&&(e="#"+e);h.value=e}!(b&x)&&l&&(l.style.backgroundColor="#"+this.toString(),l.style.color=0.5>0.213*this.rgb[0]+0.715*this.rgb[1]+0.072*this.rgb[2]?"#FFF":"#000");!(b&C)&&v()&&p();!(b&J)&&v()&&n()};this.fromHSV=function(e,g,h,j){0>e&&(e=0)||6<e&&(e=6);0>g&&(g=0)||1<g&&(g=1);0>h&&(h=0)||1<h&&(h=1);this.rgb=b(null===e?this.hsv[0]:this.hsv[0]=e,null===g?this.hsv[1]:this.hsv[1]=g,null===h?this.hsv[2]:this.hsv[2]=
...
function(e,g){g&&$(this).attr("action",g.replace(/:uuid/,b))}).show(),$("[name=uuid]").val(b),$("#graph-actions").find(".update, .dashboard, .snapshots").show()):$("#graph-actions").find(".update, .dashboard, .snapshots").hide();this.toggleEditorPanesByPreference()},getEditorJSON:function(){return JSON.parse(this.app.editor.getSession().getValue())},setEditorJSON:function(e){"string"!=typeof e&&(e=JSON.stringify(e,null,2));this.app.editor.getSession().setValue(e);return e},graphPreview:function(e){var b=
this;$("#editor-pane").is(":visible")&&(this.session("lastPreview",e,function(){var g=$("#graph-preview img"),k=$("#graph-url input");$.extend(!0,e,b.getOptionOverrides());var p=new Graphiti.Graph(e);p.image(g);k.val(p.buildURL())}),this.updateOptionsForm(e))},updateOptionsForm:function(e){var e=e.options?e.options:e,b,g=$("#graph-options form");for(b in e)if(""!=e[b]){var k=g.find('[name="options['+b+']"]');k.is(":checkbox")?k.prop("checked",e[b]):k.val(e[b])}},saveOptions:function(e){var b=this.getEditorJSON();
b.options=e;this.graphPreview(b);this.setEditorJSON(b)},buildMetricsList:function(e,b){var g=$("#metrics-list ul.search-results");g.html("");""!==$("#metrics-menu input.search").val()&&$("<li>").addClass("root").text("..").appendTo(g);for(var k=Graphiti.graphiti_base_url+jscolor.getDir()+"folder.png",p=Graphiti.graphiti_base_url+jscolor.getDir()+"metric.gif",n=0,v=e.length;n<v;n++)Sammy.log(e[n]),$("<li>").addClass("folder").text(e[n]).prepend("<img src="+k+">").hover(function(){$(this).css("font-weight",
"bold")},function(){$(this).css("font-weight","normal")}).appendTo(g);n=0;for(v=b.length;n<v;n++)Sammy.log(b[n]),$("<li>").addClass("key").append($("<a rel='add'>Add</a>")).append($("<strong>").text(b[n])).prepend("<img src="+p+">").appendTo(g)},appendFolderToSearchKey:function(e){var b=$("#metrics-menu input.search");""!==b.val()&&b.val(b.val()+".");b.val(b.val()+e)},removeFolderFromSearchKey:function(){var e=$("#metrics-menu input.search");""!==e.val()?e.val(e.val().replace(/\.?\w*$/,"")):e.val("")},
bindMetricsList:function(){var e=this,b=$("#metrics-list ul.search-results"),g=$("#metrics-menu input.search");b.delegate("li.root","click",function(b){b.preventDefault();e.removeFolderFromSearchKey();e.searchFolderAndKeyList(g.val())}).addClass(".bound");b.delegate("li.folder","click",function(b){b.preventDefault();e.appendFolderToSearchKey($(this).text());e.searchFolderAndKeyList(g.val())}).addClass(".bound");b.delegate("li.key","click",function(b){b.preventDefault();var p=g.val(),b=$(this).find("a").attr("rel"),
p=p+"."+$(this).find("strong").text();Sammy.log("clicked",b,p);e[b+"GraphMetric"](p)}).addClass(".bound");g.change(function(){e.searchFolderAndKeyList(g.val())});""==g.val()&&e.searchFolderAndKeyList("")},keywordRequestPending:0,searchFolderAndKeyList:function(e){var b=this,g=++b.keywordRequestPending;this.load("/keywords.js",{cache:!1,data:{q:e}}).then(function(e){g==b.keywordRequestPending&&b.buildMetricsList(e.folders,e.metrics)})},addGraphMetric:function(e){var b=this.getEditorJSON();b.targets.push([e,
{}]);this.graphPreview(b);this.setEditorJSON(b)},timestamp:function(e){"string"==typeof e&&(e=parseInt(e,10));return(new Date(1E3*e)).toString()},buildDashboardsDropdown:function(e){this.load("/dashboards.js",{cache:!1,data:{uuid:e}}).then(function(b){var e=$('select[name="dashboard"]');e.html("");for(var b=b.dashboards,g=0,p=b.length,n;g<p;g++)n=b[g],$("<option />",{value:n.slug,text:n.title}).appendTo(e)})},buildSnapshotsDropdown:function(e,b){var g=$('select[name="snapshot"]');b&&g.html("");for(var k=
0,p=e.length,n,v;k<p;k++)n=e[k],v=this.snapshotURLToDate(n),$("<option />",{value:n,text:v}).prependTo(g).attr("selected","selected")},loadAndRenderGraphs:function(e){var b=this,g=this.showPane("graphs"," ");this.load(e,{cache:!1}).then(function(e){var p="All Graphs",n;e.title?(n=!1,p=e.title):n=!0;g.append("<h2>"+p+"</h2>");var p=e.graphs,v=0,A=p.length,G=$("#templates .graph").clone(),z;if(0==e.graphs.length)return g.append($("#graphs-empty")),!0;for(;v<A;v++)z=p[v],G.clone().find(".title").text(z.title||
